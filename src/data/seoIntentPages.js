...
export const SEO_INTENT_PAGES = [
  ...
  faq_ar: [
    { q: 'ما هو المستجد الرئيسي الذي جاء به مشروع المرسوم فيما يخص تشجيع المنتوج والمقاولة الوطنية؟', a: 'يكرس مشروع المرسوم رقم 2.26.435 مبدأ "الأفضلية الوطنية" بشكل صريح وفعال. بموجب هذا المبدأ، سيتم تفضيل عروض المقاولات الوطنية في صفقات الأشغال والتوريدات، وذلك من خلال تطبيق زيادة بنسبة 15% على المبالغ المالية لعروض المقاولات الأجنبية عند مقارنتها بعروض المقاولات الوطنية.' },
    { q: 'بصفتي صاحب مقاولة صغرى، كيف يدعم مشروع المرسوم الجديد مشاركة المقاولات الصغيرة والمتوسطة في الصفقات العمومية؟', a: 'أولى مشروع المرسوم أهمية قصوى لهذه الفئة. أبرز إجراء هو رفع الحصة المخصصة لها من 20% إلى 30% من المبلغ الإجمالي السنوي للصفقات العمومية لكل إدارة. كما يمنح المشروع إمكانية تخصيص صفقات كاملة لفائدة المقاول الذاتي والتعاونيات والمقاولات الصغرى والمتوسطة.' },
    { q: 'هل هناك تبسيط للمساطر الإدارية فيما يتعلق بتقديم العروض إلكترونيا؟', a: 'نعم، يعتبر تعميم الرقمنة أحد الركائز الأساسية لمشروع المرسوم. يسعى المشروع إلى جعل بوابة الصفقات العمومية المنصة الوحيدة لجميع مراحل الصفقة، مما سيؤدي إلى تبسيط المساطر وتقليص الآجال وخفض التكاليف.' },
    { q: 'ما هي الآليات الجديدة لتعزيز الشفافية والحكامة في تدبير الصفقات العمومية؟', a: 'يعزز مشروع المرسوم الشفافية عبر إلزامية النشر الإلكتروني لجميع الوثائق والقرارات، وتدقيق قواعد تعارض المصالح لأعضاء لجان طلبات العروض، وتوحيد طرق تقييم العروض لتجنب القرارات التقديرية غير المبررة.' },
    { q: 'ما هو الهدف العام من هذا الإصلاح؟', a: 'الهدف هو تحويل منظومة الصفقات العمومية من أداة لتدبير النفقات إلى رافعة استراتيجية للتنمية الاقتصادية والاجتماعية، تماشياً مع أهداف ميثاق الاستثمار الجديد والنموذج التنموي.' },
  ],
