...
export const SEO_INTENT_PAGES = [
  ...
  // ─── Réforme marchés publics — décret 2-22-431 ───────────────────────────
  {
    ...
    faq_ar: [
      {
        question: 'هل مقتضيات مشروع المرسوم رقم 2.26.435 المتعلق بالصفقات العمومية سارية المفعول الآن؟',
        answer:   'لا. تستند هذه الصفحة إلى مشروع مرسوم رقم 2.26.435 لم يُنشر بعد في الجريدة الرسمية. لا تُصبح أي من الأحكام المعروضة قابلة للتطبيق إلا بعد نشر النص الرسمي النهائي. وفي حالة وجود أي تعارض، فالعبرة بالنص الرسمي المنشور في الجريدة الرسمية.',
      },
      {
        question: 'ما الفرق بين المرسوم رقم 2.22.431 ومشروع المرسوم رقم 2.26.435؟',
        answer:   'المرسوم رقم 2.22.431 الصادر في 8 مارس 2023 هو النص التنظيمي الجاري به العمل حالياً في مجال الصفقات العمومية. أما مشروع المرسوم رقم 2.26.435 فهو مشروع نص لم يُنشر بعد يرمي إلى تغيير وتتميم المرسوم الأول، من خلال تعديل تسع وعشرين مادة ومعالجة الإشكاليات التي ظهرت خلال السنوات الأولى من تطبيقه.',
      },
      {
        question: 'ما هي العتبة المقترحة لسندات الطلب وفق مشروع المرسوم؟',
        answer:   'وفق صيغة المشروع المتاحة، يُقترح رفع العتبة السنوية للأشغال المُنجزة بواسطة سندات الطلب من 500.000 درهم مع احتساب جميع الرسوم إلى 800.000 درهم مع احتساب جميع الرسوم، لكل آمر بالصرف أو آمر بالصرف مساعد أو شخص مؤهل، في إطار سنة مالية واحدة (م. 91). ويظل هذا الرفع رهيناً بنشر النص الرسمي النهائي.',
      },
      {
        question: 'ما المقصود بالعرض المنخفض بكيفية غير عادية في الصفقات العمومية المغربية؟',
        answer:   'العرض المنخفض بكيفية غير عادية هو كل عرض يقل ثمنه بصورة غير معقولة عن المبلغ التقديري لكلفة الأعمال لدى صاحب المشروع، مما يثير شبهة عدم القدرة على التنفيذ. وفق صيغة المشروع، يُقترح ملاءمة هذه العتبة حول نسبة 15% بالنسبة للمواد المعنية (م. 44 و144).',
      },
      {
        question: 'ما المقصود بالعرض المفرط في الصفقات العمومية؟',
        answer:   'وفق صيغة المشروع، يُعدّ مفرطاً كل عرض يتجاوز بأكثر من 15% المبلغ التقديري لكلفة الأعمال لدى صاحب المشروع (م. 44 و144)، حسب المواد المعنية. وتجدر الإشارة إلى أن هذه الأرقام واردة في الصيغة المتاحة من المشروع وقد تتغير في النص النهائي.',
      },
      {
        question: 'ما المقصود بالأفضلية الوطنية في الصفقات العمومية المغربية؟',
        answer:   'الأفضلية الوطنية آلية تُتيح لصاحب المشروع إضافة نسبة مئوية على المبلغ المالي للمتنافس غير المؤسس بالمغرب لأغراض المقارنة مع عروض المتنافسين الوطنيين. وفق صيغة المشروع (م. 147)، تُحدَّد هذه النسبة في 15%. وتجدر الإشارة إلى أن هذه الزيادة تُستعمل لأغراض المقارنة فقط ولا تعني بالضرورة رفع الثمن النهائي للصفقة.',
      },
      {
        question: 'ما المزايا التي يُقررها المشروع للمقاولات الصغيرة والمتوسطة والتعاونيات والمقاولين الذاتيين؟',
        answer:   'يتضمن المشروع عدة تدابير تستهدف هذه الفئات: رفع عتبة سندات الطلب إلى 800.000 درهم مع احتساب جميع الرسوم يُيسّر الوصول إلى الطلبيات الصغيرة؛ ورفع عتبة طلب العروض المفتوح المبسط إلى 1.500.000 درهم خارج الرسوم يفتح المجال أمام مسطرة مخففة؛ فيما تُتيح الصفقات المخصصة (م. 148) ولوجاً مباشراً للمقاولات الصغيرة جداً والمتوسطة والتعاونيات واتحاداتها والمقاولين الذاتيين والمقاولات المبتكرة.',
      },
    ],
  },
]
