...
export const SEO_INTENT_PAGES = [
  ...
  sections_ar: [
    {
      h2: 'النصوص الأساسية المنظمة لقانون الشغل',
      content: 'يستند قانون الشغل المغربي بشكل أساسي على مجموعة من النصوص التشريعية والتنظيمية التي تحدد إطار العلاقات الشغلية. تعتبر مدونة الشغل حجر الزاوية في هذا الصرح القانوني، وتكملها نصوص أخرى تنظم جوانب محددة كالحماية الاجتماعية والاتفاقيات القطاعية.',
      bullets: [
        'القانون رقم 65.99 المتعلق بمدونة الشغل: الصادر بتنفيذه الظهير الشريف رقم 1.03.194 بتاريخ 11 شتنبر 2003، وهو النص المرجعي الذي ينظم علاقات الشغل الفردية والجماعية بين المشغلين والأجراء في القطاع الخاص.',
        'الظهير الشريف بمثابة قانون رقم 1.72.184 بتاريخ 27 يوليوز 1972: يتعلق هذا النص بنظام الضمان الاجتماعي (CNSS)، ويحدد قواعد الانخراط والتصريح بالأجراء والمنافع التي يستفيدون منها (التعويضات العائلية، التقاعد، التأمين الإجباري عن المرض).',
        'الاتفاقيات الجماعية للشغل: تعتبر مصدرا مهما من مصادر قانون الشغل، حيث تبرم بين المنظمات النقابية للأجراء من جهة، والمشغلين أو منظماتهم المهنية من جهة أخرى، بهدف تحديد شروط عمل أفضل من تلك المنصوص عليها في القانون.',
        'المراسيم التطبيقية: صدرت عدة مراسيم لتطبيق مقتضيات مدونة الشغل، وتهم جوانب دقيقة مثل تحديد الحد الأدنى القانوني للأجر (SMIG و SMAG)، وتنظيم عمل اللجان المتساوية الأعضاء، وقواعد الصحة والسلامة المهنية.',
        'القانون رقم 19.12: يتعلق بتحديد شروط الشغل والتشغيل المتعلقة بالعاملات والعمال المنزليين، وهو نص خاص يهدف إلى حماية هذه الفئة من الأجراء وضمان حقوقهم الأساسية.',
      ],
    },
    {
      h2: 'عقد الشغل: إبرامه، أنواعه، وتعديله',
      content: 'يعتبر عقد الشغل الأداة القانونية التي تربط بين الأجير والمشغل، حيث يلتزم بمقتضاه الأجير ببذل نشاطه المهني تحت تبعية المشغل مقابل أجر. تنظم مدونة الشغل شروط صحته وأنواعه المختلفة لضمان استقرار العلاقة الشغلية.',
      bullets: [
        'أنواع العقود: يمكن إبرام عقد الشغل لمدة غير محددة (CDI) وهو الأصل، أو لمدة محددة (CDD) في حالات استثنائية حصرها القانون (كالتزايد المؤقت لنشاط المقاولة أو إنجاز أشغال ذات طابع موسمي)، أو لإنجاز شغل معين.',
        'فترة الاختبار: لا يمكن أن تتجاوز فترة الاختبار ثلاثة أشهر بالنسبة للأطر وأشباههم، وشهر ونصف بالنسبة للمستخدمين، وخمسة عشر يوما بالنسبة للعمال، مع إمكانية تجديدها مرة واحدة فقط.',
        'إثبات علاقة الشغل: يمكن إثبات علاقة الشغل بجميع وسائل الإثبات، حتى في غياب عقد مكتوب. ويجب على المشغل تسليم الأجير بطاقة الشغل التي تتضمن بياناته الأساسية وبيانات المقاولة.',
        'البيانات الإلزامية في العقد المكتوب: يجب أن يتضمن العقد المكتوب بيانات أساسية كهوية الطرفين، ومكان الشغل، وتحديد المهام، ومبلغ الأجر وتوابعه، وتاريخ بدء العقد، ومدته إذا كان محدد المدة.',
        'تعديل العقد: لا يمكن للمشغل إجراء أي تعديل جوهري على عقد الشغل (مثل تخفيض الأجر، أو تغيير المنصب بشكل جذري، أو النقل إلى مكان بعيد) إلا بموافقة صريحة من الأجير، ويعتبر رفض الأجير في هذه الحالة بمثابة فصل تعسفي.',
      ],
    },
    {
      h2: 'الحقوق والالتزامات الأساسية خلال تنفيذ العقد',
      content: 'تحدد مدونة الشغل إطارا متوازنا للحقوق والواجبات المتبادلة بين الأجير والمشغل. تشمل هذه الحقوق مدة الشغل القانونية، والحق في الراحة والعطل، والحصول على أجر عادل، في مقابل التزام الأجير بتنفيذ العمل المتفق عليه والامتثال لتعليمات المشغل.',
      bullets: [
        'مدة الشغل القانونية: تحدد مدة الشغل العادية في القطاعات غير الفلاحية في 2288 ساعة في السنة أو 44 ساعة في الأسبوع. أما في القطاع الفلاحي، فتحدد في 2496 ساعة في السنة.',
        'الحد الأدنى القانوني للأجر (SMIG/SMAG): يضمن القانون حدا أدنى للأجر لا يمكن النزول عنه، ويتم تحديده ومراجعته بموجب مرسوم. يختلف هذا الحد بين قطاعات الصناعة والتجارة والمهن الحرة (SMIG) والقطاع الفلاحي (SMAG).',
        'العطلة السنوية المؤدى عنها: يستحق كل أجير، بعد قضائه ستة أشهر متصلة من الشغل، عطلة سنوية مؤدى عنها لا تقل مدتها عن يوم ونصف يوم عمل عن كل شهر من الشغل الفعلي (أي 18 يوم عمل في السنة)، وتزداد هذه المدة مع ارتفاع الأقدمية.',
        'الراحة الأسبوعية والعطل الرسمية: يجب أن يستفيد الأجير من راحة أسبوعية لا تقل عن 24 ساعة متصلة. كما يستفيد من الراحة خلال أيام الأعياد الدينية والوطنية المؤدى عنها، والتي يحددها نص تنظيمي.',
        'الصحة والسلامة وحفظ الكرامة: يلتزم المشغل باتخاذ جميع التدابير اللازمة لحماية صحة وسلامة الأجراء في أماكن العمل، وحفظ كرامتهم، والامتناع عن كل سلوك ينطوي على تحرش جنسي أو معنوي.',
      ],
    },
    {
      h2: 'إنهاء عقد الشغل: الإجراءات والتعويضات',
      content: 'ينتهي عقد الشغل إما بالإرادة المنفردة لأحد الطرفين (الاستقالة أو الفصل) أو بقوة القانون. وضعت مدونة الشغل مساطر دقيقة لإنهاء العقد بهدف حماية الأجير من الفصل التعسفي وضمان حقوق الطرفين.',
      bullets: [
        'الاستقالة: يجب على الأجير الذي يرغب في إنهاء عقد الشغل غير محدد المدة أن يقدم استقالته كتابة مع احترام أجل الإخطار (préavis) الذي يحدده القانون أو عقد الشغل أو الاتفاقية الجماعية حسب أقدميته وفئته المهنية.',
        'الفصل بسبب خطأ جسيم: يمكن للمشغل فصل الأجير دون إخطار أو تعويض في حالة ارتكابه لخطأ جسيم (مثل السرقة، إفشاء سر مهني، السكر العلني). ويجب على المشغل اتباع مسطرة الاستماع للأجير قبل اتخاذ قرار الفصل.',
        'الفصل لأسباب اقتصادية أو هيكلية أو تكنولوجية: لا يمكن للمشغل فصل الأجراء لهذه الأسباب إلا بعد الحصول على إذن من عامل العمالة أو الإقليم، وذلك بعد استشارة مندوبي الأجراء والممثلين النقابيين.',
        'التعويضات المستحقة عند الفصل: في حالة الفصل التعسفي، يحق للأجير الحصول على تعويض عن الضرر، وتعويض عن أجل الإخطار، وتعويض عن الفصل (indemnité de licenciement) الذي يحتسب على أساس الأقدمية والأجر.',
        'وثائق نهاية الخدمة: عند انتهاء العقد لأي سبب كان، يلتزم المشغل بتسليم الأجير شهادة عمل (certificat de travail) خلال أجل أقصاه 8 أيام، ووصل تصفية كل حساب (reçu pour solde de tout compte).',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي مدة فترة الاختبار وكيف يتم تجديدها حسب مدونة الشغل المغربية؟', a: 'فترة الاختبار هي المدة التي يمكن خلالها لأحد الطرفين إنهاء عقد الشغل بإرادته دون تعويض أو إخطار. تحدد مدتها القصوى بموجب المادة 14 من مدونة الشغل كما يلي: - ثلاثة أشهر بالنسبة للأطر. - شهر ونصف بالنسبة للمستخدمين. - خمسة عشر يوماً بالنسبة للعمال. يمكن تجديد فترة الاختبار مرة واحدة ولنفس المدة، شريطة أن يتم التنصيص على ذلك كتابةً في عقد الشغل. إذا استمر الأجير في عمله بعد انقضاء فترة الاختبار، يعتبر العقد نهائياً.' },
    { q: 'كيف يتم احتساب مدة العطلة السنوية المؤدى عنها، وهل يمكن تجزئتها؟', a: 'يستحق كل أجير، بعد قضائه ستة أشهر متصلة من الشغل الفعلي، عطلة سنوية مؤدى عنها. تُحتسب مدتها على أساس يوم ونصف يوم عمل فعلي عن كل شهر من الشغل (أي 18 يوم عمل عن سنة كاملة). وتُضاف مدة يوم ونصف عن كل فترة خمس سنوات من الأقدمية، على ألا تتجاوز المدة الإجمالية للعطلة ثلاثين يوماً من أيام العمل الفعلية (المادة 231 و 232 من مدونة الشغل). يمكن تجزئة العطلة السنوية أو الجمع بين أجزاء من مدتها على مدى سنتين متتاليتين بموافقة الأجير، ولكن يجب أن تشمل الدفعة الأولى من العطلة 12 يوم عمل متصلة على الأقل (المادة 240).' },
    { q: 'ما هي شروط تشغيل الأجراء لساعات إضافية وما هو التعويض المستحق عنها؟', a: 'يمكن تشغيل الأجراء ساعات إضافية لمواجهة أشغال تقتضيها ضرورة استثنائية. وفقاً للمادة 201 من مدونة الشغل، يؤدى عن الساعات الإضافية تعويض لا يقل عن المبالغ التالية: - زيادة بنسبة 25% من الأجر إذا تم أداؤها في النهار بين الساعة السادسة صباحاً والتاسعة ليلاً. - زيادة بنسبة 50% من الأجر إذا تم أداؤها في الليل بين الساعة التاسعة ليلاً والسادسة صباحاً. - زيادة بنسبة 50% نهاراً و 100% ليلاً إذا تم أداؤها في يوم الراحة الأسبوعية، حتى لو كان ذلك تعويضاً عن يوم راحة آخر.' },
    { q: 'ما هي الأخطاء التي تعتبر جسيمة وتبرر الفصل دون تعويض، وما هي المسطرة الواجب اتباعها؟', a: 'تعتبر أخطاء جسيمة، حسب المادة 39 من مدونة الشغل، مجموعة من الأفعال التي يمكن أن تؤدي إلى الفصل دون إخطار أو تعويض، منها على سبيل المثال: السرقة، خيانة الأمانة، إفشاء سر مهني، السكر العلني، تعاطي المخدرات داخل المقاولة، السب الفادح، الرفض المتكرر وغير المبرر لتنفيذ الأوامر، أو الغياب غير المبرر لأكثر من أربعة أيام أو ثمانية أنصاف يوم خلال اثني عشر شهراً. قبل اتخاذ قرار الفصل، يجب على المشغل اتباع مسطرة الاستماع للأجير المنصوص عليها في المواد 62 إلى 65، حيث يتم استدعاء الأجير للاستماع إليه بحضور مندوب الأجراء أو ممثل نقابي، وذلك في أجل لا يتعدى ثمانية أيام من تاريخ معاينة الخطأ.' },
    { q: 'في حالة الاستقالة من عقد عمل غير محدد المدة، هل أنا ملزم باحترام أجل الإخطار وما هي مدته؟', a: 'نعم، في حالة إنهاء عقد الشغل غير محدد المدة بإرادة منفردة من طرف الأجير (الاستقالة)، يجب عليه احترام أجل الإخطار. مدة أجل الإخطار ليست محددة في مدونة الشغل مباشرة، بل يتم تحديدها بموجب المراسيم أو اتفاقيات الشغل الجماعية أو عقد الشغل أو النظام الداخلي (المادة 43). بشكل عام، ووفقاً للمرسوم رقم 2.04.469، تتراوح مدة الإخطار حسب فئة الأجير وأقدميته: - بالنسبة للأطر: شهر واحد لأقل من سنة أقدمية، شهران بين سنة و 5 سنوات، و 3 أشهر لأكثر من 5 سنوات. - بالنسبة للمستخدمين والعمال: 8 أيام لأقل من سنة أقدمية، وشهر واحد بين سنة و 5 سنوات، وشهران لأكثر من 5 سنوات. عدم احترام هذا الأجل من طرف الأجير يلزمه بأداء تعويض للمشغل يعادل الأجر المطابق لمدة الإخطار التي لم يتم احترامها.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي المسطرة القانونية التي يجب على المشغل اتباعها لفصل أجير ارتكب خطأً جسيماً؟', a: 'حسب المادة 62 من مدونة الشغل، يجب على المشغل، قبل فصل الأجير، أن يتيح له فرصة الدفاع عن نفسه بالاستماع إليه بحضور مندوب الأجراء أو الممثل النقابي بالمقاولة الذي يختاره الأجير بنفسه، وذلك داخل أجل لا يتعدى ثمانية أيام من تاريخ constation الخطأ. يتم تحرير محضر في الموضوع من قبل إدارة المقاولة، ويوقعه الطرفان. بعد ذلك، يتم تسليم مقرر الفصل إلى الأجير يداً بيد مقابل وصل، أو عن طريق رسالة مضمونة مع إشعار بالتوصل داخل أجل 48 ساعة من تاريخ اتخاذ المقرر.' },
    { q: 'ماذا يعني الفصل التعسفي وما هي حقوق الأجير في هذه الحالة؟', a: 'الفصل التعسفي هو كل إنهاء لعقد الشغل من جانب المشغل دون وجود مبرر قانوني مقبول، كأن يكون السبب غير مرتبط بكفاءة الأجير أو سلوكه أو لم تراع فيه الصعوبات الاقتصادية للمقاولة. في هذه الحالة، ووفقاً للمواد 41 و 59 من مدونة الشغل، يحق للأجير المطالبة بالتعويضات التالية: التعويض عن الضرر الذي يحدده القاضي بناءً على الأقدمية والأجر والوضعية العائلية، والتعويض عن مهلة الإخطار، والتعويض عن الفصل (indemnité de licenciement) إذا استوفى شروطه.' },
    { q: 'ما هي أنواع التعويضات التي يستحقها الأجير عند فصله بعد قضاء فترة طويلة في العمل؟', a: 'إذا تم فصل الأجير فصلاً غير تعسفي (لأسباب تكنولوجية أو هيكلية أو اقتصادية مثلاً) أو تم التوصل إلى اتفاق، فإنه يستحق تعويضاً عن الفصل وتعويضاً عن مهلة الإخطار. يُحتسب التعويض عن الفصل (indemnité de licenciement) على أساس الأقدمية، كما هو منصوص عليه في المادة 53 من مدونة الشغل. بالإضافة إلى ذلك، يستحق الأجير شهادة عمل وتصفية كل حساب (solde de tout compte). أما في حالة الفصل التعسفي، فتضاف إلى هذه التعويضات تعويضات عن الضرر كما ذكرنا سابقاً.' },
    { q: 'هل يمكن للمشغل فصلي من العمل دون إعطاء أي سبب؟', a: 'لا، لا يمكن للمشغل فصل الأجير دون مبرر. تنص المادة 35 من مدونة الشغل على أنه "يمنع فصل الأجير دون مبرر مقبول". كل فصل لا يستند إلى سبب وجيه (خطأ جسيم، أسباب تكنولوجية أو هيكلية أو اقتصادية مع احترام المسطرة) يعتبر فصلاً تعسفياً. وعليه، يقع على عاتق المشغل عبء إثبات وجود سبب مشروع ومقبول قانوناً لإنهاء عقد الشغل.' },
    { q: 'ما هو الفرق بين الفصل لأسباب شخصية والفصل لأسباب اقتصادية؟', a: 'الفصل لأسباب شخصية يتعلق بشخص الأجير نفسه، ويكون إما فصلاً تأديبياً بسبب ارتكاب خطأ جسيم (وفق اللائحة المحددة في المادة 39 من مدونة الشغل)، أو فصلاً غير تأديبي مرتبط بعدم الكفاءة المهنية. أما الفصل لأسباب اقتصادية أو تكنولوجية أو هيكلية، فهو لا يتعلق بشخص الأجير، بل بالصعوبات التي تواجهها المقاولة. هذا النوع من الفصل يخضع لمسطرة خاصة ومعقدة تتطلب الحصول على إذن من عامل العمالة أو الإقليم، وذلك بعد استشارة مندوبي الأجراء والممثلين النقابيين (المواد 66 إلى 71 من مدونة الشغل).' },
  ],
  ...
  faq_ar: [
    { q: 'من يكتسب صفة التاجر حسب القانون المغربي؟', a: 'يكتسب صفة التاجر، حسب المادة 6 من مدونة التجارة، كل شخص يمارس بصفة اعتيادية أو احترافية نشاطا تجاريا. الأنشطة التجارية محددة على سبيل المثال في المادتين 6 و 7، وتشمل شراء المنقولات لإعادة بيعها، والأنشطة الصناعية والحرفية، والنقل، والعمليات البنكية. بالإضافة إلى ذلك، تشترط المادة 12 من نفس المدونة أن يكون الشخص كامل الأهلية (18 سنة شمسية كاملة) لممارسة التجارة، مع وجود استثناءات خاصة بالقاصر المأذون له.' },
    { q: 'ما هو الأصل التجاري وما هي مكوناته الأساسية؟', a: 'الأصل التجاري هو مال منقول معنوي يشمل مجموعة من الأموال المادية والمعنوية المخصصة لممارسة نشاط تجاري. وفقا للمادة 80 من مدونة التجارة، يشتمل الأصل التجاري وجوبا على عنصرين أساسيين هما الزبناء والشهرة التجارية. كما يمكن أن يضم عناصر أخرى غير إلزامية مثل: الاسم التجاري، والشعار، والحق في الكراء، والبضائع، والمعدات والأدوات، وبراءات الاختراع، والعلامات التجارية.' },
    { q: 'هل التسجيل في السجل التجاري إلزامي؟ وما هي عواقب عدم القيام به؟', a: 'نعم، التسجيل في السجل التجاري إلزامي لكل تاجر، سواء كان شخصا طبيعيا أو معنويا (شركة)، يمارس نشاطه في المغرب. تنص المادة 37 من مدونة التجارة على وجوب طلب التسجيل في غضون ثلاثة أشهر من افتتاح المؤسسة التجارية. عدم الامتثال لهذا الالتزام يعرض التاجر لغرامة مالية كما هو منصوص عليه في المادة 62، والأهم من ذلك، لا يمكنه التمسك بصفته كتاجر في مواجهة الغير، لكن الغير يمكنه الاحتجاج بهذه الصفة ضده.' },
    { q: 'ما هي العواقب القانونية المترتبة عن إصدار شيك بدون رصيد كافٍ؟', a: 'إصدار شيك بدون رصيد كافٍ وقابل للتصرف يعتبر مخالفة خطيرة. بموجب المادة 316 من مدونة التجارة، يؤدي عدم أداء الشيك لعدم كفاية الرصيد إلى تسجيل عارضة أداء لدى بنك المغرب. يترتب على ذلك منع الشخص المصدر للشيك من استخدام الشيكات لمدة 10 سنوات على مستوى جميع البنوك في المغرب، ما لم يقم بتسوية وضعيته. تتم التسوية عبر أداء مبلغ الشيك بالإضافة إلى غرامة مالية محددة قانونا لاستعادة حق إصدار الشيكات.' },
    { q: 'شركتي تواجه صعوبات مالية، هل يمكنني الاستفادة من مسطرة الإنقاذ؟', a: 'نعم، مسطرة الإنقاذ هي آلية وقائية متاحة للمقاولات التي تواجه صعوبات مالية أو اقتصادية لكنها لم تصل بعد إلى مرحلة التوقف عن الدفع. الهدف منها، وفقا للكتاب الخامس من مدونة التجارة (المواد 560 وما يليها)، هو تمكين المقاولة من تجاوز صعوباتها عبر إعداد مخطط إنقاذ. يفتح هذا الإجراء بطلب من رئيس المقاولة لدى المحكمة التجارية، ويسمح بتجميد الديون مؤقتا لإتاحة الفرصة لإعادة هيكلة المقاولة وضمان استمراريتها والحفاظ على مناصب الشغل.' },
  ],
  ...
  faq_ar: [
    { q: 'هل هناك حد أدنى لرأس المال لتأسيس شركة ذات مسؤولية محدودة في المغرب؟', a: 'كلا، لم يعد القانون المغربي يفرض حداً أدنى لرأس مال الشركة ذات المسؤولية المحدودة. وفقاً للمادة 46 من القانون رقم 5.96، يمكن للشركاء تحديد مبلغ رأس المال بكل حرية في النظام الأساسي للشركة. يجب تقسيم رأس المال إلى حصص اسمية متساوية القيمة، ويجب أن يتم الاكتتاب في جميع الحصص وتحريرها (دفع قيمتها) بالكامل عند التأسيس.' },
    { q: 'ما هو مدى مسؤولية الشركاء عن ديون الشركة؟', a: 'مسؤولية الشركاء في الشركة ذات المسؤولية المحدودة هي مسؤولية محدودة تماماً. حسب المادة 44 من القانون رقم 5.96، لا يتحمل الشركاء ديون الشركة إلا في حدود حصصهم المقدمة في رأس المال. هذا يعني أن أموالهم الشخصية محمية، ولا يمكن لدائني الشركة الحجز عليها لسداد ديون الشركة، إلا في حالات استثنائية ومحددة قانوناً كالخطأ في التسيير.' },
    { q: 'هل يمكن لشخص واحد تأسيس شركة ذات مسؤولية محدودة؟', a: 'نعم، يمكن لشخص واحد تأسيس شركة ذات مسؤولية محدودة. في هذه الحالة، تسمى الشركة "شركة ذات مسؤولية محدودة بشريك وحيد". تنص المادة 44 من القانون رقم 5.96 على أن الشركة يمكن أن تتكون من شخص واحد أو أكثر، على ألا يتجاوز عدد الشركاء 50 شريكاً. إذا تجاوز العدد 50، يجب تحويل الشركة إلى شركة مساهمة في أجل سنتين.' },
    { q: 'من يقوم بإدارة وتسيير الشركة ذات المسؤولية المحدودة؟', a: 'يتم تسيير الشركة ذات المسؤولية المحدودة من طرف مسيّر واحد أو أكثر، ويجب أن يكونوا أشخاصاً طبيعيين. وفقاً للمادة 62 من القانون رقم 5.96، يمكن اختيار المسيّرين من بين الشركاء أو من خارجهم (من الغير). يتم تعيينهم وتحديد صلاحياتهم إما في النظام الأساسي للشركة أو بموجب عقد لاحق بقرار من الشركاء.' },
    { q: 'ما هي إجراءات تفويت (بيع) الحصص في الشركة؟', a: 'تخضع عملية تفويت الحصص لقيود تهدف إلى حماية الطابع المغلق للشركة. حسب المادة 58 من القانون رقم 5.96، تكون الحصص قابلة للانتقال بحرية بين الشركاء، أو بين الأزواج والأصول والفروع. أما إذا كان التفويت سيتم لشخص أجنبي عن الشركة (من الغير)، فيجب الحصول على موافقة أغلبية الشركاء المالكين لثلاثة أرباع (3/4) رأسمال الشركة على الأقل. ويتمتع الشركاء الآخرون بحق الأفضلية في شراء تلك الحصص بنفس الشروط.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الإطار القانوني المنظم للكراء التجاري: القانون رقم 49.16',
      content: 'يخضع الكراء التجاري في المغرب بشكل أساسي لمقتضيات القانون رقم 49.16 المتعلق بكراء العقارات أو المحلات المخصصة للاستعمال التجاري أو الصناعي أو الحرفي. ألغى هذا القانون وعوض الظهير السابق المؤرخ في 24 مايو 1955، بهدف تحقيق توازن عقدي أفضل بين حقوق المكري (المالك) والمكتري (المستأجر) وضمان استقرار الأصل التجاري الذي يشكل قوام النشاط الاقتصادي.',
      bullets: [
        'نطاق التطبيق المحدد: يطبق القانون على عقود كراء العقارات والمحلات التي يُستغل فيها أصل تجاري، سواء كان مملوكاً لتاجر، أو صانع، أو حرفي. كما يشمل نطاقه كراء العقارات الملحقة بالمحل، وعقود كراء الأراضي العارية التي شُيدت عليها بنايات لاستغلال أصل تجاري بموافقة المالك.',
        'إلزامية العقد المكتوب وبيان الحالة: أوجب القانون، تحت طائلة عدم القبول، إبرام عقد الكراء في محرر كتابي ثابت التاريخ. كما فرض ضرورة إرفاق بيان وصفي لحالة الأماكن المكتراة وقت التسليم، يوقعه الطرفان، وذلك لتحديد المسؤوليات بدقة عند انتهاء العلاقة الكرائية.',
        'الاستثناءات من نطاق التطبيق: لا تسري أحكام هذا القانون على عقود الكراء التي تدخل في إطار عقد الائتمان الإيجاري العقاري، ولا على عقود الكراء الطويل الأمد، وكذلك عقود كراء أملاك الأوقاف (الأحباس)، والعقارات أو المحلات الموجودة داخل المراكز التجارية التي يسيرها مسير واحد، والتي تخضع لاتفاقات خاصة.',
        'مدة العقد والشرط الزمني لاكتساب الحقوق: لا يفرض القانون مدة محددة للعقد، لكنه يربط اكتساب الحق في تجديد العقد وتملّك "الملكية التجارية" باستغلال المحل لمدة سنتين متتاليتين على الأقل بموجب عقد كراء، مما يشجع على استقرار العلاقات التعاقدية.',
      ],
    },
    {
      h2: 'الحقوق الجوهرية للمكتري وحماية الأصل التجاري',
      content: 'يمنح القانون 49.16 للمكتري مجموعة من الحقوق الأساسية التي تشكل درعاً قانونياً لحماية استمرارية نشاطه التجاري والحفاظ على قيمة أصله التجاري، الذي يتكون من عناصر مادية (معدات، بضائع) ومعنوية (زبناء، سمعة، علامة تجارية).',
      bullets: [
        'الحق في تجديد عقد الكراء: بعد استيفاء شرط مدة السنتين من الاستغلال، يكتسب المكتري حقاً قوياً في طلب تجديد العقد. لا يمكن للمكري أن يرفض هذا التجديد إلا لأسباب جدية ومحددة قانوناً، أو مقابل دفع تعويض كامل عن الإفراغ.',
        'مسطرة طلب التجديد والرد عليه: يجب على المكتري الراغب في التجديد أن يوجه إنذاراً للمكري عبر مفوض قضائي قبل انتهاء العقد بستة أشهر على الأقل. ويجب على المكري الذي يتوصل بالإنذار أن يجيب خلال أجل ثلاثة أشهر، وإلا اعتبر موافقاً على التجديد بنفس الشروط.',
        'مراجعة وضبط السومة الكرائية: يمكن مراجعة واجب الكراء (السومة الكرائية) باتفاق الطرفين. في حالة الخلاف، يمكن اللجوء إلى رئيس المحكمة بصفته قاضيا للأمور المستعجلة لتحديدها. لا يمكن أن تتجاوز الزيادة نسبة 10% من السومة الأخيرة، إلا إذا أثبت المكري أن السومة لا تتناسب مع قيمة المنفعة بشكل واضح، أو إذا قام المكتري بتغيير النشاط.',
        'الحق في تولية الكراء والتنازل عنه: للمكتري الحق في تولية الكراء للغير (كراء من الباطن) أو التنازل عن عقد الكراء، ما لم يتضمن العقد شرطاً يمنع ذلك. إذا كان التنازل يشمل الأصل التجاري ككل، لا يمكن للمكري الاعتراض عليه، ولكن يجب إشعاره وفقاً للمسطرة القانونية.',
      ],
    },
    {
      h2: 'إنهاء العقد، مسطرة الإفراغ، وقواعد تعويض الإفراغ',
      content: 'نظم القانون بدقة وصرامة حالات وإجراءات إنهاء عقد الكراء التجاري، سواء برغبة المكري في استرداد محله أو نتيجة إخلال المكتري بالتزاماته. يظل تعويض الإفراغ هو الضمانة الأساسية للمكتري في مواجهة الإنهاء التعسفي للعقد.',
      bullets: [
        'الإنذار بالإفراغ كإجراء جوهري: يجب على المكري الذي يرغب في إفراغ المكتري، لأي سبب كان، أن يوجه له إنذاراً عبر مفوض قضائي. يجب أن يتضمن الإنذار السبب المعتمد وأن يمنح المكتري أجلاً لا يقل عن ثلاثة أشهر للمغادرة، أو 15 يوماً في حالة عدم أداء الكراء.',
        'قاعدة التعويض الكامل عن الإفراغ: كقاعدة عامة، إذا رفض المكري تجديد العقد دون سبب جدي ومشروع، فإنه يكون ملزماً بدفع تعويض كامل للمكتري. يشمل هذا التعويض قيمة الأصل التجاري كما تحددها خبرة قضائية (بناءً على رقم المعاملات، السمعة، الموقع)، بالإضافة إلى مصاريف الانتقال والتحملات التي تكبدها المكتري.',
        'حالات الإفراغ دون تعويض (الأخطاء الموجبة للفسخ): يسقط حق المكتري في التعويض في حالات محددة تعتبر أخطاء جسيمة، أبرزها: عدم أداء واجب الكراء بعد إنذاره، إحداث تغيير بالبناية دون موافقة المكري مما يعرضها للخطر، استعمال المحل في غير النشاط المحدد في العقد، أو إغلاق المحل لمدة تزيد عن سنتين.',
        'حالات الإفراغ مع تعويض محدود وحق الرجوع: في حالات خاصة مثل رغبة المكري في هدم المحل وإعادة بنائه، أو توسعته، أو تعليته، يمكنه إنهاء العقد مقابل دفع تعويض للمكتري يعادل الضرر الذي لحقه، على ألا يتجاوز قيمة الأصل التجاري، مع منحه حق الأسبقية في الرجوع إلى المحل الجديد بنفس السومة الكرائية أو بسومة جديدة في حالة التحسينات.',
      ],
    },
  ],
  faq_ar: [
    { q: 'كمستأجر لمحل تجاري، هل يحق لي تجديد عقد الكراء بعد انتهاء مدته؟', a: 'نعم، يضمن القانون للمكتري الحق في تجديد عقد الكراء متى أثبت انتفاعه الشخصي والمستمر من المحل لمدة سنتين متتاليتين على الأقل. هذا الحق يهدف إلى حماية الأصل التجاري الذي كونه المكتري. وفي حالة رفض المالك تجديد العقد دون سبب مشروع، فإنه يكون ملزماً بأداء تعويض للمكتري عن الإفراغ يعادل قيمة الضرر الذي لحقه. هذا المبدأ منظم بموجب المادتين 4 و 7 من القانون رقم 49.16 المتعلق بكراء العقارات أو المحلات المخصصة للاستعمال التجاري أو الصناعي أو الحرفي.' },
    { q: 'أنا مالك عقار، وأرغب في استرجاع محلي التجاري المؤجر. ما هي الإجراءات القانونية وهل أنا ملزم بدفع تعويض؟', a: 'لكي تنهي عقد الكراء التجاري، يجب عليك توجيه إنذار بالإفراغ إلى المكتري قبل ستة (6) أشهر على الأقل من التاريخ المرغوب فيه للإفراغ. يجب أن يتضمن الإنذار السبب الذي تستند إليه. القاعدة العامة هي أنك ملزم بأداء تعويض عن الإفراغ للمكتري. لكن القانون رقم 49.16 يعفيك من أداء هذا التعويض في حالات محددة على سبيل الحصر في المادة 8، أبرزها: إذا لم يؤد المكتري واجبات الكراء في أجل 15 يوماً من تاريخ توصله بالإنذار، أو إذا أحدث تغييراً بالمحل دون موافقتك، أو في حالة الهدم وإعادة البناء مع التزامك بمنح المكتري حق الأسبقية في الرجوع.' },
    { q: 'هل يمكن للمالك رفع سومة الكراء التجاري في أي وقت وبأي نسبة؟', a: 'لا، لا يمكن للمالك رفع السومة الكرائية بشكل تعسفي. تخضع مراجعة السومة الكرائية لمقتضيات القانون. وفقاً للمادة 33 من القانون رقم 49.16، يحق للطرفين المطالبة بمراجعة السومة الكرائية كل ثلاث (3) سنوات من تاريخ إبرام العقد أو من تاريخ آخر مراجعة قضائية أو اتفاقية. وفي حالة عدم اتفاق الطرفين، يتم اللجوء إلى المحكمة التي تحدد السومة الجديدة بناءً على معايير موضوعية كقيمة العقار وموقعه، مع مراعاة ألا تتجاوز نسبة الزيادة 10% من السومة الحالية، إلا في حالات استثنائية يحددها القانون.' },
    { q: 'أرغب في بيع أصلي التجاري (fonds de commerce). هل أنا ملزم بالحصول على موافقة المالك لتفويت حق الكراء للمشتري الجديد؟', a: 'يميز القانون بين حالتين. الحالة الأولى: إذا قمت ببيع الأصل التجاري بكافة عناصره (الزبناء، السمعة، الحق في الكراء...)، فإنه يحق لك تفويت حق الكراء للمشتري دون الحاجة إلى موافقة المالك، ولكن يجب تبليغه بعملية التفويت. الحالة الثانية: إذا أردت تفويت الحق في الكراء بشكل مستقل ومنفصل عن باقي عناصر الأصل التجاري، فإن موافقة المالك الكتابية تصبح ضرورية. هذه الأحكام منظمة بموجب المادة 25 من القانون رقم 49.16.' },
    { q: 'ما هي العواقب القانونية في حالة تخلف المكتري عن أداء واجبات الكراء؟', a: 'يعتبر عدم أداء واجبات الكراء إخلالاً خطيراً بالعقد. في هذه الحالة، يجب على المالك أولاً توجيه إنذار أداء للمكتري، يمنحه فيه أجلاً لا يقل عن 15 يوماً لتسديد المبالغ المستحقة. إذا لم يستجب المكتري خلال هذا الأجل، يمكن للمالك اللجوء إلى رئيس المحكمة بصفته قاضياً للأمور المستعجلة للمطالبة بالمصادقة على الإنذار والأمر بأداء المبالغ، أو رفع دعوى لفسخ العقد وإفراغ المكتري دون أن يكون هذا الأخير مستحقاً لأي تعويض عن الإفراغ، وذلك استناداً للمادتين 8 و 26 من القانون رقم 49.16.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي أول خطوة يجب اتخاذها لتحصيل دين تجاري لم يتم أداؤه؟', a: 'الخطوة الأولى هي سلوك المسطرة الودية. يجب على الدائن توجيه إنذار رسمي للمدين بواسطة مفوض قضائي أو عبر رسالة مضمونة مع إشعار بالتوصل. هذا الإنذار يمنح المدين أجلاً محدداً للأداء، ويعتبر إثباتاً على أن الدائن قد طالب بدينه بشكل رسمي. يعتبر هذا الإجراء ضرورياً قبل اللجوء إلى بعض المساطر القضائية، كما أنه قد يؤدي إلى حل النزاع دون الحاجة إلى التقاضي، مما يوفر الوقت والتكاليف.' },
    { q: 'ما هي مسطرة الأمر بالأداء، ومتى يمكنني استخدامها لتحصيل ديني؟', a: 'مسطرة الأمر بالأداء هي إجراء قضائي سريع ومبسط يهدف إلى الحصول على أمر من رئيس المحكمة التجارية يلزم المدين بأداء مبلغ مالي. يمكن اللجوء إليها شريطة أن يكون الدين ثابتاً ومستحق الأداء ومحدداً بمبلغ نقدي يفوق 20.000 درهم، وأن يكون مُثبتاً بسند رسمي أو اعتراف بدين (مثل كمبيالة، سند لأمر، أو شيك). هذه المسطرة منظمة بموجب الفصول 155 إلى 165 من قانون المسطرة المدنية. إذا لم يستجب المدين للأمر أو يتعرض عليه في الآجال القانونية، يصبح الأمر قابلاً للتنفيذ الفوري.' },
    { q: 'ما هي مدة التقادم التي يسقط بها الحق في المطالبة بالديون التجارية؟', a: 'وفقاً للمادة 5 من مدونة التجارة، تتقادم الالتزامات الناشئة بمناسبة عمل تجاري بين التجار أو بينهم وبين غير التجار بمضي خمس سنوات. يُعرف هذا بـ "التقادم الخُمسي". تبدأ هذه المدة من تاريخ استحقاق الدين. من الضروري جداً للدائن أن يبادر إلى المطالبة بدينه قبل انقضاء هذه المدة، وإلا سقط حقه في المطالبة به قضائياً. تجدر الإشارة إلى وجود آجال تقادم خاصة لبعض السندات التجارية كالكمبيالة والشيك.' },
    { q: 'ما هي الوثائق الأساسية التي أحتاجها لإثبات دين تجاري أمام المحكمة؟', a: 'في المادة التجارية، يسود مبدأ حرية الإثبات (المادة 334 من مدونة التجارة). ومع ذلك، فإن الإثبات الكتابي يبقى الأقوى. الوثائق الأساسية التي يمكن الاعتماد عليها تشمل: الفواتير المقبولة من المدين، الكمبيالات والسندات لأمر، الشيكات، العقود المبرمة بين الطرفين، سندات التسليم الموقعة، المراسلات (بما في ذلك رسائل البريد الإلكتروني التي تثبت وجود المعاملة والالتزام)، وكشوف الحسابات المعتمدة. كلما كانت الحجج الكتابية قوية وواضحة، زادت فرص الحصول على حكم لصالح الدائن.' },
    { q: 'حصلت على حكم قضائي نهائي لصالحي، فما هي الخطوة التالية لاستخلاص أموالي فعلياً؟', a: 'الحصول على حكم قضائي هو الخطوة الأولى في المرحلة القضائية، لكنه لا يعني التحصيل الفوري للمبلغ. الخطوة التالية هي مرحلة التنفيذ. يجب عليك أولاً الحصول على نسخة تنفيذية من الحكم من كتابة ضبط المحكمة التي أصدرته. بعد ذلك، يتم تبليغ الحكم للمدين، وفي حال عدم الامتثال الطوعي، يتم اللجوء إلى إجراءات التنفيذ الجبري عبر مفوض قضائي. يمكن للمفوض القضائي مباشرة إجراءات الحجز على ممتلكات المدين المنقولة (كالأثاث أو السيارات) أو العقارية، أو الحجز لدى الأغيار (مثل حجز أرصدته البنكية). هذه الإجراءات منظمة في قانون المسطرة المدنية، خصوصاً في الكتاب الخامس المتعلق بطرق التنفيذ.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي أول خطوة قانونية يجب اتخاذها عند استلام شيك بدون رصيد؟', a: 'عند تقديم الشيك للبنك وعدم وجود مؤونة كافية لتغطيته، يجب على المستفيد أولاً الحصول على "شهادة عدم الأداء" من المؤسسة البنكية المسحوب عليها. هذه الشهادة هي الوثيقة الرسمية التي تثبت واقعة عدم وجود الرصيد. بعد ذلك، يمكن للمستفيد تقديم شكاية مباشرة إلى وكيل الملك لدى المحكمة الابتدائية المختصة، مرفقة بأصل الشيك وشهادة عدم الأداء، وذلك لتحريك الدعوى العمومية ضد الساحب.' },
    { q: 'ما هي العقوبات الجنائية المقررة لجريمة إصدار شيك بدون مؤونة؟', a: 'جريمة إصدار شيك بدون مؤونة تعتبر جنحة يعاقب عليها القانون المغربي. حسب المادة 316 من مدونة التجارة، يعاقب الساحب بالحبس من سنة إلى خمس سنوات وبغرامة تتراوح بين 2.000 و 10.000 درهم، على ألا تقل قيمتها عن 25% من مبلغ الشيك. بالإضافة إلى ذلك، يمكن للمحكمة أن تقضي بعقوبات إضافية، كمنع المحكوم عليه من إصدار الشيكات لمدة تتراوح بين سنة وخمس سنوات، وذلك طبقا لمقتضيات المادة 317 من نفس المدونة.' },
    { q: 'هل يمكن لساحب الشيك تفادي المتابعة الجنائية بعد ثبوت عدم وجود المؤونة؟', a: 'نعم، يمكن لساحب الشيك تسوية وضعيته لتفادي المتابعة الجنائية أو لوضع حد لها. وفقاً للمادة 313 من مدونة التجارة، يمكن للساحب استعادة أهلية إصدار الشيكات إذا قام بأداء مبلغ الشيك الذي لم يتم وفاؤه، بالإضافة إلى أداء غرامة جبائية للخزينة العامة. تتم هذه التسوية مباشرة لدى المؤسسة البنكية المسحوب عليها، ويؤدي إثبات هذه التسوية إلى إيقاف المتابعة الجنائية في حال لم يصدر حكم نهائي في القضية.' },
    { q: 'هل يُعاقب القانون الشخص الذي يقبل شيكاً مع علمه المسبق بأنه وسيلة ضمان وليس للدفع الفوري؟', a: 'نعم، القانون المغربي لا يعاقب الساحب فقط، بل يعاقب أيضاً المستفيد الذي يقبل شيكاً على سبيل الضمان. تنص الفقرة الأخيرة من المادة 316 من مدونة التجارة صراحة على أن الشخص الذي يقبل أو يظهر شيكاً مع علمه بأن الغرض منه هو أن يكون مجرد ضمانة يخضع لنفس العقوبات المطبقة على الساحب (الحبس والغرامة). وذلك لأن الشيك أداة وفاء واجبة الدفع بمجرد الاطلاع عليها، واستخدامه كضمانة يعتبر تحويلاً لوظيفته الأساسية.' },
    { q: 'ما هي مدة التقادم التي تسقط بها الدعوى العمومية في جريمة إصدار شيك بدون مؤونة؟', a: 'تعتبر جريمة إصدار شيك بدون مؤونة جنحة من الناحية القانونية. وعليه، فإن الدعوى العمومية الناتجة عنها تتقادم بمضي أربع (4) سنوات ميلادية كاملة. يبدأ احتساب هذه المدة من يوم ارتكاب الجريمة، أي من تاريخ تقديم الشيك للأداء وثبوت عدم وجود المؤونة. هذا المبدأ العام لتقادم الجنح منصوص عليه في المادة 5 من قانون المسطرة الجنائية المغربي.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي الخطوة الأولى والأساسية قبل البدء في إجراءات تأسيس شركة تجارية بالمغرب؟', a: 'الخطوة الأولى الإلزامية هي الحصول على "الشهادة السلبية" (Certificat Négatif). هذه الوثيقة، التي يسلمها المكتب المغربي للملكية الصناعية والتجارية (OMPIC)، تثبت أن الاسم التجاري الذي اخترته لشركتك غير مستعمل ومتاح قانوناً. تعتبر هذه الشهادة ضرورية لتحرير النظام الأساسي للشركة وفتح حساب بنكي باسمها قيد التأسيس.' },
    { q: 'ما هو الشكل القانوني الأكثر شيوعاً للشركات الصغيرة والمتوسطة في المغرب، وما هي أبرز خصائصه؟', a: 'الشكل القانوني الأكثر انتشاراً هو "الشركة ذات المسؤولية المحدودة" (SARL). تتميز بكون مسؤولية الشركاء فيها محدودة في حدود حصصهم في رأس المال. يمكن تأسيسها من طرف شريك واحد (SARL d\'associé unique) أو أكثر. ينظمها القانون رقم 5.96 المتعلق بشركة التضامن وشركة التوصية البسيطة وشركة التوصية بالأسهم والشركة ذات المسؤولية المحدودة وشركة المحاصة، كما تم تعديله وتتميمه.' },
    { q: 'هل هناك حد أدنى لرأس مال الشركة ذات المسؤولية المحدودة (SARL)؟', a: 'كلا، لم يعد هناك حد أدنى لرأس المال. بموجب التعديلات التي أدخلت على القانون رقم 5.96، تم إلغاء شرط الحد الأدنى لرأس المال الذي كان محدداً في 10,000 درهم. حالياً، يمكن للشركاء تحديد مبلغ رأس المال بكل حرية في النظام الأساسي للشركة، مما يسهل بشكل كبير عملية إنشاء المقاولات.' },
    { q: 'ما هي الوثائق الرئيسية التي يجب إعدادها لإيداع ملف تأسيس الشركة لدى المحكمة التجارية؟', a: 'لإيداع ملف التأسيس لدى كتابة ضبط المحكمة التجارية المختصة، يجب تجهيز الوثائق التالية على وجه الخصوص: - نظيران من النظام الأساسي المسجل. - محضر الجمع العام التأسيسي أو قرار الشريك الوحيد بتعيين المسير (إذا لم يتم تعيينه في النظام الأساسي). - شهادة تجميد المبلغ المحرر من رأس المال مسلمة من البنك. - نسخ من بطاقات التعريف الوطنية للمسير والشركاء. - نماذج التصريح بالتقييد في السجل التجاري (نموذج 2). - الشهادة السلبية وعقد الإيجار أو شهادة ملكية مقر الشركة.' },
    { q: 'بعد الحصول على السجل التجاري، هل تعتبر الشركة جاهزة لممارسة نشاطها بشكل كامل؟', a: 'الحصول على السجل التجاري هو خطوة محورية ولكنه ليس الخطوة النهائية. بعد التقييد في السجل التجاري، يجب القيام بالإجراءات التالية لتكون الشركة ممتثلة بالكامل للقانون: 1. القيام بإجراءات الإشهار القانوني عبر النشر في جريدة للإعلانات القانونية وفي الجريدة الرسمية. 2. التسجيل لدى إدارة الضرائب للحصول على المعرف الضريبي (IF) والتعريف الموحد للمقاولة (ICE). 3. الانخراط في الصندوق الوطني للضمان الاجتماعي (CNSS). بعد استكمال هذه المراحل، تصبح الشركة جاهزة قانونياً لممارسة نشاطها التجاري بشكل كامل.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هو السن القانوني للزواج في المغرب، وهل توجد استثناءات؟', a: 'السن القانوني للزواج في المغرب هو تمام الثامنة عشرة (18) سنة شمسية كاملة للرجل والمرأة على حد سواء، وذلك حسب المادة 19 من مدونة الأسرة. ومع ذلك، يمكن لقاضي الأسرة المكلف بالزواج أن يأذن بزواج الفتى والفتاة دون سن الأهلية المحدد، بمقرر معلل يبين فيه المصلحة والأسباب المبررة لذلك. يتم ذلك بعد الاستماع لأبوي القاصر أو نائبه الشرعي، والاستعانة بخبرة طبية أو إجراء بحث اجتماعي. مقرر الاستجابة لطلب الإذن بزواج القاصر غير قابل لأي طعن، وذلك وفقاً لمقتضيات المادة 20 من نفس المدونة.' },
    { q: 'في حالة الطلاق، لمن تكون حضانة الأطفال وكيف يتم تحديدها؟', a: 'الحضانة من واجبات الأبوين ما دامت علاقة الزوجية قائمة. وفي حالة انفصالهما، تخول الحضانة للأم، ثم للأب، ثم لأم الأم، وذلك حسب الترتيب المنصوص عليه في المادة 171 من مدونة الأسرة. إذا لم يوجد أحد من هؤلاء، أو لم تتوفر فيه شروط الحضانة، فإن المحكمة تقرر، بناءً على ما لديها من قرائن وما تراه في مصلحة المحضون، إسناد الحضانة لأحد الأقارب الأكثر أهلية. يجب على الحاضن أن يكون راشداً، أميناً، وقادراً على تربية المحضون وصيانته ورعايته. تستمر الحضانة إلى حين بلوغ المحضون سن الرشد القانوني (18 سنة)، ويحق للمحضون ذكراً كان أو أنثى، عند بلوغه سن الخامسة عشرة (15) سنة، أن يختار من يحضنه من أبويه، وفقاً للمادة 166.' },
    { q: 'زوجي يرفض تطليقي. ما هي الإجراءات التي يمكنني اتخاذها لإنهاء العلاقة الزوجية؟', a: 'إذا رفض الزوج الطلاق، يمكن للزوجة اللجوء إلى القضاء لطلب التطليق لأحد الأسباب التي حددتها مدونة الأسرة. الإجراء الأكثر شيوعاً هو "التطليق للشقاق". وفقاً للمواد من 94 إلى 97، يمكن لأي من الزوجين أن يتقدم بطلب للمحكمة بسبب الشقاق الذي يجعل استمرار العلاقة الزوجية مستحيلاً. تقوم المحكمة بمحاولات للصلح بين الزوجين، وإذا تعذر الصلح وثبت للمحكمة وجود الشقاق، فإنها تحكم بالتطليق وبالمستحقات المترتبة عليه (نفقة العدة، المتعة، السكنى). هذه الآلية تضمن للزوجة حقها في إنهاء العلاقة الزوجية حتى في حالة رفض الزوج.' },
    { q: 'هل يمكن للرجل الزواج بزوجة ثانية في المغرب؟ وما هي الشروط القانونية لذلك؟', a: 'نعم، لكن بشروط صارمة جداً. تمنع مدونة الأسرة التعدد إلا إذا توفرت شروط استثنائية وبإذن من القاضي. حسب المادتين 40 و 41، لا تأذن المحكمة بالتعدد إلا بعد التحقق من الشروط التالية: 1. وجود مبرر موضوعي واستثنائي (مثلاً، مرض الزوجة الأولى بمرض يمنع المعاشرة الزوجية وثبت بتقرير طبي). 2. توفر الزوج على الموارد الكافية لإعالة الأسرتين وضمان جميع الحقوق من نفقة وإسكان ومساواة في جميع أوجه الحياة. يجب على المحكمة استدعاء الزوجة الأولى المراد التزوج عليها للحضور. إذا توصلت شخصياً ولم تحضر أو امتنعت عن تسلم الاستدعاء، يوجه لها القاضي إنذاراً عن طريق عون قضائي. لا يؤذن بالتعدد إذا لم توافق الزوجة الأولى، أو إذا ثبت للمحكمة من خلال المناقشات عدم قدرة الزوج على ضمان العدل بين الزوجتين.' },
    { q: 'كيف يتم تقسيم الممتلكات المكتسبة خلال فترة الزواج عند الطلاق؟', a: 'المبدأ الأساسي في القانون المغربي هو نظام فصل الأموال، حيث أن لكل من الزوجين ذمة مالية مستقلة عن ذمة الآخر، كما تنص على ذلك المادة 49 من مدونة الأسرة. لكن، يمكن للزوجين الاتفاق كتابةً في وثيقة مستقلة عن عقد الزواج على كيفية تدبير واستثمار أموالهما المكتسبة خلال فترة الزواج وتوزيعها.  في حالة عدم وجود مثل هذا الاتفاق، يمكن اللجوء إلى القواعد العامة للإثبات ليثبت كل طرف مساهمته في تنمية أموال الأسرة. بناءً على ذلك، يمكن للمحكمة، عند الطلاق، أن تأخذ بعين الاعتبار عمل كل من الزوجين وما قدمه من مجهودات وما تحمله من أعباء لتقدير مساهمته في تنمية أموال الأسرة وتحديد نصيبه منها.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي أنواع الطلاق والتطليق الرئيسية التي ينص عليها القانون المغربي؟', a: 'تنقسم طرق إنهاء العلاقة الزوجية في مدونة الأسرة المغربية إلى فئتين رئيسيتين: 1. الطلاق تحت المراقبة القضائية: ويشمل الطلاق الذي يوقعه الزوج (المواد 78 إلى 93)، والطلاق الخلعي (المواد 115 إلى 120)، والطلاق بالاتفاق (المادة 114). في هذه الحالات، لا يتم إثبات الطلاق إلا بعد الحصول على إذن من المحكمة ومحاولة الصلح بين الزوجين. 2. التطليق القضائي: وهو الطلاق الذي تحكم به المحكمة بناءً على طلب أحد الزوجين لأسباب محددة قانونًا، وأبرزها:    - التطليق للشقاق (المواد 94 إلى 97)، وهو الأكثر شيوعًا.    - التطليق لعدم الإنفاق (المادة 102).    - التطليق للغيبة (المادة 104).    - التطليق للعيب (المادة 107).    - التطليق للضرر (المادة 99).' },
    { q: 'ما هي المستحقات المالية التي يحق للزوجة المطالبة بها بعد وقوع الطلاق؟', a: 'تحدد مدونة الأسرة المستحقات المالية للزوجة بعد الطلاق أو التطليق، وتشمل هذه المستحقات بشكل أساسي ما يلي: - مؤخر الصداق (إن وجد): وهو الجزء المتبقي من المهر المتفق عليه في عقد الزواج ولم يتم أداؤه. - نفقة العدة: وهي واجبة على الزوج طوال فترة العدة، وتُقدر بما يوازي ما كان ينفقه عليها خلال الحياة الزوجية، وتشمل الغذاء والكسوة والعلاج والسكن أو مقابله المالي. (المادة 84). - المتعة: وهي مبلغ مالي يُحكم به للزوجة المطلقة كجبر للضرر المعنوي اللاحق بها جراء الطلاق. يراعي القاضي في تقديرها فترة الزواج، والوضعية المالية للزوج، وأسباب الطلاق، ومدى مسؤولية كل طرف في وقوعه. (المادة 84). - أجرة الحضانة ومصاريف الأطفال: في حال وجود أطفال، تستحق الأم الحاضنة أجرة عن حضانتها، بالإضافة إلى النفقة الخاصة بالأطفال والتي تشمل كل احتياجاتهم الأساسية من تعليم وصحة وملبس. (المادة 166).' },
    { q: 'ما هي مسطرة التطليق للشقاق وكيف تتم؟', a: 'التطليق للشقاق هو آلية قانونية تسمح لأي من الزوجين بطلب إنهاء العلاقة الزوجية عند استحالة استمرارها. وتتم المسطرة وفق الخطوات التالية: 1. تقديم مقال: يقدم أحد الزوجين (أو كلاهما) مقالاً إلى قسم قضاء الأسرة بالمحكمة الابتدائية المختصة، يوضح فيه الأسباب التي تجعل العلاقة الزوجية مستحيلة. 2. محاولة الصلح: تستدعي المحكمة الزوجين لمحاولة الصلح، وهي إجراء إلزامي. يمكن للمحكمة أن تستعين بحكمين من أهل الزوجين أو أي شخص آخر تراه مناسبًا للمساعدة في الإصلاح بينهما. (المادة 94). 3. تحديد المسؤولية والمستحقات: إذا فشل الصلح، تحدد المحكمة مبلغًا ماليًا يودعه الزوج المدعي بصندوق المحكمة خلال أجل معين، لتغطية مستحقات الزوجة والأطفال إن وجدوا. 4. الحكم بالتطليق: بعد إيداع المبلغ، تصدر المحكمة حكمًا بالتطليق للشقاق. إذا كان الطلب مقدمًا من الزوجة وثبتت مسؤولية الزوج عن الشقاق، فإنها تحصل على كافة مستحقاتها. أما إذا كانت هي المسؤولة، فقد تفقد بعض مستحقاتها باستثناء نفقة العدة ومصاريف الأطفال. (المادة 97).' },
    { q: 'لمن تؤول حضانة الأطفال بعد الطلاق حسب القانون المغربي؟', a: 'الحضانة في القانون المغربي هي حفظ الولد مما قد يضره والقيام بتربيته ورعاية مصالحه. عند وقوع الطلاق، تؤول الحضانة حسب الترتيب التالي مع مراعاة المصلحة الفضلى للطفل دائمًا: 1. الأم: هي الأحق بحضانة أطفالها ما لم يوجد مانع شرعي أو قانوني. 2. الأب: في حال عدم وجود الأم أو عدم أهليتها. 3. الجدة للأم: في حال عدم وجود الأبوين أو عدم أهليتهما. بعد ذلك، ينتقل الحق إلى الأقارب الآخرين حسب الترتيب الذي حددته المادة 171 من مدونة الأسرة. ويشدد القانون على أن المحكمة تتخذ قرارها دائمًا بناءً على ما تراه في "مصلحة المحضون"، ويمكنها مخالفة الترتيب المذكور إذا اقتضت مصلحة الطفل ذلك، مع توفير بيئة سكن ملائمة ومستقلة للحاضنة والأطفال.' },
    { q: 'هل يمكن للزوجين الاتفاق على الطلاق بشكل ودي، وما هي الإجراءات المتبعة؟', a: 'نعم، أتاحت مدونة الأسرة إمكانية إنهاء العلاقة الزوجية بشكل ودي من خلال "الطلاق الاتفاقي". وتتم إجراءاته كالتالي: 1. الاتفاق المبدئي: يمكن للزوجين أن يتفقا على مبدأ إنهاء العلاقة الزوجية دون شروط، أو يتفقا عليه مع تنظيم شروطه وآثاره (مثل الحضانة، النفقة، زيارة المحضون، ومبلغ المتعة). 2. تقديم الطلب: يقدم الزوجان أو أحدهما طلبًا للمحكمة يتضمن اتفاقهما. يجب أن يكون الاتفاق مصادقًا على توقيعاتهما أو محررًا من طرف محامٍ أو موثق. 3. محاولة الصلح: تقوم المحكمة بمحاولة الصلح بين الزوجين. إذا أصرّا على طلبهما، فإن المحكمة تأخذ علما بالاتفاق. 4. الإذن بالطلاق: تصدر المحكمة إذنًا بتوثيق الطلاق لدى عدلين منتصبين للإشهاد. لا يعتبر الطلاق واقعًا إلا بعد توثيقه لدى العدلين ومخاطبة ضابط الحالة المدنية لتضمينه في سجلات الحالة المدنية. (المادة 114 من مدونة الأسرة).' },
  ],
  ...
  faq_ar: [
    { q: 'ما هو الأجل العام لتقادم الالتزامات المدنية في المغرب؟', a: 'القاعدة العامة هي أن كل الدعاوى الناشئة عن الالتزام تتقادم بمرور خمس عشرة (15) سنة، وذلك فيما عدا الاستثناءات التي يحددها القانون بنصوص خاصة. يُعرف هذا الأجل بالتقادم الطويل أو العادي، وهو المبدأ الأساسي الذي يُرجع إليه في حالة عدم وجود نص خاص يقضي بأجل أقصر. يستند هذا المبدأ إلى مقتضيات الفصل 387 من قانون الالتزامات والعقود المغربي.' },
    { q: 'هل توجد آجال تقادم أقصر لبعض الديون أو الدعاوى؟', a: 'نعم، نص المشرع المغربي على آجال تقادم خاصة وقصيرة لبعض الدعاوى حمايةً لاستقرار المعاملات. على سبيل المثال، وطبقاً للفصل 388 من قانون الالتزامات والعقود، تتقادم بسنة واحدة دعاوى التجار والموردين وأصحاب المصانع من أجل ما قدموه لغير التجار، ودعاوى أصحاب الفنادق والمطاعم. كما تتقادم بسنتين، بموجب الفصل 389، دعاوى الأطباء والجراحين والصيادلة والمحامين والمهندسين من أجل أتعابهم والخدمات التي قدموها.' },
    { q: 'متى يبدأ سريان مدة التقادم؟', a: 'يبدأ سريان مدة التقادم من اليوم الذي يصبح فيه الدين مستحق الأداء ويتمكن الدائن من المطالبة به قانوناً. بالنسبة للالتزامات المعلقة على شرط، لا يبدأ التقادم إلا من يوم تحقق الشرط. وفي دعاوى الضمان، كضمان العيوب الخفية، لا يبدأ سريان الأجل إلا من تاريخ اكتشاف العيب. هذه القواعد منظمة بشكل أساسي في الفصل 380 من قانون الالتزامات والعقود.' },
    { q: 'هل يمكن إيقاف أو قطع مدة التقادم؟ وما الفرق بينهما؟', a: 'نعم، يمكن أن يتوقف التقادم أو ينقطع.  1. وقف التقادم: يعني تعليق سريان المدة مؤقتاً لسبب يمنع الدائن من المطالبة بحقه (مثل القوة القاهرة أو كونه قاصراً غير ممثل قانوناً). عند زوال سبب الوقف، تستأنف المدة سيرها من حيث توقفت، مع احتساب المدة السابقة (الفصل 392 من ق.ل.ع). 2. قطع التقادم: يؤدي إلى محو المدة التي انقضت وبدء سريان تقادم جديد بنفس المدة الأصلية. من أهم أسباب قطع التقادم المطالبة القضائية، أو التنبيه الرسمي، أو إقرار المدين بالدين صراحة أو ضمناً (الفصلان 394 و 395 من ق.ل.ع).' },
    { q: 'ما هو الأثر القانوني للتقادم؟ وهل يمكن للقاضي إثارته تلقائياً؟', a: 'الأثر القانوني للتقادم هو انقضاء الدعوى وليس انقضاء الحق نفسه، مما يعني أن المدين يتحلل من الالتزام قانوناً وتصبح الدعوى للمطالبة به غير مقبولة. لكن، لا يمكن للمحكمة أن تثير التقادم من تلقاء نفسها، بل يجب على من له مصلحة فيه (المدين عادةً) أن يتمسك به كدفع أمام القضاء. وإذا قام المدين بالوفاء بدين سقط بالتقادم وهو يعلم بذلك، فإنه يعتبر وفاءً صحيحاً لالتزام طبيعي ولا يحق له استرداد ما دفعه. تستند هذه الأحكام إلى الفصلين 371 و 372 من قانون الالتزامات والعقود.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي أول خطوة لرفع دعوى مدنية أمام المحاكم المغربية؟', a: 'تبدأ الإجراءات بتقديم مقال افتتاحي للدعوى إلى كتابة ضبط المحكمة الابتدائية المختصة. يجب أن يكون هذا المقال موقعًا من طرف محامٍ مسجل في هيئة من هيئات المحامين بالمغرب (ما لم ينص القانون على خلاف ذلك)، وأن يتضمن البيانات الإلزامية المنصوص عليها في الفصل 32 من قانون المسطرة المدنية، ومنها: تحديد هوية الأطراف الكاملة وموطنهم أو محل إقامتهم، وعرض موجز لوقائع الدعوى، والطلبات، والوسائل القانونية التي تؤسس عليها الدعوى.' },
    { q: 'توصلت باستدعاء من المحكمة، ماذا يجب أن أفعل؟ وما هي عواقب عدم الحضور؟', a: 'التوصل باستدعاء يعني أنك طرف في نزاع قضائي ويوجب عليك التفاعل. يُنصح بشدة بتوكيل محامٍ لإعداد دفاعك وتقديم مذكرة جوابية تتضمن دفوعك ووسائل دفاعك. إذا تم تبليغك بصفة قانونية ولم تحضر الجلسة أو لم تقدم جوابًا، يمكن للمحكمة أن تصدر حكمًا غيابيًا في حقك، وذلك استنادًا إلى مقتضيات الفصل 47 من قانون المسطرة المدنية. هذا الحكم يكون قابلاً للتنفيذ ضدك وقد يؤدي إلى خسارتك للقضية.' },
    { q: 'خسرت قضيتي أمام المحكمة الابتدائية. هل يمكنني الطعن في الحكم وما هو الأجل القانوني لذلك؟', a: 'نعم، الأحكام الصادرة عن المحاكم الابتدائية قابلة للطعن بالاستئناف، ما لم ينص القانون على خلاف ذلك. يتم تقديم مقال الاستئناف لدى كتابة ضبط المحكمة الابتدائية التي أصدرت الحكم. الأجل القانوني لممارسة هذا الطعن هو ثلاثون (30) يومًا. ويبدأ سريان هذا الأجل من تاريخ تبليغ الحكم إلى الشخص نفسه أو في موطنه الحقيقي أو المختار، وذلك وفقًا لمقتضيات الفصل 134 من قانون المسطرة المدنية.' },
    { q: 'هل الاستعانة بمحامٍ إلزامية في جميع القضايا المدنية؟', a: 'كقاعدة عامة، يعتبر تنصيب محامٍ إلزاميًا لتقديم المقالات والمذكرات والمستنتجات أمام أغلب المحاكم، وذلك بموجب الفصل 32 من قانون المسطرة المدنية. غير أن هناك استثناءات مهمة نص عليها القانون لا تكون فيها إلزامية المحامي قائمة، ومن أبرزها القضايا التي تختص بها أقسام قضاء القرب، وقضايا الحالة المدنية، والقضايا التي تنظرها المحاكم الابتدائية كغرف استئنافية، وغيرها من الحالات المحددة بنص قانوني خاص.' },
    { q: 'لقد ربحت قضيتي وصدر لصالحي حكم نهائي. كيف يمكنني تنفيذ هذا الحكم والحصول على حقوقي؟', a: 'بعد الحصول على حكم نهائي حائز لقوة الشيء المقضي به ومذيل بالصيغة التنفيذية، يجب عليك فتح ملف للتنفيذ. يتم ذلك بتقديم طلب إلى رئيس كتابة الضبط بالمحكمة التي أصدرت الحكم الابتدائي. بعد ذلك، يُعهد بملف التنفيذ إلى أحد المفوضين القضائيين الذي يتولى مباشرة إجراءات التنفيذ ضد الطرف المحكوم عليه، كتبليغه لأداء ما بذمته، وفي حال امتناعه، يمكن اللجوء إلى إجراءات جبرية كالحجز على ممتلكاته المنقولة أو العقارية، وذلك طبقًا للقواعد المنصوص عليها في قانون المسطرة المدنية (الفصول 429 وما بعدها).' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي مستويات الجماعات الترابية حسب التنظيم الإداري المغربي؟', a: 'ينص دستور المملكة المغربية، وتحديداً في فصله 135، على أن الجماعات الترابية هي الجهات، والعمالات والأقاليم، والجماعات. وهي أشخاص اعتبارية خاضعة للقانون العام، تسير شؤونها بكيفية ديمقراطية. وتعتبر الجهة والجماعة مستويين رئيسيين، بينما تشكل العمالة أو الإقليم حلقة وصل بينهما وتضطلع بمهام التنسيق والدعم.' },
    { q: 'بصفتي مواطناً، ما هي الآليات القانونية التي يمكنني استخدامها للمشاركة في صنع القرار على مستوى جماعتي؟', a: 'يضمن القانون للمواطنين والمواطنات والجمعيات آليات للمشاركة في تدبير الشأن المحلي. أهمها الحق في تقديم العرائض إلى مجلس الجماعة بهدف إدراج نقطة تدخل في اختصاصه ضمن جدول أعماله، وذلك وفق شروط محددة. كما يمكن للمواطنين المشاركة في الجلسات العمومية للمجلس. تستند هذه الآليات إلى الفصل 139 من الدستور والقوانين التنظيمية المتعلقة بالجماعات الترابية (مثل القانون التنظيمي رقم 113.14 للجماعات).' },
    { q: 'ما هي الاختصاصات الذاتية الأساسية التي تضطلع بها الجماعة (البلدية) بشكل مباشر؟', a: 'تتمتع الجماعة باختصاصات ذاتية تمارسها في مجال ترابها، وتشمل بشكل أساسي: التخطيط العمراني وإصدار رخص البناء والتجزئة، إحداث وتدبير المرافق والتجهيزات العمومية المحلية (كالطرق والإنارة العمومية وتوزيع الماء والكهرباء والتطهير السائل)، تدبير النفايات المنزلية، صيانة المقابر، وتنظيم السير والجولان. هذه الاختصاصات محددة بدقة بموجب القانون التنظيمي رقم 113.14 المتعلق بالجماعات.' },
    { q: 'من يمارس الرقابة على مقررات مجلس الجماعة؟ وهل يمكن الطعن فيها قضائياً؟', a: 'تخضع مقررات مجلس الجماعة للرقابة الإدارية التي يمارسها عامل العمالة أو الإقليم. إذا تبين للعامل أن مقرراً ما مخالف للقوانين والأنظمة الجاري بها العمل، يمكنه التعرض عليه وإحالته على المحكمة الإدارية المختصة لطلب بطلانه. بالإضافة إلى ذلك، يحق لكل متضرر من مقرر جماعي أن يطعن فيه أمام القضاء الإداري عبر دعوى الإلغاء بسبب الشطط في استعمال السلطة، وذلك طبقاً للمادة 117 من القانون التنظيمي 113.14.' },
    { q: 'كيف يتم تمويل ميزانية الجماعات الترابية ومن هي الجهة المسؤولة عن تدقيق حساباتها؟', a: 'تعتمد الجماعات الترابية في تمويلها على موارد ذاتية (ضرائب ورسوم محلية كضريبة الخدمات الجماعية)، وموارد محولة من الدولة (كحصة الجماعة من الضريبة على القيمة المضافة)، بالإضافة إلى الاقتراضات. أما مهمة الرقابة العليا على ماليتها، فهي موكلة للمجالس الجهوية للحسابات، التي تقوم بتدقيق حسابات الجماعات والتأكد من سلامة تدبيرها المالي، وذلك بموجب القانون رقم 62.99 المتعلق بمدونة المحاكم المالية.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'حالات وأسباب عزل أعضاء المجالس الجماعية',
      content: 'ينظم القانون التنظيمي رقم 111.14 المتعلق بالجماعات الإطار القانوني الصارم الذي يحدد الحالات التي يمكن فيها تجريد عضو منتخب من ولايته الانتخابية. يهدف هذا الإطار إلى حماية استقرار المجالس المنتخبة مع ضمان احترام مبادئ النزاهة والمسؤولية في تدبير الشأن العام المحلي.',
      bullets: [
        'التنافي مع المصلحة الجماعية: طبقا للمادة 65 من القانون التنظيمي 111.14، يُمنع على كل عضو بالمجلس أن يربط مصالح خاصة مع الجماعة. في حالة ثبوت ذلك، يقوم عامل العمالة أو الإقليم بإنذار العضو المعني لتسوية وضعيته خلال 10 أيام، وفي حالة عدم الاستجابة، يحيل العامل الأمر إلى المحكمة الإدارية التي يمكنها أن تقضي بعزل العضو.',
        'التغيب غير المبرر: إذا تغيب عضو عن حضور ثلاث دورات متتالية أو خمس دورات متقطعة خلال سنة واحدة دون عذر يقبله المجلس، يمكن للمجلس، بعد استدعاء العضو المعني لتقديم إيضاحات، أن يقدم ملتمسا بإقالته إلى المحكمة الإدارية. وتعتبر هذه الإقالة بمثابة عزل قضائي (المادة 67).',
        'الإدانة الجنائية النهائية: كل عضو صدر في حقه حكم قضائي نهائي بالإدانة في إحدى الجرائم التي تؤدي إلى عدم الأهلية الانتخابية، يتم عزله بقوة القانون. يقوم عامل العمالة أو الإقليم بإحالة الأمر فورا إلى المحكمة الإدارية لمعاينة وتصريح العزل (المادة 20).',
        'الاستقالة الحكمية: يعتبر في حكم المعزول كل عضو امتنع عن أداء المهام المنوطة به بمقتضى القانون دون عذر مقبول. بعد إنذاره من طرف الرئيس أو العامل، وفي حالة استمرار الرفض، يمكن إحالة الأمر إلى القضاء الإداري لإقرار الاستقالة الحكمية التي تأخذ آثار العزل (المادة 68).',
        'فقدان الأهلية الانتخابية: يفقد العضو صفته كمنتخب بمجرد فقدانه لأحد شروط الأهلية الانتخابية المنصوص عليها في القانون رقم 59.11 المتعلق بانتخاب أعضاء مجالس الجماعات الترابية. يقوم العامل بإحالة الأمر إلى المحكمة الإدارية التي تصرح بإسقاط العضوية.',
      ],
    },
    {
      h2: 'المسطرة الخاصة بعزل رئيس المجلس الجماعي',
      content: 'نظرا للمسؤوليات التنفيذية الجسيمة الملقاة على عاتق رئيس المجلس، فقد خصه المشرع بمسطرة عزل خاصة ومشددة، توازن بين ضرورة استمرارية المرفق العام ومبدأ ربط المسؤولية بالمحاسبة. هذه المسطرة تقع بالكامل تحت إشراف السلطة القضائية الإدارية.',
      bullets: [
        'الأفعال الموجبة للعزل: تنص المادة 64 من القانون التنظيمي 111.14 على أن عزل الرئيس يمكن أن يتم في حالة ارتكابه \'أفعالا خطيرة تخل بأخلاقيات المرفق العمومي ومصالح الجماعة\'. هذا المفهوم الواسع يشمل على سبيل المثال سوء التدبير المالي، أو استغلال النفوذ، أو عرقلة السير العادي لمصالح الجماعة.',
        'مبادرة عامل العمالة أو الإقليم: مسطرة العزل لا يمكن أن يبادر بها أعضاء المجلس، بل هي حكر على عامل العمالة أو الإقليم الذي يمثل السلطة المركزية. يقوم العامل بتوجيه طلب العزل إلى المحكمة الإدارية المختصة.',
        'إجراء التوقيف المؤقت: كإجراء تحفظي، يمكن للعامل، بموجب قرار معلل، توقيف الرئيس عن ممارسة مهامه لمدة لا تتجاوز شهرا واحدا. خلال هذه الفترة، يتولى أحد نواب الرئيس، حسب الترتيب، تسيير شؤون الجماعة بشكل مؤقت.',
        'الإحالة على القضاء الإداري: يجب على العامل إحالة ملف العزل على المحكمة الإدارية داخل أجل التوقيف (شهر واحد). إذا لم يقم بذلك، يعود الرئيس لممارسة مهامه تلقائيا. المحكمة تبت في الطلب في أجل لا يتعدى شهرا من تاريخ توصلها بالملف.',
        'الحكم القضائي بالعزل: المحكمة الإدارية هي الجهة الوحيدة المخولة لإصدار حكم نهائي بعزل الرئيس. حكمها يكون قابلا للاستئناف أمام محكمة الاستئناف الإدارية. العزل لا يصبح نهائيا إلا بعد استنفاد جميع طرق الطعن.',
        'آثار العزل: يترتب على الحكم النهائي بالعزل فقدان الرئيس لصفته كرئيس وكعضو في المجلس الجماعي. يتم بعد ذلك دعوة المجلس لانتخاب رئيس جديد ومكتب جديد وفقا للمساطر القانونية المعمول بها.',
      ],
    },
    {
      h2: 'الطعون القضائية والآثار المترتبة على قرار العزل',
      content: 'بما أن قرار العزل هو حكم قضائي صادر عن المحكمة الإدارية، فإنه يخضع لجميع ضمانات المحاكمة العادلة، بما في ذلك الحق في الطعن. وتترتب على هذا الحكم آثار قانونية وإدارية هامة تؤثر على تركيبة وسير عمل المجلس الجماعي.',
      bullets: [
        'الحق في الطعن بالاستئناف: يمكن للعضو أو الرئيس المعزول الطعن في الحكم الابتدائي الصادر عن المحكمة الإدارية أمام محكمة الاستئناف الإدارية داخل الآجال القانونية. الطعن بالاستئناف لا يوقف تنفيذ الحكم الابتدائي بالعزل، إلا إذا قررت محكمة الاستئناف خلاف ذلك بناء على طلب صريح.',
        'الطعن بالنقض: الأحكام الصادرة عن محاكم الاستئناف الإدارية يمكن الطعن فيها بالنقض أمام محكمة النقض، التي تراقب مدى التطبيق السليم للقانون من طرف قضاة الموضوع دون الخوض في وقائع القضية مجددا.',
        'التصريح بشغور المقعد: بمجرد أن يصبح حكم العزل نهائيا وباتا، يقوم عامل العمالة أو الإقليم بإصدار قرار يصرح بموجبه بشغور المقعد الذي كان يشغله العضو المعزول، ويتم إخبار رئيس المجلس ووزارة الداخلية بذلك.',
        'تنظيم انتخابات جزئية: يترتب على التصريح بشغور المقعد تنظيم انتخابات جزئية لملء المقعد الشاغر داخل أجل ثلاثة (3) أشهر من تاريخ التصريح بالشغور، ما لم يقع الشغور خلال السنة الأخيرة من الولاية الانتدابية للمجلس، ففي هذه الحالة لا يتم تنظيم انتخابات جزئية.',
        'عدم الأهلية للترشح مستقبلا: في الحالات الخطيرة، خصوصا تلك المتعلقة بجرائم الفساد المالي أو الإخلال بالثقة العامة، يمكن للحكم القضائي بالعزل أن يقترن بعقوبة إضافية تتمثل في عدم الأهلية للترشح للانتخابات الجماعية لمدة ولاية انتدابية واحدة أو ولايتين، كإجراء ردعي لضمان نزاهة المشهد الانتخابي.',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي الأسباب الرئيسية التي قد تؤدي إلى عزل عضو منتخب في مجلس جماعي؟', a: 'يمكن عزل عضو مجلس جماعي أو رئيسه بناءً على عدة أسباب محددة قانونًا. وفقًا للمادة 64 من القانون التنظيمي رقم 113.14 المتعلق بالجماعات، يتم العزل إذا ارتكب العضو أفعالًا مخالفة للقوانين والأنظمة الجاري بها العمل، أو أفعالًا تضر بأخلاقيات المرفق العمومي ومصالح الجماعة. تشمل هذه الأفعال على سبيل المثال لا الحصر، استغلال النفوذ، أو ربط مصالح خاصة مع مصالح الجماعة، أو ارتكاب خروقات جسيمة في مجال التعمير. يتم العزل بحكم قضائي من المحكمة الإدارية بناءً على طلب من عامل العمالة أو الإقليم.' },
    { q: 'من هي الجهة المخولة بطلب عزل رئيس أو عضو مجلس جماعي، وما هي المسطرة المتبعة؟', a: 'الجهة المخولة قانونًا بطلب عزل عضو أو رئيس مجلس جماعي هي عامل العمالة أو الإقليم الذي تقع الجماعة في نفوذه الترابي. تتم المسطرة عبر إحالة الأمر من طرف العامل إلى المحكمة الإدارية المختصة. يمكن للعامل أن يقرر توقيف المعني بالأمر عن ممارسة مهامه إلى حين بث المحكمة في طلب العزل. تصدر المحكمة حكمها بالعزل إذا ثبت لديها وجود الأسباب الموجبة لذلك، ويكون حكمها قابلاً للاستئناف. هذه المسطرة منصوص عليها بوضوح في المادة 64 من القانون التنظيمي رقم 113.14.' },
    { q: 'ماذا يترتب عن مشاركة عضو في مداولة للمجلس يكون له فيها مصلحة شخصية؟', a: 'يمنع القانون على أي عضو في مجلس الجماعة أن يشارك في مداولة تهمه بصفة شخصية أو تهم زوجه أو أصوله أو فروعه. تنص المادة 65 من القانون التنظيمي رقم 113.14 على أنه يُمنع على كل عضو أن يربط مصالح خاصة مع الجماعة أو أن يبرم معها أعمالاً أو عقود الكراء أو اقتناء أو تبادل. في حالة مشاركة عضو في مداولة له فيها مصلحة، تكون تلك المداولة باطلة بقوة القانون، ويمكن أن يتعرض العضو المعني لمسطرة العزل أمام المحكمة الإدارية إذا ثبت تعمده الإضرار بمصالح الجماعة.' },
    { q: 'ما هي عواقب تغيب عضو المجلس عن دورات المجلس بشكل متكرر وبدون عذر مقبول؟', a: 'يعتبر التغيب المتكرر بدون عذر مقبول بمثابة إقالة حكمية. حسب المادة 67 من القانون التنظيمي رقم 113.14، كل عضو تغيب عن ثلاث دورات متتالية أو خمس دورات بصفة متقطعة دون مبرر يقبله المجلس، يتم إخباره من طرف رئيس المجلس بضرورة تقديم مبررات غيابه. إذا لم يقدم العضو مبررًا، أو كانت مبرراته غير مقبولة، يقوم المجلس في الدورة الموالية بمعاينة هذا الغياب وإعلان إقالة العضو المعني. يخبر الرئيس عامل العمالة أو الإقليم بهذا الإجراء لاتخاذ ما يلزم لتعويض العضو المقال.' },
    { q: 'هل يمكن لعضو تم عزله من مجلس جماعي أن يترشح للانتخابات الموالية؟', a: 'يترتب على قرار العزل القضائي أثر مباشر على الأهلية الانتخابية للعضو المعزول. تنص الفقرة الأخيرة من المادة 64 من القانون التنظيمي رقم 113.14 صراحة على أن العزل يترتب عليه عدم أهلية العضو المعزول للترشح في الانتخابات الموالية داخل نفس الجماعة التي تم عزله منها. هذا الإجراء يهدف إلى ضمان عدم عودة الأشخاص الذين ثبت إخلالهم بواجباتهم ومسؤولياتهم إلى تدبير الشأن العام المحلي في الدورة الانتخابية التي تلي مباشرة قرار العزل.' },
  ],
  ...
  faq_ar: [
    { q: 'كمغربي مقيم بالخارج، كيف يمكنني توكيل شخص في المغرب لإدارة ممتلكاتي أو بيع عقار؟ وهل الوكالة المنجزة في القنصلية كافية؟', a: 'يمكنك إبرام عقد وكالة لتفويض شخص ينوب عنك في المغرب. بخصوص بيع أو شراء أو إنشاء حقوق عينية على عقار، يفرض القانون شكليات محددة. فبموجب المادة 4 من القانون رقم 39.08 المتعلق بمدونة الحقوق العينية، يجب أن تحرر جميع التصرفات المتعلقة بنقل الملكية أو إنشاء الحقوق العينية الأخرى أو نقلها أو تعديلها أو إسقاطها بموجب محرر رسمي أو محرر ثابت التاريخ يتم تحريره من طرف محام مقبول للترافع أمام محكمة النقض. الوكالة المنجزة لدى القنصلية المغربية بالخارج تعتبر محرراً رسمياً وهي صالحة لإبرام هذه التصرفات، شريطة أن تكون خاصة ومفصلة تحدد بدقة العقار موضوع التصرف وطبيعته (بيع، شراء، رهن...). أما لإجراءات الإدارة العادية (كتسلم إيجار أو متابعة إجراءات إدارية)، فالوكالة العرفية قد تكون كافية، وإن كان يفضل دائماً توثيقها لتجنب أي نزاع.' },
    { q: 'أملك عقاراً في المغرب، وعند عودتي لقضاء العطلة، وجدته محتلاً من طرف شخص لا تربطني به أي علاقة قانونية. ما هي الإجراءات التي يجب علي اتخاذها لاسترجاعه؟', a: 'يعتبر الاستيلاء على عقار الغير جريمة يعاقب عليها القانون. يمكنك سلوك مسطرتين متوازيتين: 1. المسطرة الجنائية (الأكثر سرعة وفعالية): تقديم شكاية مباشرة إلى وكيل الملك لدى المحكمة الابتدائية التي يقع العقار في دائرة نفوذها، من أجل "انتزاع حيازة عقار"، وهي الجريمة المنصوص عليها في الفصل 570 من القانون الجنائي. بعد البحث الذي تجريه الضابطة القضائية، يمكن للنيابة العامة أن تأمر بإرجاع الحالة إلى ما كانت عليه وطرد المحتل. 2. المسطرة المدنية: رفع دعوى استعجالية أمام رئيس المحكمة الابتدائية للمطالبة بطرد المحتل لكونه يحتل العقار بدون سند قانوني. يجب إثبات ملكيتك للعقار (عبر شهادة الملكية إذا كان العقار محفظاً) وإثبات واقعة الاحتلال (عبر محضر معاينة ينجزه مفوض قضائي). ينصح بالتحرك بسرعة فور علمك بالاحتلال لتدعيم موقفك القانوني.' },
    { q: 'تزوجت في بلد إقامتي الأوروبي من مواطنة أجنبية. هل هذا الزواج معترف به تلقائياً في المغرب؟ وما هي الإجراءات اللازمة لتسجيله؟', a: 'الزواج المبرم في الخارج وفق قوانين بلد الإقامة لا يعترف به تلقائياً في المغرب، بل يتطلب استصدار حكم قضائي يسمى "الأمر بتذييل العقد الأجنبي بالصيغة التنفيذية". تنص المادة 128 من مدونة الأسرة على أنه يجب على المغاربة الذين أبرموا عقود زواجهم بالخارج إيداع نسخة منه لدى المصالح القنصلية المغربية. بعد ذلك، يجب تقديم طلب إلى قسم قضاء الأسرة بالمحكمة الابتدائية (إما لمحل السكنى بالمغرب، أو لمحل إبرام العقد، أو لمدينة الرباط عند عدم وجود موطن بالمغرب). تتحقق المحكمة من صحة العقد ومن عدم تعارضه مع النظام العام المغربي ومقتضيات مدونة الأسرة (كغياب الموانع الشرعية وتوفر الأركان الأساسية للزواج). بعد صدور الحكم، يصبح الزواج معترفاً به رسمياً ويمكن تسجيله في سجلات الحالة المدنية المغربية.' },
    { q: 'توفي والدي في المغرب وترك تركة. كيف يمكنني، وأنا مقيم بالخارج، إثبات صفتي كوريث والمطالبة بحصتي؟', a: 'الخطوة الأولى والأساسية هي إنجاز "رسم الإراثة". وهو وثيقة رسمية يحررها العدول، تثبت وفاة الهالك وتحدد ورثته الشرعيين وحصة كل واحد منهم. لإنجازها، يجب الإدلاء بشهادة وفاة الهالك، ونسخ من بطاقات هوية الورثة، وعقود الزواج لإثبات العلاقة الزوجية. بما أنك مقيم بالخارج، يمكنك توكيل شخص في المغرب (قريب أو محام) بموجب وكالة خاصة ومصادق عليها لدى القنصلية المغربية، لينوب عنك في إجراءات إعداد رسم الإراثة. بعد الحصول على هذا الرسم، يمكنك المطالبة بحصتك في التركة. إذا امتنع باقي الورثة عن إجراء القسمة الرضائية، يمكنك اللجوء إلى المحكمة لرفع دعوى "القسمة القضائية" استناداً إلى رسم الإراثة، وذلك وفقاً لمقتضيات الكتاب السادس من مدونة الأسرة المتعلق بالميراث.' },
    { q: 'أرغب في شراء عقار في المغرب. ما هي أهم الاحتياطات القانونية التي يجب اتخاذها لتأمين عملية الشراء، خصوصاً إذا كان العقار غير محفظ؟', a: 'تأمين شراء عقار يتطلب حذراً بالغاً، وتختلف درجة الأمان حسب طبيعة العقار: 1. العقار المحفظ: هو الخيار الأكثر أماناً. الرسم العقاري الخاص به يعتبر نهائياً ولا يقبل الطعن وله قوة ثبوتية مطلقة (مبدأ التطهير المنصوص عليه في ظهير التحفيظ العقاري). قبل الشراء، يجب طلب شهادة ملكية حديثة من المحافظة العقارية للتأكد من هوية المالك الحقيقي، ومن خلو العقار من أي تحملات (رهون، حجوزات...). يجب أن يتم البيع عبر محرر رسمي (عند موثق أو عدول) أو محرر ثابت التاريخ (عند محام)، كما تقتضي المادة 4 من مدونة الحقوق العينية. 2. العقار غير المحفظ (الملك): يكتنفه خطر كبير لوجود نزاعات محتملة حول الملكية والحدود. قبل الشراء، يجب القيام ببحث معمق حول أصل الملكية وتسلسلها، والتأكد من حيازة البائع الهادئة والمستمرة. يجب طلب شهادة إدارية من السلطة المحلية تثبت أن العقار ليس أرضاً جماعية أو تابعة لأملاك الدولة. ينصح بشدة، بعد الشراء، بالشروع فوراً في مسطرة التحفيظ لتحويله إلى عقار محفظ وتأمينه قانونياً بشكل نهائي.' },
  ],
  ...
  faq_ar: [
    { q: 'بصفتي مغربياً مقيماً بالخارج، ما هو القانون المطبق على تركتي؟ هل هو القانون المغربي أم قانون بلد إقامتي؟', a: 'يخضع إرث المواطن المغربي، حتى وإن توفي خارج المغرب وكان يمتلك أملاكاً في بلد الإقامة، للقانون المغربي حصراً. فالعبرة بالجنسية لا بمحل الوفاة أو الإقامة. وعليه، فإن قواعد الإرث المنصوص عليها في مدونة الأسرة المغربية هي التي تطبق لتحديد الورثة وتوزيع الأنصبة، وذلك تكريساً لمبدأ شخصية القوانين الذي يحكم مسائل الأحوال الشخصية للمغاربة.' },
    { q: 'أحمل جنسية مزدوجة (مغربية وأجنبية). في حالة وفاتي، أي قانون سيطبق على ممتلكاتي الموجودة في المغرب؟', a: 'في نظر القضاء المغربي، تعتبر الجنسية المغربية هي الأصل وتجبّ أي جنسية أخرى مكتسبة. بناءً على ذلك، سيتم اعتبارك مواطناً مغربياً فقط، وستخضع تركتك، خاصة العقارات والأموال الموجودة داخل المغرب، بشكل كامل ومطلق لأحكام الشريعة الإسلامية وقواعد الإرث الواردة في مدونة الأسرة المغربية (الكتاب السادس، المواد من 321 إلى 395).' },
    { q: 'كيف يمكنني مباشرة إجراءات الإرث في المغرب دون الحاجة إلى السفر شخصياً؟', a: 'يمكنك مباشرة الإجراءات عن بعد من خلال إبرام "وكالة خاصة" (Procuration spéciale) لدى القنصلية المغربية في بلد إقامتك. تخول هذه الوكالة لشخص موثوق به في المغرب (كأحد أفراد العائلة أو محامٍ) صلاحية القيام بكافة الإجراءات اللازمة نيابة عنك، بما في ذلك استصدار رسم الإراثة، وتقديم التصريح بالتركة لدى إدارة الضرائب، وتمثيلك أمام المحاكم والإدارات لتصفية التركة وقسمتها.' },
    { q: 'ما هي الوثائق الأساسية المطلوبة لإنجاز "رسم الإراثة" لمغربي توفي خارج أرض الوطن؟', a: 'لإعداد رسم الإراثة (acte d\'hérédité) لدى العدول، يجب الإدلاء بالوثائق التالية:  1. شهادة الوفاة الأصلية الصادرة في بلد الوفاة، مصادق عليها (أو تحمل خاتم الأبوستيل) ومترجمة إلى اللغة العربية من قبل مترجم محلف. 2. عقد زواج الهالك وعقود ازدياد جميع الورثة. 3. نسخ من بطاقات التعريف الوطنية للورثة الراشدين. 4. شهادة من اثني عشر شاهداً (لفيف عدلي) يشهدون بمعرفتهم بالهالك وبورثته الشرعيين وعدم وجود وارث آخر غيرهم. يقوم العدول باستقبال هؤلاء الشهود وتحرير شهادتهم في إطار إعداد رسم الإراثة النهائي.' },
    { q: 'قمت بتحرير وصية في بلد إقامتي الأجنبي، فهل تعتبر صحيحة ونافذة في المغرب؟', a: 'تكون الوصية المحررة في الخارج صحيحة من حيث الشكل إذا تمت وفقاً لقانون بلد إبرامها. أما من حيث الموضوع، فيجب أن تحترم القواعد الآمرة للقانون المغربي. أهم هذه القواعد هي: - لا يمكن أن تتجاوز الوصية ثلث (1/3) التركة بعد سداد الديون.  - لا تصح الوصية لوارث إلا إذا أجازها باقي الورثة بعد وفاة الموصي (المادة 279 من مدونة الأسرة). فإذا كانت وصيتك تمنح أكثر من الثلث أو تعطي لأحد الورثة الشرعيين، فإنها لن تنفذ في المغرب إلا في حدود الثلث، وبعد موافقة باقي الورثة في الحالة الثانية.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الإطار القانوني لتحويل الأموال وتمويل الاستثمار',
      content: 'يضمن القانون المغربي للمغاربة المقيمين بالخارج، شأنهم شأن المستثمرين الأجانب، حرية تمويل استثماراتهم بالمغرب بالعملة الصعبة. ويخضع هذا التمويل لمقتضيات تنظيم الصرف التي يشرف على تطبيقها مكتب الصرف، والتي تهدف إلى تيسير وتأمين تدفق رؤوس الأموال.',
      bullets: [
        'يجب أن يتم تمويل الاستثمار حصراً عن طريق تحويل عملات أجنبية من حساب بنكي بالخارج إلى حساب بنكي بالمغرب. الطريقة المثلى هي فتح "حساب بالدرهم القابل للتحويل" (Compte en dirhams convertibles)، والذي يسمح باستقبال العملات الصعبة وتحويلها إلى الدرهم لتمويل النفقات الاستثمارية محلياً.',
        'وفقاً للدورية العامة لعمليات الصرف (Instruction Générale des Opérations de Change) الصادرة عن مكتب الصرف، يعتبر كل استثمار ممول بالعملة الصعبة "استثماراً أجنبياً بالمغرب"، مما يمنح صاحبه حق إعادة تحويل الأرباح ورأس المال المستثمر لاحقاً.',
        'من الضروري الاحتفاظ بجميع الوثائق التي تثبت مصدر الأموال الأجنبي، وعلى رأسها إشعارات التحويل البنكي (SWIFT) والكشوفات البنكية. هذه المستندات تشكل "سند التمويل" الذي سيطالب به البنك كوسيط معتمد عند طلب تحويل الأرباح أو حصيلة بيع الاستثمار إلى الخارج.',
        'بعد إنجاز عملية الاستثمار (شراء عقار، تأسيس شركة، إلخ)، يجب على المستثمر، عبر بنكه المعتمد، تقديم "حساب استثماري" (Compte rendu de l\'investissement) إلى مكتب الصرف في أجل لا يتعدى ستة (6) أشهر من تاريخ إنجازه. هذا الإجراء إلزامي لتسجيل الاستثمار رسمياً وضمان حقوق التحويل المستقبلية.',
        'بالنسبة للاستثمارات العقارية، يجب أن يتم تسجيل عقد الشراء لدى مصالح التسجيل والتنبر وأن يتم تقييده في المحافظة العقارية. ويجب أن يشير العقد بوضوح إلى أن ثمن الشراء قد تم أداؤه عن طريق تحويل عملة صعبة، مع إرفاق الوثائق البنكية الداعمة.',
      ],
    },
    {
      h2: 'تأسيس الشركات والامتيازات الضريبية المتاحة',
      content: 'يوفر التشريع التجاري المغربي مرونة كبيرة في اختيار الشكل القانوني للمقاولة، مع حزمة من التحفيزات الضريبية الهامة التي تهدف إلى تشجيع المبادرة الخاصة، والتي يستفيد منها المغاربة المقيمون بالخارج بشكل كامل.',
      bullets: [
        'يعتبر شكل "الشركة ذات المسؤولية المحدودة" (SARL) الأكثر شيوعاً للمشاريع الصغيرة والمتوسطة، نظراً لبساطة إجراءات تأسيسها وتسييرها، ومسؤولية الشركاء المحدودة في حدود حصصهم. وينظمها القانون رقم 5.96 المتعلق بشركة التضامن وشركة التوصية البسيطة وشركة التوصية بالأسهم والشركة ذات المسؤولية المحدودة وشركة المحاصة.',
        'أول خطوة عملية في تأسيس الشركة هي الحصول على "الشهادة السلبية" (Certificat Négatif) من المكتب المغربي للملكية الصناعية والتجارية (OMPIC)، وهي وثيقة تثبت أن الاسم التجاري المختار للمقاولة غير مستعمل ومتاح قانونياً.',
        'بموجب المادة 6 من المدونة العامة للضرائب (Code Général des Impôts)، تستفيد المقاولات الصناعية أو الحرفية أو مقدمة الخدمات، التي تم تأسيسها حديثاً، من إعفاء كلي من الضريبة على الشركات (IS) لمدة الخمس (5) سنوات الأولى من تاريخ شروعها في النشاط، شريطة أن تكون خاضعة لنظام المحاسبة الفعلي.',
        'بالنسبة للمشاريع الفردية الصغيرة، يمكن للمستثمر اختيار نظام "المساهمة المهنية الموحدة" (CPU). هذا النظام المبسط، الذي تم إقراره في قانون المالية لسنة 2021، يجمع في ضريبة واحدة كلاً من الضريبة على الدخل المهني والواجبات المتعلقة بالتغطية الصحية الإجبارية، مما يسهل بشكل كبير الالتزامات الإدارية والجبائية.',
        'تخضع الأرباح الموزعة (dividendes) من طرف الشركات المغربية على الشركاء غير المقيمين، بما فيهم المغاربة المقيمون بالخارج، لحجز ضريبي في المنبع (retenue à la source) بنسبة مخفضة تبلغ 10%، وذلك طبقاً للمادة 15 من المدونة العامة للضرائب. هذا المعدل يعتبر تنافسياً ويشجع على توزيع الأرباح.',
      ],
    },
    {
      h2: 'ضمانات إعادة تحويل الأرباح وحصيلة بيع الاستثمار',
      content: 'يكرس القانون المغربي مبدأ حرية إعادة تحويل العائدات الناتجة عن الاستثمار إلى الخارج. هذه الضمانة أساسية وتطمئن المستثمرين على قدرتهم على استرجاع ثمار استثماراتهم، شريطة احترام الإجراءات القانونية المتعلقة بالتمويل الأولي والتصريح بالاستثمار.',
      bullets: [
        'ينص تنظيم الصرف المغربي صراحة على أن الاستثمارات الممولة بالعملة الصعبة تمنح الحق في تحويل صافي الأرباح الموزعة بعد خصم الضرائب، وكذلك تحويل حصيلة بيع أو تصفية الاستثمار، بما في ذلك فائض القيمة (plus-value).',
        'لتحويل الأرباح السنوية (dividendes)، يجب على الشركة تقديم طلب للبنك المعتمد مرفقاً بمحضر الجمعية العامة التي قررت توزيع الأرباح، والقوائم المالية للشركة، وإثبات أداء الضريبة على الشركات (IS) والضريبة المحجوزة في المنبع على الأرباح الموزعة.',
        'عند بيع الاستثمار (حصص في شركة، عقار، إلخ)، يتم تحويل حصيلة البيع بعد تقديم عقد البيع المسجل، وإثبات أداء الضريبة على الأرباح العقارية أو الضريبة على الأرباح الناتجة عن بيع القيم المنقولة، بالإضافة إلى الوثائق الأصلية التي تثبت تمويل الاستثمار الأولي بالعملة الصعبة.',
        'لا يوجد أي سقف أو حد كمي لمبالغ الأرباح أو حصيلة التصفية التي يمكن تحويلها إلى الخارج. الحرية كاملة ما دامت جميع الالتزامات الضريبية قد تمت تسويتها وتم إثبات شرعية العملية ومطابقتها للقانون.',
        'في حالة الاستثمار في الأسهم المدرجة في بورصة الدار البيضاء، يتم تحويل الأرباح وحصيلة البيع بشكل تلقائي وفوري تقريباً من خلال البنك الذي يحتفظ بحساب الأوراق المالية للمستثمر، مما يوفر سيولة وسرعة عالية في استرجاع الأموال.',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي الأشكال القانونية الرئيسية للشركات التي يمكن للمستثمر الأجنبي تأسيسها في المغرب؟', a: 'يتيح القانون المغربي للمستثمرين الأجانب عدة خيارات، أبرزها الشركة ذات المسؤولية المحدودة (SARL)، التي يمكن أن تتكون من شريك واحد (SARLAU) أو أكثر، وهي الشكل الأكثر شيوعاً نظراً لمرونتها ومحدودية مسؤولية الشركاء. كما توجد شركة المساهمة (SA) المناسبة للمشاريع الكبرى التي تتطلب رؤوس أموال ضخمة. تخضع هذه الشركات بشكل أساسي لمقتضيات القانون رقم 5.96 المتعلق بشركة التضامن وشركة التوصية البسيطة وشركة التوصية بالأسهم والشركة ذات المسؤولية المحدودة وشركة المحاصة، والقانون رقم 17.95 المتعلق بشركات المساهمة.' },
    { q: 'هل توجد قيود على نسبة مساهمة الأجانب في رأسمال الشركات المغربية؟', a: 'المبدأ العام في القانون المغربي هو حرية الاستثمار، حيث لا يفرض أي قيود على نسبة مشاركة رأس المال الأجنبي في أغلب القطاعات الاقتصادية. يمكن للمستثمر الأجنبي امتلاك نسبة تصل إلى 100% من رأسمال الشركة. الاستثناء الرئيسي يتعلق بملكية الأراضي الفلاحية أو المعدة للفلاحة، حيث يقتصر حق تملكها على الأشخاص الذاتيين المغاربة، أو الشركات التي يملكها بالكامل أشخاص مغاربة، وذلك بموجب الظهير الشريف بمثابة قانون رقم 1.73.213 الصادر في 2 مارس 1973.' },
    { q: 'ما هو الإطار القانوني الرئيسي المنظم للاستثمار وما هي أهم التحفيزات المتاحة؟', a: 'الإطار القانوني الجديد المنظم للاستثمار هو القانون-الإطار رقم 03.22 بمثابة ميثاق الاستثمار. يهدف هذا الميثاق إلى تشجيع الاستثمار الخاص عبر توفير منظومة دعم متكاملة وواضحة. تشمل التحفيزات الرئيسية التي يقدمها الميثاق \'منحاً مشتركة\' لدعم الاستثمارات، و\'منحة ترابية\' إضافية لتوجيه الاستثمارات نحو الأقاليم والعمالات الأقل حظاً، بالإضافة إلى \'منحة قطاعية\' لدعم القطاعات ذات الأولوية. يتم تحديد شروط ومعايير الاستفادة من هذه المنح بموجب نصوص تنظيمية لاحقة.' },
    { q: 'كيف يضمن القانون المغربي حماية الاستثمارات الأجنبية؟', a: 'يوفر المغرب ضمانات متعددة لحماية الاستثمارات الأجنبية. على المستوى الدستوري، يضمن الفصل 35 من الدستور المغربي حق الملكية وحرية المبادرة. وعلى المستوى الدولي، أبرم المغرب أكثر من 70 اتفاقية ثنائية لتشجيع وحماية الاستثمارات المتبادلة (TBI) مع دول شريكة. كما يضمن النظام القضائي المغربي، من خلال المحاكم التجارية المتخصصة، حق التقاضي للمستثمرين. بالإضافة إلى ذلك، يعترف المغرب باللجوء إلى التحكيم التجاري الوطني والدولي كوسيلة فعالة لتسوية المنازعات المتعلقة بالاستثمار.' },
    { q: 'ما هي الإجراءات المتعلقة بتحويل الأرباح ورأس المال المستثمر إلى الخارج؟', a: 'يضمن المغرب للمستثمرين الأجانب حرية تحويل المداخيل الناتجة عن استثماراتهم إلى الخارج. وفقاً لتعليمات مكتب الصرف (Instruction Générale des Opérations de Change)، فإن الاستثمارات الممولة بالعملة الصعبة تخضع لـ \'نظام القابلية للتحويل\'. يضمن هذا النظام للمستثمر الحق في تحويل صافي أرباح التوزيع (بعد أداء الضريبة على الشركات والضريبة على الدخل)، وعائدات بيع أو تصفية الاستثمار، دون أي قيود كمية أو زمنية، شريطة أن يكون الاستثمار الأولي قد تم تمويله وإعلانه وفقاً للأنظمة الجاري بها العمل.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الإطار القانوني والتحققات الأولية قبل إبرام عقد الشراء',
      content: 'قبل التوقيع على أي التزام، من الضروري القيام بمجموعة من التحريات القانونية والتقنية لضمان سلامة المعاملة العقارية وتجنب أي نزاعات مستقبلية. هذه المرحلة الوقائية تعتبر حجر الزاوية في تأمين استثمارك العقاري بالمغرب.',
      bullets: [
        'التحقق من الوضعية القانونية للعقار: يجب التمييز بين العقار المحفظ الذي يتوفر على رسم عقاري نهائي لدى المحافظة العقارية، والذي يوفر حماية قانونية مطلقة للمالك طبقا لمبدأ التطهير المنصوص عليه في الظهير الشريف الصادر في 12 أغسطس 1913 المتعلق بالتحفيظ العقاري، والعقار غير المحفظ الذي يخضع لقواعد القانون المدني وقد يثير صعوبات في إثبات الملكية.',
        'الحصول على شهادة المعلومات التعميرية: هذه الوثيقة، التي تصدرها الوكالة الحضرية أو الجماعة المحلية، تعتبر إلزامية وتحدد طبيعة استعمال الأرض (سكني، تجاري، صناعي...) والارتفاقات والتكاليف التعميرية المفروضة على العقار بموجب وثائق التعمير، وذلك وفقا لمقتضيات القانون رقم 12.90 المتعلق بالتعمير.',
        'التأكد من الوضعية الجبائية للعقار: من الضروري مطالبة البائع بتقديم شهادة إبراء ذمة جبائية تثبت أداء جميع الضرائب والرسوم المستحقة على العقار، خاصة ضريبة السكن وضريبة الخدمات الجماعية (المنظمة بموجب القانون رقم 47.06 المتعلق بجبايات الجماعات الترابية)، لتجنب انتقال هذه الديون إلى المشتري الجديد.',
        'مراجعة نظام الملكية المشتركة: في حالة شراء شقة أو محل تجاري ضمن عمارة، يجب الاطلاع على نظام الملكية المشتركة ودفتر التحملات، والتأكد من عدم وجود ديون على البائع لفائدة اتحاد الملاك (syndic)، وذلك تطبيقا لمقتضيات القانون رقم 18.00 المتعلق بنظام الملكية المشتركة للعقارات المبنية.',
        'التثبت من وجود رخصة السكن أو شهادة المطابقة: بالنسبة للعقارات الحديثة البناء، تعتبر رخصة السكن (للمباني السكنية) أو شهادة المطابقة (للاستعمالات الأخرى) وثيقة أساسية تثبت أن البناء مطابق للتصاميم المرخصة من طرف السلطات المحلية، وهي ضرورية لإبرام العقد النهائي.',
      ],
    },
    {
      h2: 'مسطرة الشراء والمراحل التعاقدية الأساسية',
      content: 'تتم عملية شراء عقار في المغرب عبر سلسلة من المراحل التعاقدية المنظمة قانونا، والتي تهدف إلى حماية حقوق كل من البائع والمشتري. يوصى بشدة بالاستعانة بمهني مؤهل (موثق أو عدول) لمواكبة هذه المسطرة المعقدة.',
      bullets: [
        'إبرام الوعد بالبيع (Compromis de vente): هو عقد تمهيدي يلتزم بموجبه البائع ببيع العقار للمشتري الذي يلتزم بشرائه بثمن متفق عليه. يتضمن هذا العقد عادة دفع \'عربون\' وشروطا واقفة، كشرط الحصول على قرض بنكي. وينظم قانون الالتزامات والعقود أحكام البيع والعربون.',
        'دور الموثق أو العدول: أصبح تحرير العقود العقارية من طرف مهني مؤهل (موثق أو عدل) إلزاميا بموجب المادة 4 من مدونة الحقوق العينية (القانون رقم 39.08). يقوم الموثق أو العدول بالتحقق من سلامة الوثائق، وصياغة العقد النهائي، وضمان استيفاء جميع الشروط القانونية قبل توقيعه.',
        'تحويل الأموال وفتح حساب بالدرهم القابل للتحويل: بالنسبة للمغاربة المقيمين بالخارج، يجب أن يتم تمويل عملية الشراء بالعملة الصعبة. يتوجب فتح حساب بنكي بالدرهم القابل للتحويل لتحويل الأموال من الخارج، مما يضمن الحق في إعادة تحويل ثمن البيع والأرباح المحققة إلى الخارج عند إعادة بيع العقار، وذلك وفقا لتعليمات مكتب الصرف.',
        'توقيع العقد النهائي للبيع: بعد استيفاء جميع الشروط (الحصول على القرض، أداء الضرائب، إلخ)، يتم توقيع عقد البيع النهائي لدى الموثق أو العدول. بمجرد التوقيع، يقوم الموثق بتسجيل العقد لدى إدارة الضرائب.',
        'تقييد العقد في الرسم العقاري: تعتبر هذه المرحلة حاسمة لنقل الملكية بشكل نهائي وقانوني في مواجهة الغير. يقوم الموثق بإيداع نسخة من العقد المسجل لدى المحافظة العقارية لتقييد اسم المشتري الجديد في الرسم العقاري للعقار، مما يمنحه الحماية القانونية الكاملة التي يخولها نظام التحفيظ العقاري.',
      ],
    },
    {
      h2: 'التكاليف، الضرائب والالتزامات المترتبة عن الشراء',
      content: 'يترتب على عملية شراء عقار بالمغرب مجموعة من المصاريف والرسوم والضرائب التي يجب على المشتري أخذها بعين الاعتبار في ميزانيته. تختلف هذه التكاليف حسب طبيعة العقار وثمنه.',
      bullets: [
        'رسوم التسجيل (Droits d\'enregistrement): هي ضريبة تفرض على العقود الناقلة للملكية وتستخلصها إدارة الضرائب. تتراوح نسبتها من ثمن الشراء وتختلف حسب نوع العقار (مثلا، نسبة مخفضة للسكن الاجتماعي أو الرئيسي تحت شروط معينة)، وذلك وفقا للمدونة العامة للضرائب.',
        'رسوم المحافظة العقارية (Droits de la conservation foncière): تؤدى للوكالة الوطنية للمحافظة العقارية والمسح العقاري والخرائطية مقابل تقييد البيع في الرسم العقاري. تبلغ هذه الرسوم حاليا 1.5% من ثمن الشراء، بالإضافة إلى رسوم ثابتة ورسم خاص لإنشاء شهادة الملكية الجديدة.',
        'أتعاب الموثق أو العدول: تحدد أتعاب الموثق بنسبة مئوية من ثمن البيع بموجب مرسوم تنظيمي، وتضاف إليها الضريبة على القيمة المضافة (TVA). أما أتعاب العدول فتخضع لتعريفة محددة قانونا. تشمل هذه الأتعاب تكاليف الإجراءات التي يقوم بها المهني نيابة عن الزبون.',
        'الضرائب العقارية السنوية: بمجرد أن يصبح مالكا، يخضع المشتري لأداء ضريبتين محليتين سنويا: ضريبة السكن (إذا كان العقار مخصصا للسكن الرئيسي أو الثانوي) وضريبة الخدمات الجماعية. يتم تنظيم هاتين الضريبتين بموجب القانون رقم 47.06 المتعلق بجبايات الجماعات الترابية.',
        'الضريبة على الأرباح العقارية (TPI) عند إعادة البيع: في حالة بيع العقار مستقبلا، يخضع الربح المحقق للضريبة على الأرباح العقارية. يُحسب الربح بالفرق بين ثمن البيع وثمن الشراء المعاد تقييمه مضافا إليه مصاريف الاستثمار والشراء. سعر الضريبة هو 20% كحد أدنى، مع إمكانية تطبيق إعفاءات، أبرزها الإعفاء المتعلق بالسكن الرئيسي المشغول لمدة لا تقل عن 6 سنوات، وذلك حسب مقتضيات المدونة العامة للضرائب.',
      ],
    },
  ],
  faq_ar: [
    { q: 'بصفتي مغربيا مقيما بالخارج، هل يمكنني توكيل شخص آخر لإتمام إجراءات شراء عقار بالمغرب نيابة عني؟', a: 'نعم، يمكنكم قانونيا توكيل شخص آخر، شريطة أن تكون الوكالة "وكالة خاصة" ومفصلة تحدد العقار موضوع الشراء والثمن وصلاحيات الوكيل. يجب تحرير هذه الوكالة لدى موثق أو عدل بالمغرب. إذا تم تحريرها بالخارج، فيجب أن تكون مصادقًا عليها من طرف السلطات القنصلية المغربية أو تحمل خاتم "الأبوستيل" (Apostille) طبقا لاتفاقية لاهاي. تستمد الوكالة أحكامها من الفصول 879 وما يليها من قانون الالتزامات والعقود.' },
    { q: 'ما هي الإجراءات القانونية لتحويل أموال شراء العقار من الخارج إلى المغرب لضمان حقوقي؟', a: 'لضمان حق إعادة تحويل ثمن البيع والأرباح المحتملة مستقبلا، يجب أن يتم تمويل عملية الشراء بعملات أجنبية. يتم ذلك عبر تحويل بنكي من حسابكم بالخارج إلى حساب بالدرهم القابل للتحويل مفتوح لدى بنك مغربي. من الضروري التصريح للبنك المغربي عند التحويل بأن المبلغ مخصص لعملية استثمار عقاري. يحتفظ البنك بإشعار التحويل الذي يعتبر مستندا أساسيا لدى مكتب الصرف لإثبات مصدر الأموال والاستفادة من "ضمانة الصرف" (garantie de retransfert) المنصوص عليها في تعليمات مكتب الصرف (Instruction Générale des Opérations de Changes).' },
    { q: 'ما هي الضمانات التي يوفرها القانون عند شراء عقار في طور الإنجاز (VEFA)؟', a: 'ينظم القانون رقم 107.12 (المعدل والمتمم للقانون 44.00) بيع العقارات في طور الإنجاز. من أهم الضمانات: وجوب إبرام "عقد ابتدائي" لدى مهني مؤهل (موثق أو عدل)، وعدم أداء أي مبلغ قبل توقيع هذا العقد. كما ألزم القانون البائع بتقديم ضمانة بنكية أو تأمين لضمان استرجاع الأقساط المدفوعة في حالة عدم تنفيذ العقد أو ضمان إتمام الأشغال. ويتم أداء الثمن على شكل أقساط متتالية تتناسب مع تقدم مراحل البناء المحددة قانونا.' },
    { q: 'ما هي أهم الرسوم والضرائب التي يجب أداؤها عند اقتناء عقار محفظ في المغرب؟', a: 'تترتب على عملية الشراء مجموعة من الرسوم والضرائب، أهمها: 1. واجبات التسجيل (Droits d\'enregistrement): تحتسب كنسبة مئوية من ثمن الشراء، وتحدد سنويا في قانون المالية. (مرجع: المدونة العامة للضرائب). 2. رسوم المحافظة العقارية (Droits de la conservation foncière): تبلغ حاليا 1.5% من قيمة العقار، بالإضافة إلى رسم ثابت للشهادة ورسوم أخرى. (مرجع: مرسوم تحديد تعريفة رسوم المحافظة العقارية). 3. أتعاب الموثق أو العدول: تحدد بنسبة مئوية من ثمن البيع وفقا للقانون المنظم للمهنة. 4. الضريبة على القيمة المضافة (TVA): تكون مشمولة في ثمن البيع إذا كان العقار جديدا ومقتنى من منعش عقاري.' },
    { q: 'هل يمكنني بصفتي مغربيا مقيما بالخارج شراء أرض فلاحية في المغرب؟', a: 'القانون المغربي، وتحديدا ظهير 2 مارس 1973، يضع قيودا على تملك الأجانب للأراضي الفلاحية أو القابلة للفلاحة. هذا القيد يمتد ليشمل الأشخاص الذاتيين الأجانب والشركات التي لا تتوفر على الشروط القانونية. بالنسبة للمغاربة المقيمين بالخارج، إذا كانوا يحملون جنسية مغربية فقط، فلا يوجد مانع قانوني. أما إذا كانوا يحملون جنسية أجنبية (مزدوجي الجنسية)، فإنهم يعاملون كأجانب في هذا السياق ويمنع عليهم تملك الأراضي الفلاحية. الاستثناء الوحيد هو إذا فقدت الأرض صبغتها الفلاحية بموجب وثيقة تعمير رسمية (مثل إدراجها ضمن تصميم تهيئة كمنطقة سكنية).' },
  ],
  ...
  sections_ar: [
    {
      h2: 'مبدأ قبول ازدواجية الجنسية في القانون المغربي',
      content: 'يتبنى المشرع المغربي موقفا متسامحا ومنفتحا تجاه مسألة ازدواجية الجنسية، حيث لا يفرض على المواطن المغربي التخلي عن جنسيته الأصلية عند اكتسابه لجنسية أجنبية. هذا المبدأ، المستقر عليه فقها وقضاء وتشريعا، يكرس حق المواطن في الاحتفاظ برابطته القانونية والوجدانية بوطنه الأم.',
      bullets: [
        'الاحتفاظ التلقائي بالجنسية المغربية: خلافا لبعض التشريعات المقارنة، لا يؤدي اكتساب جنسية أجنبية بشكل طوعي إلى فقدان الجنسية المغربية بصفة تلقائية. فالمواطن المغربي، سواء كان حاملا للجنسية بصفة أصلية أو مكتسبة، يظل محتفظا بجنسيته ما لم يطلب التخلي عنها صراحة ووفق شروط محددة.',
        'إجراءات التخلي كاستثناء: ينص الفصل 19 من قانون الجنسية المغربية (الظهير الشريف رقم 1.58.250 الصادر في 6 شتنبر 1958) على أن فقدان الجنسية لا يتم إلا بناء على طلب صريح من المعني بالأمر وبعد الحصول على إذن يصدر بموجب مرسوم، مما يؤكد أن القاعدة هي الاحتفاظ بالجنسية والاستثناء هو فقدانها.',
        'الحق في حمل وثائق متعددة: كنتيجة مباشرة لهذا المبدأ، يحق للمواطن مزدوج الجنسية حمل جواز سفر مغربي وجواز سفر أجنبي في آن واحد، واستخدامهما للتنقل عبر الحدود الدولية مع مراعاة قوانين الدخول والخروج لكل دولة.',
        'عدم وجود إلزامية التصريح: لا يفرض القانون المغربي على المواطن الذي يكتسب جنسية أجنبية واجب التصريح بذلك لدى السلطات المغربية. يظل وضعه القانوني كمواطن مغربي كاملا دون تغيير من الناحية الإدارية أو القانونية داخل المملكة.',
        'تطبيق المبدأ على الجنسية الأصلية والمكتسبة: يسري مبدأ قبول ازدواجية الجنسية على المغاربة بالجنسية الأصلية (عن طريق النسب أو الولادة) والمغاربة الذين اكتسبوا الجنسية لاحقا. ومع ذلك، قد تفرض قيود خاصة على مكتسبي الجنسية في حالات معينة تتعلق بالتجريد منها كما هو منصوص عليه في الفصل 22 من نفس القانون.',
      ],
    },
    {
      h2: 'حالات وإجراءات فقدان الجنسية المغربية والتجريد منها',
      content: 'يعتبر فقدان الجنسية المغربية أو التجريد منها إجراء استثنائيا ومقيدا بشروط صارمة يحددها القانون، ويهدف إلى حماية المصالح العليا للدولة. لا يمكن أن يتم هذا الإجراء إلا بموجب قرار إداري سيادي (مرسوم) وبعد استيفاء مساطر دقيقة تضمن حقوق الدفاع.',
      bullets: [
        'الفقدان الطوعي بناء على طلب (الفصل 19): يمكن للمغربي الراشد الذي اكتسب عن طواعية جنسية أجنبية أن يتقدم بطلب إلى وزارة العدل للتخلي عن جنسيته المغربية. لا يصبح هذا التخلي نافذا إلا بعد صدور مرسوم يأذن به، ويُنشر بالجريدة الرسمية للمملكة.',
        'الفقدان بسبب وظيفة أجنبية (الفصل 19، الفقرة 3): إذا كان المغربي يشغل وظيفة عمومية في دولة أجنبية أو يعمل في جيش أجنبي واحتفظ بها لأكثر من ستة أشهر بعد إنذار الحكومة المغربية له بالتخلي عنها، يمكن إعلان فقدانه للجنسية المغربية بموجب مرسوم.',
        'التجريد من الجنسية كعقوبة (الفصل 22): يمكن تجريد الشخص الذي اكتسب الجنسية المغربية (وليس المغربي بالجنسية الأصلية) من جنسيته خلال 10 سنوات من اكتسابها إذا صدر ضده حكم من أجل جريمة ماسة بأمن الدولة، أو جريمة إرهابية، أو تهرب من الخدمة العسكرية، أو قام بأفعال تتنافى مع صفته كمغربي وتضر بمصالح المغرب. ويتم التجريد بمرسوم معلل بعد إتاحة الفرصة للمعني بالأمر لتقديم ملاحظاته.',
        'الأثر الجماعي لفقدان الجنسية (الفصل 24): يمكن أن يمتد أثر فقدان الجنسية أو التجريد منها إلى الأبناء القاصرين غير المتزوجين إذا كانوا يعيشون مع والدهم. ومع ذلك، يمنحهم القانون الحق في استرداد الجنسية المغربية بتقديم تصريح خلال السنتين التاليتين لبلوغهم سن الرشد.',
        'ضرورة النشر في الجريدة الرسمية: في جميع حالات الفقدان أو التجريد، لا تنتج هذه الإجراءات أثرها القانوني إلا من تاريخ نشر المرسوم المتعلق بها في الجريدة الرسمية، مما يضمن الشفافية واليقين القانوني للمعاملات.',
      ],
    },
    {
      h2: 'المركز القانوني لمزدوجي الجنسية داخل التراب الوطني',
      content: 'تطبق السلطات المغربية مبدأ "سيادة الجنسية الوطنية" على أراضيها. وبموجب هذا المبدأ، يُعامل المواطن الذي يحمل جنسية أخرى بالإضافة إلى الجنسية المغربية كمواطن مغربي حصراً عند تواجده داخل المغرب، وتترتب على ذلك آثار قانونية هامة.',
      bullets: [
        'الخضوع الحصري للقانون المغربي: يخضع مزدوج الجنسية لجميع القوانين المغربية دون استثناء، بما في ذلك مدونة الأسرة في مسائل الزواج والطلاق والإرث، ومدونة الشغل، والقانون الجنائي. ولا يمكنه الاحتجاج بجنسيته الأجنبية للإفلات من تطبيق هذه القوانين.',
        'الاختصاص القضائي للمحاكم المغربية: تختص المحاكم المغربية وحدها بالنظر في جميع الدعاوى والقضايا المتعلقة بمزدوج الجنسية، سواء كانت مدنية، تجارية، أو جنائية، طالما أن الأفعال أو الوقائع حدثت على التراب المغربي أو كان الاختصاص منعقدا لها بموجب القانون.',
        'انعدام الحماية الدبلوماسية الأجنبية: لا يمكن للمواطن مزدوج الجنسية الاستفادة من الحماية الدبلوماسية أو القنصلية لدولته الأخرى أثناء تواجده في المغرب. تعتبر السلطات المغربية أي تدخل من هذا القبيل تدخلاً في شؤونها الداخلية، وتتعامل معه باعتباره مواطنا مغربيا فقط.',
        'الالتزامات الإدارية والمدنية: يجب على مزدوج الجنسية استخدام وثائقه الثبوتية المغربية (بطاقة التعريف الوطنية الإلكترونية، جواز السفر المغربي) في جميع معاملاته الإدارية داخل المغرب، مثل فتح حساب بنكي، أو تملك العقارات، أو تسجيل العقود، أو المرور عبر المطارات والموانئ.',
        'التمتع بالحقوق السياسية الكاملة: يحق للمواطن مزدوج الجنسية التمتع بكافة حقوقه السياسية كمواطن مغربي، بما في ذلك الحق في التصويت في الانتخابات والترشح للمناصب المنتخبة، شريطة استيفائه للشروط القانونية المطلوبة من جميع المواطنين دون تمييز بسبب حمل جنسية أخرى.',
      ],
    },
  ],
  faq_ar: [
    { q: 'هل يعترف القانون المغربي بازدواجية الجنسية؟', a: 'نعم، يقر القانون المغربي بمبدأ ازدواجية الجنسية. فالمواطن المغربي الذي يكتسب جنسية أجنبية لا يفقد جنسيته المغربية الأصلية تلقائياً. من منظور السلطات المغربية، يظل حاملاً للجنسية المغربية ويتمتع بكافة الحقوق والالتزامات المترتبة عليها. يستند هذا المبدأ على أحكام ظهير 6 شتنبر 1958 بمثابة قانون الجنسية المغربية، الذي لا يتضمن أي مقتضى يفرض على المغربي التخلي عن جنسيته عند اكتسابه جنسية أخرى.' },
    { q: 'هل أفقد جنسيتي المغربية بمجرد حصولي على جنسية دولة أخرى عن طواعية؟', a: 'لا، إن اكتساب جنسية أجنبية طواعية لا يؤدي إلى فقدان الجنسية المغربية بشكل تلقائي. وفقاً للمادة 19 من قانون الجنسية المغربية، يفقد الجنسية المغربية "المغربي الراشد الذي يكتسب عن طواعية في الخارج جنسية أجنبية، ويُؤذن له بموجب مرسوم في التخلي عن الجنسية المغربية". وبالتالي، فإن فقدان الجنسية المغربية مشروط بالحصول على إذن صريح من السلطات المغربية يصدر بموجب مرسوم، وبدون هذا الإذن، يظل الشخص محتفظاً بجنسيته المغربية كاملة.' },
    { q: 'أنا مغربي أحمل جنسية أخرى وزوجتي أجنبية، ما هي جنسية أطفالنا المولودين في الخارج؟', a: 'يعتبر طفلك مغربياً بقوة القانون. فبموجب المادة 6 من قانون الجنسية المغربية، بعد تعديلها سنة 2007، يعتبر مغربياً "الولد المولود من أب مغربي أو من أم مغربية". هذا المقتضى يسري سواء وُلد الطفل داخل المغرب أو خارجه، وبغض النظر عن جنسية الزوج الآخر. وبالتالي، تثبت الجنسية المغربية للطفل عن طريق البنوة لأحد الوالدين المغاربة، ويمكن تسجيله في سجلات الحالة المدنية المغربية لدى القنصليات والسفارات المغربية بالخارج.' },
    { q: 'بصفتي مزدوج الجنسية، هل أتمتع بنفس حقوق والتزامات المواطن الذي يحمل الجنسية المغربية فقط؟', a: 'نعم، من وجهة نظر القانون المغربي، لا يوجد أي تمييز بين المواطن المغربي الذي يحمل جنسية واحدة والمواطن مزدوج الجنسية. فكلاهما يخضع لنفس القوانين ويتمتع بنفس الحقوق ويتحمل نفس الالتزامات. تشمل هذه الحقوق على سبيل المثال حق الإرث وفقاً لمدونة الأسرة، وحق التملك، والحقوق السياسية كالتصويت والترشح. كما تشمل الالتزامات الخضوع للقانون المغربي، خاصة فيما يتعلق بالأحوال الشخصية عند التواجد في المغرب أو أمام المحاكم المغربية.' },
    { q: 'هل يمكنني التخلي عن جنسيتي المغربية؟ وما هي الإجراءات المتبعة؟', a: 'نعم، يمكن للمواطن المغربي التخلي عن جنسيته، ولكن ضمن شروط وإجراءات محددة. تنظم المادة 19 من قانون الجنسية هذه المسألة، حيث تشترط ثلاثة أمور أساسية: 1) أن يكون الشخص راشداً (بلغ سن الرشد القانوني)، 2) أن يكون قد اكتسب جنسية أجنبية بصفة اختيارية، 3) أن يحصل على ترخيص بالتخلي عن الجنسية المغربية بموجب مرسوم. يتم تقديم الطلب إلى وزارة العدل، التي تدرسه قبل رفعه لصدور المرسوم. وتجدر الإشارة إلى أن هذا الترخيص هو سلطة تقديرية للدولة وليس حقاً مكتسباً للمواطن.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الإطار القانوني العام: ميثاق الاستثمار الجديد',
      content: 'يشكل القانون الإطار رقم 03.22 بمثابة ميثاق الاستثمار، الصادر بتنفيذه الظهير الشريف رقم 1.22.76، حجر الزاوية في المنظومة القانونية المحفزة للاستثمار الأجنبي والمحلي. يهدف هذا الميثاق إلى توفير رؤية واضحة للمستثمرين وتقديم دعم ملموس للمشاريع ذات القيمة المضافة العالية.',
      bullets: [
        'إرساء أنظمة دعم أساسية: يقر الميثاق أنظمة دعم متعددة تشمل \'منح دعم مشتركة\' للمشاريع التي تستوفي معايير محددة (خلق مناصب شغل قارة، حجم الاستثمار، إلخ)، و\'منحة ترابية\' إضافية للمشاريع المقامة في أقاليم وعمالات معينة، و\'منحة قطاعية\' لتشجيع الاستثمار في القطاعات ذات الأولوية.',
        'نظام خاص بالمشاريع الاستراتيجية: تستفيد المشاريع ذات الطابع الاستراتيجي (التي يتجاوز حجم استثمارها 2 مليار درهم أو ذات الأهمية الخاصة للدولة) من مزايا تفاوضية مباشرة مع الحكومة، بموجب اتفاقيات استثمار خاصة، وذلك بعد المصادقة عليها من طرف اللجنة الوطنية للاستثمارات.',
        'تبسيط المساطر ورقمنتها: ينص الميثاق على إحداث منصة رقمية موحدة للمستثمر (\'The Unified Investor Platform\') لتسهيل جميع الإجراءات المتعلقة بملف الاستثمار، من الإيداع إلى التتبع والحصول على التراخيص، مما يقلص الآجال ويعزز الشفافية.',
        'تحسين مناخ الأعمال: يلتزم الميثاق بتسهيل الولوج إلى العقار الاستثماري، وتطوير مناطق صناعية من الجيل الجديد، وتبسيط الإجراءات الإدارية المتعلقة بالتراخيص، وذلك وفقاً لمقتضيات القانون رقم 55.19 المتعلق بتبسيط المساطر والإجراءات الإدارية.',
        'حوكمة منظومة الاستثمار: يعيد الميثاق تنظيم حوكمة الاستثمار عبر تعزيز دور اللجنة الوطنية للاستثمارات برئاسة رئيس الحكومة، وتحديد مهام الوكالة المغربية لتنمية الاستثمارات والصادرات (AMDIE) كفاعل رئيسي في مواكبة المستثمرين.',
      ],
    },
    {
      h2: 'الأنظمة الخاصة: مناطق التسريع الصناعي والقطب المالي للدار البيضاء',
      content: 'بالإضافة إلى الإطار العام، وضع المشرع المغربي أنظمة خاصة موجهة لأنشطة معينة، توفر حوافز ضريبية وجمركية وإدارية استثنائية. وتعتبر مناطق التسريع الصناعي والقطب المالي للدار البيضاء أبرز مثالين على هذه الأنظمة.',
      bullets: [
        'مناطق التسريع الصناعي (ZAI): هذه المناطق، التي حلت محل \'المناطق الحرة للتصدير\' والمنظمة بموجب القانون رقم 19.94، مخصصة للأنشطة الصناعية والخدمات المرتبطة بها الموجهة للتصدير. تستفيد الشركات المستقرة بها من إعفاء كلي من الضريبة على الشركات لمدة 5 سنوات متتالية، تليها فترة تطبيق سعر مخفض ومحدد في 15%، بالإضافة إلى الإعفاء التام من الرسوم الجمركية والضريبة على القيمة المضافة على المعدات والمواد الأولية المستوردة.',
        'القطب المالي للدار البيضاء (CFC): تم إحداث هذا القطب بموجب القانون رقم 44.10 المتعلق بصفة \'القطب المالي للدار البيضاء\'. الشركات الحاصلة على هذه الصفة (شركات مالية، مقدمو خدمات مهنية، مقاولات جهوية...) تستفيد من نظام ضريبي خاص، يشمل إعفاءً كلياً من الضريبة على الشركات لمدة 5 سنوات بالنسبة للأنشطة الموجهة للخارج، ثم تطبيق سعر مخفض بشكل دائم بعد ذلك. كما تستفيد من تسهيلات كبرى في مجال الصرف ومساطر مبسطة لإنشاء الشركات.',
        'مزايا ضريبية على الدخل: بالنسبة للمستخدمين الأجانب العاملين لدى الشركات الحاصلة على صفة القطب المالي للدار البيضاء، يمكنهم الاستفادة من نظام خاص للضريبة على الدخل، حيث يتم إعفاؤهم من الضريبة لمدة 10 سنوات على الرواتب المدفوعة من مصادر أجنبية، أو تطبيق سعر تفضيلي على الراتب الإجمالي.',
        'إجراءات إدارية مبسطة: تتميز هذه المناطق بوجود شباك وحيد (Guichet Unique) يتكلف بتسهيل كافة الإجراءات الإدارية للمستثمر، من الحصول على التراخيص إلى التصاريح اليومية، مما يضمن سرعة وفعالية في إطلاق وتشغيل المشاريع.',
        'التحكيم والوساطة: يتيح القطب المالي للدار البيضاء للمقاولات المنضوية تحته إمكانية اللجوء إلى مركز الدار البيضاء للتحكيم والوساطة الدولي (CIMAC)، مما يوفر آلية بديلة وفعالة لتسوية المنازعات التجارية.',
      ],
    },
    {
      h2: 'ضمانات المستثمر الأجنبي: تحويل الأرباح وحماية حق الملكية',
      content: 'يوفر القانون المغربي مجموعة من الضمانات القوية للمستثمرين الأجانب، تهدف إلى تأمين رؤوس أموالهم وضمان قدرتهم على تحويل أرباحهم وعائدات استثماراتهم إلى الخارج، بالإضافة إلى حماية قانونية وقضائية فعالة لاستثماراتهم.',
      bullets: [
        'حرية تحويل الأموال (نظام القابلية للتحويل): يضمن مكتب الصرف (Office des Changes)، بموجب تعليماته العامة المتعلقة بعمليات الصرف، للمستثمرين الأجانب حرية تحويل الأرباح الصافية بعد خصم الضرائب، وعائدات تفويت أو تصفية استثماراتهم، بما في ذلك فائض القيمة. الشرط الأساسي للاستفادة من هذه الضمانة هو أن يكون الاستثمار الأولي قد تم تمويله بعملات أجنبية وتم التصريح به وفقاً للمساطر المعمول بها.',
        'حماية حق الملكية: يكفل الدستور المغربي، في فصله 35، حق الملكية ولا يمكن الحد منه إلا بموجب القانون. كما أن القانون رقم 7.81 المتعلق بنزع الملكية من أجل المنفعة العامة والاحتلال المؤقت يضع شروطاً صارمة لنزع الملكية، حيث لا يمكن أن يتم إلا لأغراض المنفعة العامة وبمقابل تعويض عادل ومسبق.',
        'الولوج إلى القضاء المختص: للمستثمر الأجنبي الحق الكامل في اللجوء إلى المحاكم المغربية للدفاع عن حقوقه. وقد تم إحداث المحاكم التجارية بموجب القانون رقم 53.95، وهي محاكم متخصصة في النظر في النزاعات التجارية، مما يضمن معالجة سريعة ومتخصصة للقضايا المتعلقة بالاستثمار.',
        'الحماية بموجب الاتفاقيات الدولية: صادق المغرب على عدد كبير من اتفاقيات تشجيع وحماية الاستثمارات المتبادلة (BITs) مع العديد من الدول. توفر هذه الاتفاقيات ضمانات إضافية للمستثمرين، بما في ذلك اللجوء إلى التحكيم الدولي لتسوية المنازعات، لا سيما عبر المركز الدولي لتسوية منازعات الاستثمار (ICSID) التابع للبنك الدولي، والذي يعد المغرب عضواً فيه.',
        'المواكبة المؤسساتية: تلعب الوكالة المغربية لتنمية الاستثمارات والصادرات (AMDIE)، المحدثة بموجب القانون رقم 60.16، دور \'المحامي العام\' للدولة في مجال الاستثمار، حيث تقدم مواكبة قبلية وبعدية للمستثمرين، وتساعدهم على تجاوز العقبات الإدارية، وتوفر لهم كافة المعلومات الضرورية لإنجاح مشاريعهم.',
      ],
    },
  ],
  faq_ar: [
    { q: 'كمستثمر أجنبي، هل يمكنني امتلاك 100% من رأس مال شركة في المغرب دون الحاجة إلى شريك مغربي؟', a: 'نعم، بشكل عام، يمكن للمستثمر الأجنبي امتلاك نسبة 100% من رأس مال شركة مغربية. لقد كرس القانون الإطار رقم 03.22 بمثابة ميثاق الاستثمار مبدأ حرية الاستثمار وإلغاء أي قيود مرتبطة بجنسية المستثمر في معظم القطاعات الاقتصادية. لم يعد شرط "المغربة" (Marocanisation) مطبقاً إلا في قطاعات قليلة ومنظمة بنصوص خاصة، مثل الصيد في أعالي البحار أو استغلال بعض الأراضي الفلاحية.' },
    { q: 'بعد تحقيق أرباح من استثماري، هل هناك قيود على تحويل هذه الأرباح ورأس المال الأصلي إلى الخارج؟', a: 'يضمن القانون المغربي للمستثمرين الأجانب حرية تحويل الأرباح الصافية بعد خصم الضرائب، وكذلك حصيلة بيع أو تصفية الاستثمار. يشترط لذلك أن يكون الاستثمار قد تم تمويله أصلاً بعملات أجنبية ومسجلاً لدى مكتب الصرف (Office des Changes) وفقاً للتعليمات العامة لعمليات الصرف (Instruction Générale des Opérations de Change). يضمن نظام القابلية للتحويل (régime de convertibilité) هذه الحقوق بشكل كامل لتشجيع تدفق رؤوس الأموال الأجنبية.' },
    { q: 'ما هي أبرز الحوافز والامتيازات الضريبية التي يقدمها المغرب للمستثمرين الأجانب بموجب ميثاق الاستثمار الجديد؟', a: 'يقدم ميثاق الاستثمار الجديد (القانون الإطار رقم 03.22) عدة أنظمة دعم للمشاريع الاستثمارية، تشمل المستثمرين الأجانب والمحليين على حد سواء. من أبرز هذه الحوافز:  1. منح مشتركة (primes communes) لدعم الاستثمارات المؤهلة. 2. منحة ترابية إضافية (prime territoriale) لتشجيع الاستثمار في الأقاليم والعمالات الأقل حظاً. 3. منحة قطاعية إضافية (prime sectorielle) لدعم القطاعات ذات الأولوية الاستراتيجية. بالإضافة إلى ذلك، يمكن للمشاريع ذات الطابع الاستراتيجي أن تستفيد من مزايا تفاوضية خاصة مع الحكومة. تهدف هذه الآليات إلى تعزيز جاذبية المغرب كوجهة استثمارية تنافسية.' },
    { q: 'هل يمكنني كأجنبي شراء الأراضي والعقارات في المغرب لأجل مشروعي الاستثماري؟', a: 'نعم، ولكن مع تمييز أساسي. يمكن للأجانب، أفراداً كانوا أم شركات، تملك العقارات غير الفلاحية (الحضرية أو المخصصة للصناعة والسياحة) دون قيود. أما بخصوص الأراضي الفلاحية، فإن الظهير الشريف بتاريخ 2 مارس 1973 يمنع الأجانب (الأشخاص الطبيعيين والاعتباريين) من تملكها. ومع ذلك، يمكن التحايل على هذا القيد قانونياً عبر إبرام عقود كراء طويلة الأمد (bail emphytéotique) تصل إلى 99 سنة، أو عن طريق شركة مغربية تمتلك الأرض، حتى لو كان رأسمال هذه الشركة مملوكاً بالكامل لأجانب، شريطة أن يكون غرض الشركة غير فلاحي.' },
    { q: 'في حالة نشوء نزاع تجاري يتعلق باستثماري، ما هي الآليات القانونية المتاحة لحل هذا النزاع؟', a: 'يوفر الإطار القانوني المغربي عدة آليات لحل النزاعات. أولاً، يمكن اللجوء إلى المحاكم التجارية المغربية المختصة بالنظر في النزاعات التجارية. ثانياً، وهو الخيار المفضل في الاستثمارات الدولية، يمكن اللجوء إلى التحكيم (Arbitrage) سواء كان وطنياً أو دولياً. ينظم القانون رقم 95.17 المتعلق بالتحكيم والوساطة الاتفاقية هذه المسطرة. والمغرب طرف في اتفاقية نيويورك لسنة 1958 بشأن الاعتراف بقرارات التحكيم الأجنبية وتنفيذها، مما يضمن قابلية تنفيذ الأحكام التحكيمية الدولية في المغرب. كما توجد مراكز تحكيم متخصصة مثل المركز الدولي للوساطة والتحكيم بالدار البيضاء (CIMAC).' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي الأنواع الرئيسية للصفقات العمومية التي ينظمها القانون المغربي؟', a: 'طبقا للمادة 6 من المرسوم رقم 2.22.431 المتعلق بالصفقات العمومية، تنقسم الصفقات العمومية إلى ثلاثة أنواع رئيسية حسب موضوعها: 1. صفقات الأشغال: وهي الصفقات التي يكون موضوعها تنفيذ أشغال بناء أو هدم أو صيانة أو ترميم منشآت وبنايات، بما في ذلك التجهيزات اللازمة لتشغيلها. 2. صفقات التوريدات: وهي الصفقات التي يكون موضوعها اقتناء منتجات أو مواد أو معدات، مع إمكانية أن تشمل أشغال وضع وتركيب ثانوية. 3. صفقات الخدمات: وهي الصفقات التي يكون موضوعها إنجاز خدمات لا يمكن وصفها بأنها أشغال أو توريدات، مثل خدمات الدراسات والإشراف، الصيانة، التنظيف، الحراسة، أو الخدمات المعلوماتية.' },
    { q: 'كيف يمكنني كصاحب مقاولة الاطلاع على إعلانات الصفقات العمومية المفتوحة؟', a: 'للاطلاع على الصفقات العمومية المتاحة، أوجبت المادة 22 من مرسوم الصفقات العمومية على صاحب المشروع (الإدارة العمومية) نشر الإعلانات عبر وسيلتين رئيسيتين: 1. بوابة الصفقات العمومية: وهي المنصة الإلكترونية الرسمية (www.marchespublics.gov.ma) التي تعتبر المصدر المركزي والشامل لجميع إعلانات طلبات العروض المفتوحة. 2. الصحافة الوطنية: يجب نشر إعلان الصفقة في جريدتين على الأقل توزعان على الصعيد الوطني، إحداهما باللغة العربية والأخرى بلغة أجنبية.  لذلك، يجب على المقاولين مراقبة البوابة الإلكترونية بشكل مستمر، بالإضافة إلى متابعة الجرائد الوطنية المتخصصة.' },
    { q: 'ما هي الوثائق الأساسية التي يجب علي تقديمها للمشاركة في صفقة عمومية؟', a: 'يجب على كل متنافس تقديم ملف يتكون عمومًا من عدة أجزاء، كما هو مفصل في المادة 29 من مرسوم الصفقات العمومية. وتحدد الوثائق المطلوبة بدقة في "نظام الاستشارة" الخاص بكل صفقة. بشكل عام، يتكون الملف من: - الملف الإداري: ويشمل وثائق تثبت الوضعية القانونية والجبائية والاجتماعية للمتنافس (مثل شهادة القيد في السجل التجاري، شهادة انتظام الوضعية الجبائية، وشهادة الانخراط في الصندوق الوطني للضمان الاجتماعي). - الملف التقني: ويحتوي على الوثائق التي تبرز القدرات التقنية والمهنية للمتنافس (مثل المراجع، شهادات حسن التنفيذ، الموارد البشرية والمادية). - العرض المالي: ويتضمن "عقد الالتزام" الذي يحدد مبلغ العرض، وجدول الأثمان وتفصيل الأسعار. - الملف الإضافي (عند الاقتضاء): قد يطلب صاحب المشروع وثائق إضافية حسب طبيعة الصفقة.' },
    { q: 'إذا اعتبرت أن إحدى مراحل إبرام الصفقة لم تكن عادلة، فما هي سبل الطعن المتاحة لي؟', a: 'ينظم الباب الثامن من مرسوم الصفقات العمومية (خاصة المادة 169) مساطر الطعن والشكاوى. إذا شعر متنافس بوجود خرق لقواعد المنافسة أو لمبادئ الصفقات العمومية، يمكنه اللجوء إلى: 1. الشكاية لدى صاحب المشروع: كخطوة أولى، يمكن للمتنافس تقديم شكاية مكتوبة إلى السلطة المختصة أو المسؤول عن الإدارة التي أطلقت الصفقة. 2. الطعن لدى اللجنة الوطنية للطلب العمومي: في حال عدم الرد على الشكاية أو في حال كان الرد غير مقنع، يمكن للمتنافس رفع طعن أمام "اللجنة الوطنية للطلب العمومي". هذه اللجنة هي هيئة استشارية مستقلة تنظر في الشكاوى المتعلقة بخروقات مساطر إبرام الصفقات وتقدم توصيات بشأنها. 3. الطعن القضائي: كحل أخير، يبقى من حق المتضرر اللجوء إلى القضاء الإداري (المحكمة الإدارية) للطعن في قرار صاحب المشروع والمطالبة بإلغائه أو بالتعويض عن الضرر.' },
    { q: 'هل يمنح القانون المغربي أفضلية للمقاولات الوطنية، خاصة الصغيرة والمتوسطة؟', a: 'نعم، يكرس مرسوم الصفقات العمومية مبدأ "الأفضلية الوطنية" ويدعم المقاولات الصغرى والمتوسطة بشكل واضح: - الأفضلية الوطنية (المادة 155): تُمنح أفضلية للعروض المقدمة من طرف المقاولات الوطنية في صفقات الأشغال والدراسات المرتبطة بها. ويتم ذلك عبر تطبيق نسبة زيادة (تصل إلى 15%) على مبالغ عروض المقاولات الأجنبية عند مقارنة العروض المالية. - دعم المقاولات الصغيرة والمتوسطة والتعاونيات والمقاول الذاتي (المادة 156): ألزم المرسوم أصحاب المشاريع بتخصيص نسبة من المبلغ المتوقع للصفقات التي يعتزمون إبرامها كل سنة لفائدة المقاولات الصغيرة والمتوسطة الوطنية، والتعاونيات، واتحاد التعاونيات، والمقاولين الذاتيين. هذه النسبة محددة حاليًا في 30%، مما يضمن لهم حصة مهمة من السوق العمومية.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي الإجراءات الأساسية للحصول على رخصة البناء في المغرب؟', a: 'للحصول على رخصة البناء، يجب على صاحب الشأن إيداع ملف طلب لدى الجماعة الترابية التي يقع العقار في نفوذها. يتكون الملف أساساً من التصاميم المعمارية التي يعدها مهندس معماري مسجل في هيئة المهندسين المعماريين، بالإضافة إلى وثائق تثبت ملكية العقار ودراسات تقنية (مثل دراسة الخرسانة المسلحة). تتم دراسة الطلب من طرف لجنة متخصصة في إطار "الشباك الوحيد لرخص التعمير". الإطار القانوني الرئيسي لهذه المسطرة هو القانون رقم 12.90 المتعلق بالتعمير، والمرسوم رقم 2.18.577 الصادر بتطبيقه والذي يحدد الإجراءات والكيفيات لمنح الرخص.' },
    { q: 'ماذا أفعل في حالة رفض طلبي لرخصة البناء أو عدم تلقي أي رد من الإدارة؟', a: 'في حالة الرفض الصريح، يجب أن يكون قرار الإدارة معللاً، أي أن يوضح الأسباب القانونية والتقنية للرفض. يمكن للمعني بالأمر تقديم تظلم إداري لدى رئيس مجلس الجماعة أو الطعن في القرار أمام المحكمة الإدارية. أما في حالة سكوت الإدارة عن الرد بعد انقضاء الآجال القانونية المحددة (شهرين كقاعدة عامة حسب المادة 48 من القانون 12.90)، فإن هذا السكوت يعتبر بمثابة رفض ضمني، مما يفتح الباب أيضاً للطعن القضائي أمام المحكمة الإدارية المختصة.' },
    { q: 'بعد الانتهاء من أشغال البناء، هل يمكنني استغلال المبنى فوراً؟', a: 'لا، لا يمكن استغلال المبنى أو شغله قانونياً مباشرة بعد انتهاء الأشغال. يجب الحصول على وثيقة إدارية تثبت مطابقة البناء المنجز للتصاميم المرخصة. هذه الوثيقة تسمى "رخصة السكن" إذا كان المبنى مخصصاً للسكن، أو "شهادة المطابقة" للاستعمالات الأخرى (تجاري، صناعي، إلخ). يتم إصدارها من طرف رئيس مجلس الجماعة بعد معاينة تقوم بها لجنة مختصة. يعتبر الحصول على هذه الوثيقة شرطاً أساسياً لربط البناية بشبكات الماء والكهرباء والصرف الصحي بشكل نهائي، وذلك طبقاً للمادة 55 من القانون رقم 12.90 المتعلق بالتعمير.' },
    { q: 'ما هي العقوبات المترتبة على البناء بدون رخصة أو مخالفة التصاميم المرخصة؟', a: 'يعتبر البناء بدون رخصة أو مخالفة ضوابط التعمير والبناء جريمة يعاقب عليها القانون. القانون رقم 66.12 المتعلق بمراقبة وزجر المخالفات في مجال التعمير والبناء شدد العقوبات بشكل كبير. تشمل الإجراءات الزجرية إصدار أمر فوري بإيقاف الأشغال، وفرض غرامات مالية تتراوح بين 10.000 و 100.000 درهم، وقد تصل إلى عقوبات حبسية في الحالات الخطيرة. كما يمكن للسلطات المختصة أن تأمر بهدم الأجزاء المخالفة أو البناء بأكمله على نفقة المخالف، مع إمكانية المتابعة الجنائية ضد جميع المتدخلين (صاحب المشروع، المهندس، المقاول).' },
    { q: 'هل أحتاج إلى رخصة للقيام بأعمال إصلاح طفيفة داخل شقتي أو منزلي؟', a: 'الأمر يعتمد على طبيعة الأشغال. الإصلاحات الداخلية البسيطة التي لا تمس العناصر الحاملة للبناء (الجدران الأساسية، الأعمدة، الأسقف) ولا تغير من الواجهة الخارجية للمبنى (مثل الصباغة الداخلية، تغيير الأرضيات) لا تستوجب الحصول على رخصة. لكن، أي أشغال تهدف إلى إدخال تغييرات على الواجهة الخارجية، أو إضافة بناء، أو تغيير في هيكل المبنى، حتى لو كانت طفيفة، تتطلب الحصول على "رخصة للقيام بأشغال صغرى" أو "رخصة إصلاح" من الجماعة. المرسوم رقم 2.18.577 يحدد لائحة الأشغال الخاضعة لهذه المسطرة المبسطة.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هو الأجل القانوني للتصريح بالولادة، وما هي الإجراءات المتبعة في حالة تجاوزه؟', a: 'يجب التصريح بالولادة لدى ضابط الحالة المدنية لمحل وقوعها داخل أجل ثلاثين (30) يوماً من تاريخ الولادة. استناداً إلى المادة 15 من القانون رقم 37.99 المتعلق بالحالة المدنية، إذا لم يتم التصريح بالولادة في الأجل القانوني، لا يمكن لضابط الحالة المدنية تسجيلها إلا بناءً على حكم تصريحي بالولادة صادر عن المحكمة الابتدائية المختصة.' },
    { q: 'كيف يمكنني تغيير الاسم الشخصي لطفلي بعد تسجيله في الحالة المدنية؟', a: 'يمكن تغيير الاسم الشخصي الذي تم اختياره إذا كان له مساس بالأخلاق أو النظام العام، أو كان مثار سخرية، أو اسماً أجنبياً غير معتمد. يتم تقديم طلب التغيير إلى اللجنة العليا للحالة المدنية عن طريق ضابط الحالة المدنية. وتنظر اللجنة في الطلب وتصدر قرارها بالقبول أو الرفض مع التعليل. ويستند هذا الإجراء إلى مقتضيات المادة 21 من القانون رقم 37.99 والمادة 24 من المرسوم التطبيقي رقم 2.99.665.' },
    { q: 'يوجد خطأ مادي في اسمي برسم ولادتي، ما هي مسطرة تصحيحه؟', a: 'يتم إصلاح الأخطاء المادية التي تكتشف في رسوم الحالة المدنية (مثل الأخطاء في الأسماء أو التواريخ) بناءً على حكم قضائي صادر عن المحكمة الابتدائية التي يوجد بدائرتها مكتب الحالة المدنية المسجل به الرسم المراد تصحيحه. يجب على المعني بالأمر تقديم مقال افتتاحي للدعوى لدى المحكمة، وبعد صدور الحكم بالتصحيح، يتم تبليغه إلى ضابط الحالة المدنية الذي يقوم بتدوين منطوق الحكم بطرة الرسم الأصلي. تنظم هذه المسطرة المادة 29 من القانون رقم 37.99.' },
    { q: 'ما الفرق بين النسخة الكاملة والموجز من رسم الولادة، ومن يحق له طلب النسخة الكاملة؟', a: 'موجز رسم الولادة هو وثيقة مختصرة تتضمن المعلومات الأساسية ويمكن لأي شخص طلبها. أما النسخة الكاملة من رسم الولادة، فتتضمن كافة البيانات الأصلية والبيانات الهامشية (زواج، طلاق، وفاة...). ونظراً لطابعها السري، لا تسلم إلا للمعني بالأمر شخصياً، أو لأصوله، أو فروعه، أو زوجه (شريطة عدم انحلال ميثاق الزوجية)، أو نائبه الشرعي، أو وكيله بموجب وكالة خاصة. ويخضع هذا التمييز لمقتضيات المادة 7 من المرسوم رقم 2.99.665 الصادر لتطبيق القانون رقم 37.99.' },
    { q: 'ما هي الإجراءات والآجال القانونية للتصريح بالوفاة؟', a: 'يجب التصريح بالوفاة داخل أجل ثلاثين (30) يوماً من تاريخ وقوعها لدى ضابط الحالة المدنية لمحل الوفاة أو لمحل سكنى المتوفى. يتم التصريح من طرف أحد أقارب المتوفى أو أي شخص لديه معلومات صحيحة ومؤكدة عن الوفاة، مع الإدلاء بشهادة طبية تثبت الوفاة. في حالة انصرام الأجل القانوني، لا يمكن تسجيل الوفاة إلا بناءً على حكم تصريحي بالوفاة صادر عن المحكمة الابتدائية المختصة، وذلك وفقاً للمادتين 23 و 24 من القانون رقم 37.99 المتعلق بالحالة المدنية.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي المكونات الأساسية لأجرة الموظف العمومي بالمغرب؟', a: 'تتكون أجرة الموظف العمومي أساساً من المرتب الأساسي المرتبط بالرقم الاستدلالي لدرجته ورتبته، وتضاف إليه مجموعة من التعويضات. تنقسم هذه التعويضات إلى تعويضات نظامية كـالتعويض عن الإقامة والتعويضات العائلية، وتعويضات خاصة مرتبطة بطبيعة المهام الممارسة (مثل التعويض عن المهام، التعويض عن الأعباء...). الأساس القانوني لهذه المنظومة هو الظهير الشريف رقم 1.58.008 الصادر في 24 فبراير 1958 بشأن النظام الأساسي العام للوظيفة العمومية، بالإضافة إلى المراسيم التطبيقية الخاصة بكل هيئة.' },
    { q: 'كيف يتم تعويض الموظفين عن مصاريف التنقل لأغراض المصلحة؟', a: 'يتم تعويض الموظفين والأعوان عن مصاريف التنقل التي يتحملونها بمناسبة قيامهم بمهام لفائدة الإدارة داخل المغرب أو خارجه. يشمل هذا التعويض مصاريف النقل والإقامة والأكل. تحدد مبالغ هذه التعويضات وكيفيات صرفها بموجب المرسوم رقم 2.06.377 الصادر في 29 أكتوبر 2008، وتختلف قيمتها حسب درجة الموظف والمسافة المقطوعة وطبيعة المهمة. يجب أن تكون المهمة مأموراً بها بشكل مسبق من طرف السلطة المختصة.' },
    { q: 'هل يحق للموظف العمومي الحصول على تعويض عن الساعات الإضافية؟', a: 'يعتبر العمل خارج أوقات العمل الرسمية، المحددة بموجب المرسوم رقم 2.05.916 بتاريخ 20 يوليوز 2005، أمراً استثنائياً. لا يتم التعويض عن الساعات الإضافية بشكل تلقائي، بل يجب أن تكون مبررة بضرورة المصلحة ومأذوناً بها كتابياً من الرئيس الإداري. يمكن أن يكون التعويض إما على شكل رخصة للراحة تعادل مدة العمل الإضافي، أو على شكل تعويض مالي تحدد شروطه ومقاديره نصوص تنظيمية خاصة، وذلك في حالة تعذر منح الراحة التعويضية.' },
    { q: 'ما هو السند القانوني وشروط الاستفادة من التعويضات العائلية في الوظيفة العمومية؟', a: 'يستفيد الموظف العمومي من تعويضات عائلية عن كل طفل تحت كفالته. الأساس القانوني لهذه التعويضات هو النظام الأساسي العام للوظيفة العمومية (ظهير 24 فبراير 1958)، وينظم شروطها التفصيلية المرسوم رقم 2.58.1381 الصادر في 27 نونبر 1958. تُمنح هذه التعويضات عن الأطفال حتى بلوغهم سن 21 سنة، أو 26 سنة إذا كانوا يتابعون دراستهم، وبدون تحديد للسن بالنسبة للأطفال في وضعية إعاقة. يتم تحديد المبلغ الشهري للتعويض عن كل طفل بموجب نص تنظيمي.' },
    { q: 'كيف تتم تسوية الوضعية الإدارية والمالية للموظف أثناء رخصة المرض؟', a: 'يميز القانون بين رخص المرض قصيرة الأمد وطويلة الأمد. بالنسبة لرخصة المرض قصيرة الأمد، يتقاضى الموظف مجموع أجرته خلال الثلاثة أشهر الأولى، ونصفها خلال الثلاثة أشهر التالية. أما في حالة رخصة المرض طويلة الأمد بسبب إحدى الإصابات أو الأمراض المحددة قانوناً، فيتقاضى الموظف مجموع أجرته لمدة ثلاث سنوات، ونصفها لمدة سنتين تاليتين. هذه المقتضيات منظمة بموجب الفصول 43 و 44 من النظام الأساسي العام للوظيفة العمومية.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'المرحلة الودية للتحصيل: الإشعار والآجال القانونية',
      content: 'تُعتبر المرحلة الودية أولى خطوات استخلاص الديون العمومية وفقاً لمقتضيات القانون رقم 15-97 بمثابة مدونة تحصيل الديون العمومية. تهدف هذه المرحلة إلى حث المدين على الأداء الطوعي لدينه قبل اللجوء إلى أي إجراء جبري.',
      bullets: [
        '**إصدار سند التحصيل:** تبدأ المسطرة بإصدار جداول الضرائب أو قوائم الرسوم أو الأوامر بالمداخيل، والتي تجعل الدين مستحق الأداء. وفقاً للمادة 13 من مدونة تحصيل الديون العمومية، لا يمكن الشروع في التحصيل إلا بناءً على سند تنفيذي صادر ومصادق عليه من طرف السلطة المختصة.',
        '**تبليغ الإشعار بالأداء:** يتلقى المدين إشعاراً بالتسديد يتضمن طبيعة الدين ومبلغه وتاريخ استحقاقه. هذا الإشعار، الذي يمكن أن يكون إلكترونياً أو ورقياً، يحدد الأجل المتاح للأداء الطوعي ويشكل آخر فرصة للأداء بدون تكاليف إضافية.',
        '**آجال الأداء الطوعي:** يجب على المدين أداء المبالغ المستحقة قبل انصرام الأجل المحدد في الإشعار، والذي يختلف حسب طبيعة الدين. يمكن للمدين، في حال إثبات عسره، طلب تسهيلات في الأداء من المحاسب المكلف بالتحصيل وفقاً للشروط المنصوص عليها في المادة 116 من المدونة.',
        '**عواقب انقضاء الأجل الودي:** يؤدي عدم الأداء داخل الأجل المحدد إلى الانتقال التلقائي إلى مرحلة التحصيل الجبري. كما تترتب على هذا التأخير، طبقاً للمادة 29 من المدونة، تطبيق زيادات عن التأخير وذعائر وغرامات تضاف إلى أصل الدين.',
        '**وسائل الأداء المتاحة:** تضع الخزينة العامة للمملكة رهن إشارة الملزمين عدة قنوات للأداء، منها الأداء المباشر في قباضات إدارة الضرائب، أو عبر المنصات الإلكترونية الرسمية للخزينة العامة للمملكة والمديرية العامة للضرائب، أو لدى البنوك الشريكة، وذلك لتسهيل عملية التسديد الطوعي.',
      ],
    },
    {
      h2: 'إجراءات التحصيل الجبري: من الإنذار إلى الحجز',
      content: 'عندما يفشل التحصيل الودي، يمنح القانون رقم 15-97 للمحاسبين المكلفين بالتحصيل صلاحيات واسعة للشروع في إجراءات جبرية تهدف إلى استيفاء ديون الدولة بالقوة العمومية.',
      bullets: [
        '**الإنذار القانوني:** يعتبر الإنذار أول إجراء من إجراءات التحصيل الجبري، وهو بمثابة إشعار أخير للمدين قبل فرض صوائر التحصيل. يتم تبليغه عبر البريد المضمون أو عن طريق أعوان التبليغ التابعين للخزينة أو المفوضين القضائيين، ويمنح المدين أجلاً إضافياً للأداء (المادة 36).',
        '**الأمر بالأداء (Le Commandement):** في حالة عدم الاستجابة للإنذار، يصدر المحاسب المكلف بالتحصيل أمراً بالأداء. هذا الإجراء، المنصوص عليه في المادة 40، يخول لأعوان التنفيذ الشروع في إجراءات الحجز، وتترتب عليه مصاريف قانونية يتحملها المدين.',
        '**الإشعار للغير الحائز (ATD):** يعد من أنجع وسائل التحصيل الجبري وأكثرها شيوعاً. بموجب المواد 101 إلى 104، يمكن للقابض أن يوجه إشعاراً مباشراً إلى الأغيار (بنوك، مشغلين، زبناء) الذين يحوزون أموالاً تعود للمدين، ويلزمهم بتحويلها مباشرة إلى الخزينة في حدود مبلغ الدين.',
        '**الحجز الإداري والبيع:** إذا لم تفض الإجراءات السابقة إلى نتيجة، يمكن اللجوء إلى حجز ممتلكات المدين المنقولة أو العقارية (المادة 59 وما يليها). يتم الحجز من طرف أعوان الخزينة ويمكن أن يؤدي إلى بيع المحجوزات في المزاد العلني لاستخلاص مبلغ الدين والمصاريف المترتبة عليه.',
        '**المسؤولية الجنائية للمدين:** تشدد المدونة على المسؤولية الجنائية للمدينين الذين يحاولون التملص من أداء ديونهم. فبموجب المادة 89، يعاقب كل من قام بتنظيم عسره أو افتعاله بهدف إتلاف أو تبديد ممتلكاته للتهرب من الأداء، بعقوبات حبسية وغرامات مالية.',
      ],
    },
    {
      h2: 'حقوق المدين وسبل الطعن في إجراءات التحصيل',
      content: 'رغم الطابع الإلزامي لإجراءات التحصيل، فقد كفل المشرع المغربي للمدين مجموعة من الحقوق والضمانات التي تمكنه من الدفاع عن مصالحه والطعن في الدين أو في مساطر استخلاصه.',
      bullets: [
        '**التعرض على إجراءات التحصيل:** يحق للمدين تقديم تعرض على إجراءات التحصيل الجبري، كالأمر بالأداء أو الحجز، أمام رئيس المحكمة الإدارية. يجب أن يستند هذا التعرض، وفقاً للمادة 121، على أسباب محددة قانوناً مثل انعدام السند التنفيذي، أو انقضاء الدين بالتقادم، أو بطلان الإجراء شكلاً.',
        '**الطعن الإداري (الشكاية):** قبل اللجوء إلى القضاء للطعن في أساس الدين (أي في صحة فرض الضريبة أو الرسم)، يجب على المدين وجوباً تقديم شكاية إدارية إلى السلطة التي أصدرت الأمر بالتحصيل (مثلاً: المدير الإقليمي للضرائب). تملك الإدارة أجل 6 أشهر للرد على هذه الشكاية (المادة 117).',
        '**الطعن القضائي أمام المحكمة الإدارية:** في حالة رفض الشكاية الإدارية صراحة أو ضمناً (بعدم الجواب داخل أجل 6 أشهر)، يمكن للمدين رفع دعوى قضائية أمام المحكمة الإدارية المختصة. يجب رفع هذه الدعوى داخل أجل 30 يوماً من تاريخ تبليغ قرار الرفض أو انقضاء الأجل المذكور (المادة 120).',
        '**طلب إيقاف الأداء:** لا يوقف تقديم الشكاية أو رفع الدعوى القضائية إجراءات التحصيل تلقائياً. للحصول على وقف التنفيذ، يجب على المدين تقديم طلب صريح بذلك إلى المحاسب المكلف بالتحصيل أو إلى قاضي المستعجلات، مع ضرورة تكوين ضمانات (كفالة بنكية مثلاً) تغطي مبلغ الدين المتنازع بشأنه، وذلك طبقاً لمقتضيات المادة 118.',
        '**الحق في الحصول على بيان الوضعية:** من الحقوق الأساسية للمدين، المنصوص عليها في المادة 115، إمكانية أن يطلب في أي وقت من المحاسب المكلف بالتحصيل تسليمه شهادة أو بياناً لوضعيته الجبائية، يوضح بالتفصيل أصل الدين والمبالغ المؤداة والرصيد المتبقي، مما يضمن شفافية الإجراءات.',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي الإجراءات الأولية التي تباشرها الإدارة في حالة عدم أدائي لدين عمومي (ضريبة مثلا) في أجله القانوني؟', a: 'في حالة عدم أداء الدين العمومي عند حلول أجله، يقوم المحاسب المكلف بالتحصيل بتوجيه "آخر إشعار بدون صائر" إلى المدين. إذا لم يتم الأداء في غضون ثلاثين (30) يوماً من تاريخ استلام هذا الإشعار، يمكن للمحاسب الشروع في إجراءات التحصيل الجبري وفقاً للمادة 36 من القانون رقم 15.97 بمثابة مدونة تحصيل الديون العمومية. هذا الإشعار هو بمثابة إنذار أخير قبل اللجوء إلى طرق التنفيذ الجبري.' },
    { q: 'هل يمكنني المنازعة في دين عمومي تطالبني الإدارة بأدائه؟ وما هي المسطرة المتبعة؟', a: 'نعم، يمكن للمدين الذي ينازع في شرعية أو مبلغ الدين المطلوب منه أن يقدم مطالبة كتابية إلى رئيس الإدارة التي ينتمي إليها المحاسب المكلف بالتحصيل (مثلاً، مدير الضرائب). تؤدي هذه المطالبة إلى وقف أداء المبلغ المنازع فيه، شريطة أن يقدم المدين ضمانات (كفالة بنكية مثلاً) تكفل تحصيل الدين في حالة رفض المطالبة. تنظم هذه المسطرة المواد من 117 إلى 119 من مدونة تحصيل الديون العمومية.' },
    { q: 'ما هي أهم وسائل التحصيل الجبري التي يمكن للإدارة اللجوء إليها ضدي؟', a: 'في حالة عدم الأداء الطوعي بعد استنفاد المسطرة الحبية، يخول القانون رقم 15.97 للإدارة استعمال عدة وسائل للتنفيذ الجبري، أهمها: - الإشعار للغير الحائز (المواد 101 إلى 104): يسمح بحجز المبالغ المستحقة للمدين لدى الغير (كالأبناك أو المشغلين). - حجز وبيع المنقولات (ابتداءً من المادة 45). - الحجز العقاري. - الإكراه البدني كإجراء أخير في حالات وشروط محددة (المواد 76 إلى 83).' },
    { q: 'أعاني من صعوبات مالية، هل يمكنني طلب تسهيلات في أداء الدين العمومي على شكل أقساط؟', a: 'نعم، يمكن للمدين الذي يثبت وجود صعوبات مالية تمنعه من تسديد الدين دفعة واحدة، أن يقدم طلباً معللاً إلى المحاسب المكلف بالتحصيل للحصول على تسهيلات في الأداء. يمكن أن تتخذ هذه التسهيلات شكل دفعات مجزأة أو آجال للأداء. ويبقى منح هذه التسهيلات خاضعاً للسلطة التقديرية للإدارة، وذلك طبقاً لمقتضيات المادة 116 من مدونة تحصيل الديون العمومية.' },
    { q: 'متى يسقط الدين العمومي بالتقادم؟', a: 'يتقادم إجراء تحصيل الديون العمومية بمضي أربع (4) سنوات ميلادية كاملة تلي تاريخ الشروع في تحصيلها أو تاريخ وضعها في التحصيل (تاريخ إصدار الأمر بالاستخلاص). وينقطع هذا التقادم بكل إجراء من إجراءات التحصيل الجبري يتم تبليغه للمدين بشكل قانوني، أو بكل طلب لتسهيلات الأداء يقدمه المدين. تنظم هذه المقتضيات المادة 123 من القانون رقم 15.97 بمثابة مدونة تحصيل الديون العمومية.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الإطار القانوني للجمعيات والشركات الرياضية',
      content: 'أحدث القانون رقم 30-09 المتعلق بالتربية البدنية والرياضة، الصادر بتنفيذه الظهير الشريف رقم 1-10-150، تغييراً جذرياً في حوكمة الأندية الرياضية، حيث فرض على الجمعيات التي تشارك في المنافسات الاحترافية التحول إلى شركات رياضية. يهدف هذا الإطار الجديد إلى إرساء قواعد الاحتراف، الحكامة الجيدة والشفافية المالية في تسيير أندية النخبة.',
      bullets: [
        'بموجب المادة 15 من القانون 30-09، يتعين على كل جمعية رياضية يشارك فريقها الأول في بطولة احترافية، تُنظمها جامعة رياضية معترف بها، أن تُحدث شركة رياضية وتتخذ شكل شركة مساهمة (Société Anonyme) خاضعة لأحكام القانون رقم 17-95.',
        'يجب إبرام اتفاقية بين الجمعية الرياضية والشركة المحدثة عنها، تُصادق عليها الجمعية العمومية للجمعية. تحدد هذه الاتفاقية، التي لا يمكن أن تتجاوز مدتها 10 سنوات قابلة للتجديد، العلاقات بين الطرفين، خاصة فيما يتعلق بشروط استعمال علامة الجمعية وشعارها وألوانها.',
        'يحدد المرسوم رقم 2-17-498 الحد الأدنى لرأس مال الشركات الرياضية التي تشارك فرقها في البطولة الاحترافية لكرة القدم. يتوجب على الجمعية الرياضية الأم أن تساهم في رأسمال الشركة بحصة لا تقل عن 30% من الأسهم عند تأسيسها.',
        'تخضع الشركة الرياضية في تسييرها لمجالس الإدارة أو مجالس الإدارة الجماعية وفقاً لقانون شركات المساهمة. يجب أن يضم مجلس الإدارة ممثلين عن الجمعية الرياضية لضمان استمرارية المشروع الرياضي والتاريخي للنادي.',
        'تلعب الجامعة الملكية المغربية لكرة القدم دوراً محورياً في المصادقة على الأنظمة الأساسية للشركات الرياضية ومراقبة امتثالها للقوانين والأنظمة الجاري بها العمل، وذلك كشرط أساسي لمنحها "رخصة النادي المحترف" التي تسمح بالمشاركة في المنافسات التي تنظمها.',
      ],
    },
    {
      h2: 'عقد الرياضي المحترف: الطبيعة والأحكام الخاصة بكرة القدم',
      content: 'يُعتبر عقد الرياضي المحترف، كما نظمه القانون 30-09 ومرسومه التطبيقي رقم 2-10-628، عقد شغل محدد المدة يربط بين رياضي محترف ونادٍ رياضي (جمعية أو شركة). يخضع هذا العقد لأحكام خاصة توازن بين متطلبات قانون الشغل وخصوصية الممارسة الرياضية على مستوى عالٍ.',
      bullets: [
        'يجب أن يحرر العقد وجوباً في ثلاث نظائر أصلية على الأقل، ويجب أن يتضمن بيانات إلزامية محددة في المادة 1 من المرسوم التطبيقي، كمدة العقد، ومبلغ الأجر وتفاصيله (راتب شهري، مكافآت المباريات، منح التوقيع)، والتزامات الطرفين.',
        'يكون عقد الرياضي المحترف دائماً عقد شغل محدد المدة (CDD). وفقاً لأنظمة الجامعة الملكية المغربية لكرة القدم، لا يمكن أن تقل مدة العقد عن تاريخ إبرامه حتى نهاية الموسم الرياضي، ولا يمكن أن تتجاوز خمس سنوات، وذلك تماشياً مع لوائح الفيفا.',
        'يلتزم النادي بأداء الأجر المتفق عليه بانتظام، وتوفير التأمين الإجباري عن حوادث الشغل والأمراض المهنية، والتصريح لدى الصندوق الوطني للضمان الاجتماعي (CNSS) وفقاً لمقتضيات مدونة الشغل، وتوفير الظروف الملائمة للممارسة الرياضية (تجهيزات، رعاية طبية).',
        'يلتزم اللاعب بالمشاركة في التدريبات والمنافسات، والحفاظ على لياقته البدنية، واحترام النظام الداخلي للنادي والقرارات الفنية للمدرب، والامتثال لقواعد مكافحة المنشطات، والمشاركة في الأنشطة الترويجية للنادي ضمن الحدود المنصوص عليها في العقد.',
        'أحدثت الجامعة الملكية المغربية لكرة القدم "الغرفة الوطنية لفض النزاعات" (CNRL) كآلية مختصة بالنظر في النزاعات الناشئة عن العقود الرياضية بين اللاعبين والأندية. قرارات هذه الغرفة ملزمة للأطراف، مع إمكانية استئنافها أمام الهيئات القضائية المختصة أو هيئات التحكيم الرياضي الوطنية أو الدولية.',
      ],
    },
    {
      h2: 'الرخصة الرياضية وحقوق الاستغلال التجاري',
      content: 'تُعد الرخصة الرياضية الوثيقة الإدارية التي لا غنى عنها لممارسة أي نشاط رياضي تنافسي، بينما تشكل حقوق الاستغلال التجاري، وعلى رأسها حقوق البث التلفزي، عصب الحياة المالية للأندية والجامعات الرياضية في منظومة كرة القدم الحديثة.',
      bullets: [
        'تنص المادة 13 من القانون 30-09 على أن المشاركة في المنافسات الرياضية التي تنظمها الجامعات رهينة بالحصول على رخصة رياضية سارية المفعول. تُسلم هذه الرخصة من طرف الجامعة الملكية المغربية لكرة القدم وتثبت أهلية الرياضي للمشاركة وتأهيله القانوني والطبي.',
        'تمنح المادة 73 من القانون 30-09 للجامعات الرياضية، دون سواها، ملكية حقوق استغلال المنافسات الرياضية التي تنظمها. وبناءً عليه، تقوم الجامعة الملكية المغربية لكرة القدم بالتفاوض والتسويق الجماعي لحقوق البث التلفزي للبطولة الاحترافية "إنوي" وباقي المسابقات.',
        'تحدد الجمعية العمومية للجامعة الملكية المغربية لكرة القدم معايير وقواعد توزيع العائدات المتأتية من حقوق البث على الأندية المشاركة. تأخذ هذه المعايير في الاعتبار عادة الترتيب النهائي في البطولة، والجماهيرية، ونتائج الأندية في مسابقات الشباب، ومعايير الحكامة الجيدة.',
        'يميز العقد الرياضي بين حقوق الصورة الجماعية للفريق، التي يملكها النادي ويستغلها في إطار عقود الرعاية، وحقوق الصورة الفردية للاعب. يجب تحديد نطاق استغلال النادي لصورة اللاعب بشكل دقيق في العقد لتجنب النزاعات، خاصة فيما يتعلق بالرعاة الشخصيين للاعب.',
        'يعاقب القانون على المشاركة في منافسة رياضية دون التوفر على رخصة. كما أن أنظمة الجامعة تفرض عقوبات تأديبية ومالية على الأندية واللاعبين في حالة الإخلال بالالتزامات المتعلقة بحقوق الاستغلال التجاري أو عقود الرعاية المركزية التي تبرمها الجامعة.',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي الإجراءات القانونية التي يمكن للاعب كرة قدم محترف اتخاذها في حالة عدم توصله بأجوره من ناديه؟', a: 'طبقا لمقتضيات القانون رقم 30.09 المتعلق بالتربية البدنية والرياضة، يعتبر عقد اللاعب المحترف عقد شغل. في حالة إخلال النادي بالتزامه بأداء الأجور، يمكن للاعب اللجوء إلى الغرفة الوطنية لفض النزاعات (CNRL) التابعة للجامعة الملكية المغربية لكرة القدم. يمكن للغرفة أن تصدر قرارا يلزم النادي بالأداء، وفي حالة استمرار عدم الامتثال، يمكن أن يؤدي ذلك إلى فسخ العقد من جانب اللاعب لسبب مشروع مع حقه في التعويض، بالإضافة إلى إمكانية فرض عقوبات رياضية على النادي.' },
    { q: 'كيف يتم تحويل جمعية رياضية لكرة القدم إلى شركة رياضية وفقا للقانون المغربي؟', a: 'أوجب القانون رقم 30.09 على الجمعيات الرياضية التي تشارك أنديتها في المنافسات الاحترافية (البطولة الاحترافية بقسميها الأول والثاني) إحداث شركات رياضية. يتم هذا التحول عبر قيام الجمعية بتأسيس شركة رياضية (عادة شركة مساهمة) ونقل فرع النشاط المتعلق بكرة القدم الاحترافية إليها. يهدف هذا الإجراء إلى إخضاع تسيير الأندية لقواعد الحكامة الجيدة والشفافية المالية المنصوص عليها في قانون الشركات التجارية، وفصل النشاط الاحترافي عن نشاط الهواة.' },
    { q: 'ما هي الشروط القانونية لممارسة مهنة وكيل اللاعبين في المغرب؟', a: 'تنظم مهنة وكيل اللاعبين بموجب القانون رقم 30.09 وأنظمة الجامعة الملكية المغربية لكرة القدم. لممارسة هذه المهنة، يجب على الشخص الحصول على رخصة "وكيل رياضي" معتمدة من الجامعة. من بين الشروط الأساسية: التمتع بالأهلية المدنية الكاملة، والسيرة الحسنة (عدم وجود سوابق جنائية)، واجتياز امتحان الكفاءة الذي تنظمه الجامعة، وتقديم ضمانة مالية لتغطية مسؤوليته المهنية. يمنع على أي شخص غير مرخص له ممارسة الوساطة في إبرام العقود الرياضية تحت طائلة العقوبات.' },
    { q: 'ما هي العقوبات المقررة قانوناً لأعمال الشغب والتخريب في الملاعب الرياضية؟', a: 'يعاقب على أعمال الشغب في الملاعب الرياضية بموجب القانون رقم 09.09 المتمم لمجموعة القانون الجنائي. ينص هذا القانون على عقوبات حبسية وغرامات مالية مشددة. على سبيل المثال، يعاقب بالحبس من سنة إلى خمس سنوات وبغرامة من 1.200 إلى 20.000 درهم كل من ساهم في أعمال عنف أثناء المباريات نتج عنها إيذاء. كما يعاقب على أفعال مثل إلقاء المقذوفات، أو حيازة أسلحة أو مواد حارقة داخل الملعب. بالإضافة إلى العقوبات الجنائية، يمكن للمحكمة أن تقضي بعقوبة إضافية تتمثل في المنع من حضور المباريات الرياضية.' },
    { q: 'ما هي القواعد المنظمة لانتقال اللاعبين القاصرين (أقل من 18 سنة) في كرة القدم؟', a: 'يخضع انتقال اللاعبين القاصرين لقواعد صارمة تهدف إلى حمايتهم. على الصعيد الدولي، يطبق المغرب لوائح الاتحاد الدولي لكرة القدم (FIFA) التي تمنع كأصل عام الانتقالات الدولية للاعبين الذين تقل أعمارهم عن 18 عامًا، مع وجود استثناءات محددة (مثل انتقال والدي اللاعب لأسباب غير مرتبطة بكرة القدم). أما على الصعيد الوطني، فإن أي انتقال للاعب قاصر يتطلب موافقة صريحة ومكتوبة من وليه الشرعي، وتضع الجامعة الملكية المغربية لكرة القدم أنظمة خاصة تضمن حماية حقوقهم التعليمية والرياضية.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي الضمانات القانونية لحماية معطياتي الشخصية عند استخدامها من قبل أنظمة الذكاء الاصطناعي في المغرب؟', a: 'يخضع استخدام المعطيات الشخصية في المغرب، بما في ذلك عبر أنظمة الذكاء الاصطناعي، لمقتضيات القانون رقم 09-08 المتعلق بحماية الأشخاص الذاتيين تجاه معالجة المعطيات ذات الطابع الشخصي. يفرض هذا القانون على كل جهة تعالج المعطيات (مثل مطوري أو مستخدمي أنظمة الذكاء الاصطناعي) الحصول على موافقة صريحة من الشخص المعني قبل جمع بياناته، وتحديد الغرض من المعالجة بشكل واضح، وعدم استخدامها لأغراض أخرى. كما يمنح القانون للأفراد حقوقاً أساسية كالحق في الولوج إلى بياناتهم، والحق في تصحيحها، والحق في التعرض على معالجتها لأسباب مشروعة. وتشرف اللجنة الوطنية لمراقبة حماية المعطيات ذات الطابع الشخصي (CNDP) على تطبيق هذه المقتضيات.' },
    { q: 'في حالة وقوع ضرر بسبب قرار خاطئ اتخذه نظام ذكاء اصطناعي (مثلاً، سيارة ذاتية القيادة)، من يتحمل المسؤولية القانونية؟', a: 'في غياب نص قانوني خاص بمسؤولية الذكاء الاصطناعي، يتم الرجوع إلى القواعد العامة للمسؤولية المدنية المنصوص عليها في ظهير الالتزامات والعقود. يمكن أن تتوزع المسؤولية على عدة أطراف حسب الحالة: 1.  المسؤولية التقصيرية (الفصل 77 و 78): يمكن مساءلة مطور أو مبرمج النظام إذا ثبت وجود خطأ في التصميم أو البرمجة أدى إلى الضرر. 2.  مسؤولية حارس الشيء (الفصل 88): يمكن تحميل مالك أو مستخدم النظام (مثلاً، مالك السيارة ذاتية القيادة) المسؤولية، على اعتبار أن النظام تحت حراسته، إلا إذا أثبت أنه فعل ما كان ضرورياً لمنع الضرر أو أن الضرر يرجع لسبب أجنبي لا يد له فيه. 3.  مسؤولية المنتج عن منتجاته المعيبة: يمكن أيضاً متابعة الشركة المصنعة. ويبقى للقضاء السلطة التقديرية لتحديد المسؤول في كل حالة على حدة.' },
    { q: 'هل الأعمال التي يُنشئها الذكاء الاصطناعي بشكل مستقل (مثل لوحة فنية أو مقطوعة موسيقية) محمية بموجب قانون حقوق المؤلف المغربي؟', a: 'الإطار القانوني الحالي يطرح إشكالية. فالقانون رقم 2.00 المتعلق بحقوق المؤلف والحقوق المجاورة يربط صفة "المؤلف" بالشخص الطبيعي الذي قام بالإبداع. وبما أن الذكاء الاصطناعي ليس شخصاً طبيعياً، فإن المصنفات التي يتم إنشاؤها بالكامل وبشكل مستقل من طرفه لا تستفيد، من حيث المبدأ، من الحماية القانونية المخصصة للمؤلف. ومع ذلك، إذا كان هناك تدخل بشري إبداعي وملموس في عملية الإنشاء (مثل التوجيه الدقيق والمفصل الذي يقدمه المستخدم)، يمكن اعتبار هذا المستخدم مؤلفاً للعمل النهائي. هذه المسألة لا تزال موضوع نقاش فقهي وقضائي عالمي، والإطار القانوني المغربي مرشح للتطور لمواكبة هذه التحديات.' },
    { q: 'هل العقود المبرمة عبر منصات رقمية تستخدم وكلاء ذكاء اصطناعي (Chatbots) لإتمام الصفقات تعتبر ملزمة قانوناً؟', a: 'نعم، تعتبر هذه العقود صحيحة وملزمة قانوناً. القانون رقم 53.05 المتعلق بالتبادل الإلكتروني للمعطيات القانونية أقر بالمساواة في القيمة الثبوتية بين الوثيقة المحررة على دعامة ورقية والوثيقة المحررة على دعامة إلكترونية. يعتبر استخدام وكيل ذكاء اصطناعي (شات بوت) من قبل أحد الأطراف بمثابة استخدام أداة أو وسيط إلكتروني للتعبير عن إرادته. طالما أن أركان العقد الأساسية (الرضا، المحل، السبب) متوفرة ويمكن إثباتها إلكترونياً، فإن العقد ينتج كافة آثاره القانونية. وتُنسب الأفعال والتصريحات الصادرة عن الوكيل الذكي إلى الطرف الذي يستخدمه.' },
    { q: 'ما هو الموقف القانوني من استخدام تقنيات "التزييف العميق" (Deepfake) لإنشاء محتوى يهدف إلى التشهير أو الاحتيال؟', a: 'رغم عدم وجود نص قانوني يجرم "التزييف العميق" بالاسم، فإن إنتاج أو نشر محتوى مزيف باستخدام هذه التقنية يمكن أن يقع تحت طائلة عدة نصوص في القانون الجنائي المغربي، خاصة تلك المتعلقة بالجرائم المعلوماتية. على سبيل المثال: - المس بالحياة الخاصة: يعاقب الفصل 1-447 من القانون الجنائي على "تثبيت أو تسجيل أو بث أو توزيع صورة شخص أثناء تواجده في مكان خاص دون موافقته". - التشهير والقذف: يمكن أن يشكل المحتوى المزيف جريمة قذف أو سب علني، خاصة إذا تم نشره على منصات التواصل الاجتماعي. - النصب والاحتيال: إذا استُخدم المحتوى المزيف لخداع شخص ما والحصول على أمواله، فإنه يشكل جريمة نصب يعاقب عليها الفصل 540 من القانون الجنائي. - بث وتوزيع ادعاءات كاذبة: يعاقب الفصل 2-447 على بث أو توزيع ادعاءات أو وقائع كاذبة بقصد المساس بالحياة الخاصة للأشخاص أو التشهير بهم. العبرة هي بالقصد الجنائي والضرر الناتج عن الفعل.' },
  ],
  ...
  faq_ar: [
    { q: 'بصفتي مؤثراً، هل أنا ملزم قانوناً بالإشارة بوضوح إلى أن المحتوى الذي أنشره هو إعلان أو شراكة تجارية مدفوعة الأجر؟', a: 'نعم، بكل تأكيد. الشفافية تجاه المتابعين ليست مجرد ممارسة أخلاقية، بل هي التزام قانوني. بموجب القانون رقم 31.08 القاضي بتحديد تدابير لحماية المستهلك، يُعتبر كل إعلان أو إشهار لا يفصح عن طابعه التجاري إعلاناً مضللاً. إخفاء العلاقة التجارية مع العلامة التجارية يمكن أن يضلل المستهلك حول طبيعة التوصية ومصداقيتها. لذلك، يجب على المؤثر أن يشير بوضوح إلى أن المحتوى إعلاني باستخدام عبارات صريحة مثل "#إعلان"، "#شراكة_مدفوعة" أو "برعاية..." لتجنب أي مسؤولية قانونية محتملة.' },
    { q: 'ما هي مسؤوليتي القانونية كمؤثر إذا تسبب منتج قمت بالترويج له في إلحاق ضرر بالمستهلك؟', a: 'يمكن أن تُثار مسؤولية المؤثر القانونية. على الرغم من أن المسؤولية الرئيسية تقع على عاتق المنتج أو المورد وفقاً للقانون رقم 31.08 المتعلق بحماية المستهلك، إلا أن المؤثر قد يُعتبر شريكاً أو متدخلاً في عملية الترويج. إذا ثبت أن المؤثر كان على علم بعيب المنتج أو خطورته، أو قدم معلومات كاذبة ومضللة حول سلامته وفعاليته، يمكن متابعته على أساس المسؤولية التقصيرية المنصوص عليها في الفصول 77 و 78 من قانون الالتزامات والعقود، وقد يُلزم بتعويض المتضرر عن الأضرار التي لحقت به.' },
    { q: 'هل الدخل الذي أحصل عليه من نشاطي كمؤثر، بما في ذلك الهدايا والمنتجات المجانية، خاضع للضريبة في المغرب؟', a: 'نعم، جميع المداخيل المحققة من نشاط التأثير الرقمي تعتبر خاضعة للضريبة. وفقاً للمدونة العامة للضرائب، تُصنف هذه المداخيل ضمن فئة الدخول المهنية. هذا يشمل ليس فقط المبالغ النقدية، بل أيضاً المنافع العينية ذات القيمة (مثل الهدايا، رحلات السفر، المنتجات باهظة الثمن). يجب على المؤثر التصريح بمجموع مداخيله لدى المديرية العامة للضرائب وأداء الضريبة على الدخل المستحقة، سواء كان يمارس نشاطه كشخص ذاتي أو عبر شركة.' },
    { q: 'هل يجوز لي استخدام مقاطع موسيقية أو صور محمية بحقوق المؤلف في المحتوى الذي أنشره دون الحصول على ترخيص؟', a: 'لا، لا يجوز ذلك. القانون رقم 2.00 المتعلق بحقوق المؤلف والحقوق المجاورة يحمي المصنفات الأدبية والفنية، بما في ذلك الموسيقى والصور الفوتوغرافية ومقاطع الفيديو. استخدام هذه المصنفات دون الحصول على إذن صريح أو ترخيص من صاحب الحقوق يعتبر تعدياً على حقوق المؤلف (تقليداً)، وهو عمل يعاقب عليه القانون. يمكن لصاحب الحقوق المطالبة بوقف النشر، سحب المحتوى، والحصول على تعويضات مالية عن الضرر. لذا، يجب استخدام محتوى مرخص، أو محتوى من الملك العام، أو إنشاء محتوى أصلي بالكامل.' },
    { q: 'هل هناك منتجات أو خدمات يُحظر عليّ الترويج لها كمؤثر في المغرب؟', a: 'نعم، يمنع القانون المغربي بشكل صارم الإشهار والترويج لبعض المنتجات والخدمات. من أبرزها: - المشروبات الكحولية: بموجب القانون رقم 15.91. - التبغ ومنتجاته: وفقاً للقانون رقم 46.02. - الأدوية التي لا يمكن صرفها إلا بوصفة طبية، وبعض الخدمات الطبية التي لا يمكن الترويج لها إلا من قبل مهنيي الصحة المؤهلين. - ألعاب القمار واليانصيب غير المرخصة. - أي منتج أو خدمة مخالفة للنظام العام والآداب العامة. الترويج لهذه الفئات المحظورة يعرض المؤثر لعقوبات جنائية صارمة وغرامات مالية كبيرة.' },
  ],
  ...
  faq_ar: [
    { q: 'ما هي العقوبات القانونية المترتبة على السياقة تحت تأثير الكحول أو المواد المخدرة في المغرب؟', a: 'تعتبر السياقة في حالة سكر أو تحت تأثير مواد مخدرة جنحة يعاقب عليها القانون بشدة. وفقًا للمادة 183 من القانون رقم 52.05 المتعلق بمدونة السير على الطرق، يُعاقب كل من ساق مركبة وهو في حالة سكر أو تحت تأثير الكحول بنسبة تركيز تفوق الحد القانوني، أو تحت تأثير مواد مخدرة، بالحبس من ستة أشهر إلى سنة واحدة وبغرامة مالية تتراوح بين 5.000 و 10.000 درهم، أو بإحدى هاتين العقوبتين فقط. بالإضافة إلى ذلك، يتم تعليق رخصة السياقة لمدة تتراوح بين ستة أشهر وسنة، مع خصم 6 نقاط من رصيد الرخصة. وفي حالة رفض السائق الخضوع للاختبارات، تطبق عليه نفس العقوبات.' },
    { q: 'تم ضبطي وأنا أستعمل الهاتف المحمول أثناء السياقة. ما هي طبيعة هذه المخالفة وما هي العقوبات المترتبة عليها؟', a: 'يُعد استعمال الهاتف المحمول أثناء السياقة مخالفة من الدرجة الأولى. حسب المادة 184 من مدونة السير، يُعاقب مرتكب هذه المخالفة بأداء غرامة تصالحية وجزافية قدرها 700 درهم. في حال الأداء الفوري، تخفض الغرامة إلى 400 درهم، وإذا تم الأداء في غضون 15 يوماً، يكون المبلغ 500 درهم. بالإضافة إلى الغرامة المالية، يترتب على هذه المخالفة خصم 3 نقاط من رصيد رخصة السياقة. الهدف من هذا التشديد هو الحد من المخاطر الجسيمة التي يسببها تشتت انتباه السائق.' },
    { q: 'ما هي العقوبات المحددة قانونًا لتجاوز السرعة المسموح بها؟', a: 'تختلف العقوبات حسب مقدار تجاوز السرعة المسموح بها: - تجاوز السرعة بأقل من 20 كلم/ساعة: مخالفة من الدرجة الثالثة، غرامتها 300 درهم. - تجاوز السرعة بين 20 و 30 كلم/ساعة: مخالفة من الدرجة الثانية، غرامتها 500 درهم وخصم نقطتين (2) من رخصة السياقة. - تجاوز السرعة بين 30 و 50 كلم/ساعة: مخالفة من الدرجة الأولى، غرامتها 700 درهم وخصم 4 نقاط. - تجاوز السرعة بـ 50 كلم/ساعة أو أكثر: تعتبر جنحة وفق المادة 186، ويعاقب عليها بغرامة من 4.000 إلى 8.000 درهم، مع توقيف رخصة السياقة لمدة تتراوح بين شهر وثلاثة أشهر، وخصم 6 نقاط.' },
    { q: 'ما هي عقوبة السياقة بدون التوفر على رخصة السياقة؟', a: 'تعتبر السياقة بدون الحصول على رخصة السياقة جنحة يعاقب عليها القانون. تنص المادة 167 من مدونة السير على أن كل شخص يسوق مركبة على الطريق العمومية دون الحصول على رخصة السياقة اللازمة لذلك الصنف من المركبات، يُعاقب بغرامة مالية تتراوح بين 2.000 و 4.000 درهم. بالإضافة إلى ذلك، تأمر المحكمة بإيداع المركبة في المحجز لمدة 7 أيام، ولا يمكن استرجاعها إلا من طرف شخص حاصل على رخصة سياقة من نفس الصنف.' },
    { q: 'قمت بحادثة سير نتجت عنها خسائر مادية فقط وفررت من مكان الحادث. ما هي التبعات القانونية لجريمة الفرار؟', a: 'تُعرف هذه الحالة بـ "جنحة الفرار عقب حادثة سير". وفقًا للمادة 182 من مدونة السير، كل سائق تسبب في حادثة سير أو كان طرفًا فيها، ولم يتوقف وحاول التملص من المسؤولية الجنائية أو المدنية، يُعاقب بالحبس من شهر إلى ستة أشهر وبغرامة من 2.000 إلى 10.000 درهم، أو بإحدى هاتين العقوبتين فقط. وتضاعف هذه العقوبة إذا نتج عن الحادثة قتل غير عمدي أو جروح. كما يترتب على هذه الجنحة خصم 3 نقاط من رخصة السياقة.' },
  ],
  ...
  faq_ar: [
    { q: 'اشتريت سلعة عبر الإنترنت لكني غيرت رأيي. هل يمكنني إرجاعها واسترداد أموالي؟', a: 'نعم، يمنحك القانون رقم 31.08 القاضي بتحديد تدابير لحماية المستهلك الحق في التراجع عن الشراء. يمكنك ممارسة هذا الحق داخل أجل سبعة (7) أيام كاملة من تاريخ تسلم المنتج، دون الحاجة إلى تبرير قرارك أو دفع أي غرامات. إذا لم يقم المورد بإعلامك بحقك في التراجع، يتم تمديد هذا الأجل إلى ثلاثين (30) يوماً. لممارسة هذا الحق، يجب عليك إرجاع المنتج للمورد على نفقتك. ويجب على المورد أن يرد لك المبلغ المدفوع كاملاً في أجل أقصاه خمسة عشر (15) يوماً من تاريخ ممارسة حق التراجع. تجدر الإشارة إلى أن هذا الحق لا يسري على بعض المنتجات والخدمات المحددة قانوناً، مثل السلع سريعة التلف أو المنتجات المصنعة حسب مواصفات خاصة بك. (المواد 36، 37 و 40 من القانون 31.08).' },
    { q: 'اكتشفت عيباً في جهاز اشتريته حديثاً يجعله غير صالح للاستعمال المقصود منه. ما هي حقوقي تجاه البائع؟', a: 'أنت محمي بموجب "الضمان القانوني للعيوب الخفية" المنصوص عليه في قانون الالتزامات والعقود، والذي عززه القانون 31.08. إذا كان العيب خفياً (غير ظاهر عند الشراء) وقديماً (موجوداً قبل البيع) وجوهرياً (يُنقص من قيمة الشيء أو يجعله غير صالح للاستعمال)، يحق لك إما رد المنتج واسترجاع ثمنه كاملاً، أو الاحتفاظ به مع استرجاع جزء من الثمن يتناسب مع حجم العيب. يجب رفع دعوى الضمان في أجل لا يتعدى 365 يوماً بعد التسليم، باستثناء الحالات التي يلتزم فيها البائع بضمان أطول. (المواد 549 وما يليها من قانون الالتزامات والعقود والمادة 65 من القانون 31.08).' },
    { q: 'وقعت على عقد مع شركة خدمات، وأعتقد أن أحد البنود يمنح الشركة حقوقاً مفرطة على حسابي. هل هذا البند قانوني؟', a: 'لا، البنود التي تخلق اختلالاً كبيراً بين حقوق وواجبات الطرفين على حساب المستهلك تعتبر "شروطاً تعسفية" وهي باطلة ولاغية بقوة القانون. يعتبر الشرط تعسفياً، على سبيل المثال، إذا كان يمنح المورد الحق في تعديل خصائص المنتج أو الخدمة من جانب واحد دون سبب وجيه، أو إذا كان يُلغي حق المستهلك في الحصول على تعويض في حال إخلال المورد بالتزاماته. حتى لو وقعت على العقد، فإن هذه الشروط تعتبر كأن لم تكن ولا يمكن للمورد الاحتجاج بها ضدك. (المواد 15 إلى 19 من القانون 31.08).' },
    { q: 'ماذا أفعل إذا تعرضت لإشهار كاذب دفعني لشراء منتج لا يتطابق مع المواصفات المعلن عنها؟', a: 'الإشهار الكاذب أو المضلل هو كل إعلان يتضمن ادعاءات أو بيانات غير صحيحة حول طبيعة المنتج، أو كميته، أو مميزاته الأساسية، أو سعره، أو مصدره. يمنع القانون 31.08 هذا النوع من الممارسات التجارية منعاً باتاً. في هذه الحالة، يمكنك تقديم شكاية لدى المصالح المختصة التابعة لوزارة الصناعة والتجارة أو لدى إحدى جمعيات حماية المستهلك المعتمدة. كما يمكنك اللجوء إلى القضاء للمطالبة بإبطال العقد والتعويض عن الضرر الذي لحق بك. ويعاقب القانون المورد الذي يقوم بإشهار مضلل بغرامات مالية وقد تصل العقوبة إلى الحبس. (المادة 21 من القانون 31.08).' },
    { q: 'إلى من ألجأ في حال انتهاك حقوقي كمستهلك، وما هي المسطرة التي يجب اتباعها؟', a: 'في البداية، يُنصح بمحاولة إيجاد حل ودي مباشرة مع المورد (البائع أو مقدم الخدمة). إذا فشلت هذه المحاولة، يمكنك اتباع الخطوات التالية: 1. اللجوء إلى جمعيات حماية المستهلك: يمكن لهذه الجمعيات المعترف بها قانونياً أن تقدم لك الاستشارة والمساعدة وأن تتوسط بينك وبين المورد. 2. تقديم شكاية إدارية: يمكنك تقديم شكاية عبر البوابة الوطنية لشكايات المستهلك (khidmat-almostahlik.ma) أو مباشرة لدى المصالح الإقليمية لوزارة الصناعة والتجارة، والتي يمكنها إجراء بحث وتحرير محاضر بالمخالفات. 3. اللجوء إلى القضاء: إذا لم تؤد الخطوات السابقة إلى نتيجة، يبقى لك الحق في رفع دعوى قضائية أمام المحكمة المختصة للمطالبة بحقوقك والحصول على تعويض عن الأضرار. (المواد 136 وما يليها من القانون 31.08).' },
  ],
  ...
  sections_ar: [
    {
      h2: 'طلب العروض: الأسلوب المبدئي لإبرام الصفقات العمومية',
      content: 'يُعَدُّ طلب العروض، بموجب المرسوم رقم 2-22-431، الأسلوب المبدئي والقاعدة العامة لإبرام الصفقات العمومية. يضمن هذا الأسلوب أوسع منافسة ممكنة بين المتنافسين ويقوم على مبادئ الشفافية والمساواة في التعامل معهم.',
      bullets: [
        'طلب العروض المفتوح كأصل عام: يعتبر طلب العروض المفتوح هو القاعدة، حيث يمكن لكل متنافس مؤهل أن يقدم عرضًا. يفرض الفصل 22 من المرسوم نشر إعلان الصفقة في بوابة الصفقات العمومية (www.marchespublics.gov.ma) وفي جريدتين على الأقل، لضمان أقصى درجات الإشهار والمنافسة.',
        'حالات طلب العروض المحدود: يُلجأ إلى طلب العروض المحدود بشكل استثنائي وفقًا للمادة 20 من المرسوم، خاصة في الأعمال التي تتطلب خبرات أو إمكانيات تقنية عالية لا تتوفر إلا لدى عدد محدود من المقاولين أو الموردين. في هذه الحالة، يقوم صاحب المشروع باستشارة ثلاثة متنافسين على الأقل، بعد موافقة السلطة المختصة على لائحتهم.',
        'إلزامية الإيداع الإلكتروني للعروض: أقر المرسوم الجديد إلزامية إيداع عروض المتنافسين وسحب ملفات الاستشارة بطريقة إلكترونية حصرًا عبر بوابة الصفقات العمومية. يهدف هذا الإجراء، المنصوص عليه في المادة 30، إلى تجريد المساطر من الطابع المادي، وتعزيز الشفافية، وتسهيل مشاركة المتنافسين.',
        'مسطرة فتح الأظرفة وتقييم العروض: تتم عملية فتح الأظرفة في جلسة عمومية من طرف لجنة طلب العروض. يتم تقييم العروض على مرحلتين وفقًا للمادتين 40 و 41: فحص الملفين الإداري والتقني أولاً، ثم دراسة العرض المالي للمتنافسين المقبولين في المرحلة الأولى فقط.',
        'معايير إسناد الصفقة: تُسند الصفقة للمتنافس صاحب "العرض الأفضل اقتصاديا"، وليس بالضرورة صاحب العرض المالي الأقل ثمناً. وفقًا للمادة 42، يمكن أن يشمل هذا المعيار، بالإضافة إلى الثمن، الجودة التقنية، والقيمة الوظيفية، ومدة التنفيذ أو التسليم، مما يمنح صاحب المشروع مرونة أكبر لاختيار العرض الذي يحقق أفضل قيمة مقابل المال.',
      ],
    },
    {
      h2: 'الصفقة التفاوضية: أسلوب استثنائي ومقيد',
      content: 'تمثل الصفقة التفاوضية استثناءً صريحًا من مبدأ المنافسة المفتوحة، حيث يسمح لصاحب المشروع بإجراء مفاوضات حول شروط الصفقة مع متنافس واحد أو أكثر. وقد حصر المرسوم رقم 2-22-431 حالات اللجوء إليها بشكل دقيق لتفادي أي تعسف في استعمالها.',
      bullets: [
        'الحالات الحصرية للجوء إلى التفاوض: تحدد المادة 21 من المرسوم على سبيل الحصر الحالات التي يمكن فيها إبرام صفقة تفاوضية. تشمل هذه الحالات الأعمال التي لا يمكن تنفيذها إلا من قبل فاعل اقتصادي وحيد (احتكار، براءة اختراع)، وحالة الاستعجال القصوى الناتجة عن ظروف غير متوقعة، ومتطلبات الدفاع أو الأمن العام، أو عندما تكون جميع العروض المقدمة في مسطرة سابقة غير مقبولة.',
        'إلزامية الشهادة الإدارية المبررة: يجب على صاحب المشروع، قبل الشروع في المسطرة التفاوضية، إعداد شهادة إدارية مفصلة. توضح هذه الشهادة الأسباب الواقعية والقانونية التي تبرر اللجوء إلى هذا الأسلوب الاستثنائي، وتعتبر وثيقة أساسية للرقابة القبلية والبعدية.',
        'أنواع الصفقات التفاوضية: يميز المرسوم بين الصفقة التفاوضية بإشهار مسبق ومنافسة، والصفقة التفاوضية بدون إشهار مسبق وبدون منافسة. تُستخدم الأولى عندما تسمح الظروف باستشارة عدة متنافسين، بينما تقتصر الثانية على الحالات الأكثر تقييدًا كحالة الاحتكار المطلق أو الاستعجال القصوى.',
        'شفافية ما بعد الإبرام: رغم الطابع التفاوضي للمسطرة، تفرض المادة 160 من المرسوم على صاحب المشروع نشر مستخرج من الصفقة المبرمة في بوابة الصفقات العمومية. يجب أن يتضمن هذا المستخرج اسم نائل الصفقة، وموضوعها، ومبلغها، وذلك في أجل لا يتعدى خمسة عشر (15) يوما من تبليغها، لضمان حد أدنى من الشفافية.',
        'محتوى التفاوض: يمكن أن يشمل التفاوض جميع مكونات الصفقة، بما في ذلك الثمن، ومواصفات الأداء، وآجال التنفيذ، وشروط الضمان. يجب على صاحب المشروع توثيق جميع مراحل التفاوض في محضر رسمي يوقعه الطرفان لضمان إثبات الاتفاقات التي تم التوصل إليها.',
      ],
    },
    {
      h2: 'الأساليب الخاصة: المباراة وأمر بالشراء',
      content: 'بالإضافة إلى طلب العروض والصفقة التفاوضية، نظم المرسوم أسلوبين خاصين لتلبية احتياجات محددة للإدارة: المباراة، التي تستهدف الجانب الإبداعي والفني، وأمر بالشراء، المخصص للأعمال المتكررة ذات الطبيعة التوقعية.',
      bullets: [
        'المباراة لأعمال التصميم والإبداع: تُستخدم المباراة، وفقًا للمادة 23 من المرسوم، في الحالات التي تبررها اعتبارات فنية أو جمالية أو تقنية خاصة، كما هو الشأن في مجال التعمير والهندسة المعمارية. الهدف هو اختيار تصميم أو مشروع من بين عدة مقترحات مجهولة الهوية تقدمها لجنة المباراة للتقييم.',
        'لجنة المباراة وجوائز المشاريع: يتم تقييم المشاريع المقدمة من قبل لجنة مباراة تضم بالضرورة مهنيين مؤهلين في المجال المعني. يمكن للجنة أن تقترح منح جوائز أو علاوات لأفضل المشاريع المصنفة، حتى لو لم يتم إبرام صفقة تنفيذ مع أصحابها. يمكن لصاحب المشروع بعد ذلك إبرام صفقة تفاوضية مع الفائز بالمباراة لتنفيذ المشروع.',
        'أمر بالشراء للأعمال المتكررة: يُلجأ إلى هذا الأسلوب، المنظم بموجب المادة 24، لاقتناء توريدات أو إنجاز خدمات ذات طابع متكرر وقابل للتوقع، والتي لا يمكن تحديد كمياتها أو وتيرة تنفيذها بدقة مسبقًا. يتم إبرام صفقة إطار تحدد هوية الموردين وأثمان الوحدات، ثم تصدر أوامر الشراء عند الحاجة.',
        'السقوف المالية لأمر بالشراء: لا يمكن أن يتجاوز المبلغ الإجمالي التقديري للأعمال موضوع أمر بالشراء سقفًا ماليًا يحدد بقرار لرئيس الحكومة. وتخضع مسطرة إبرام الصفقة الإطار نفسها لمبادئ المنافسة عبر طلب عروض لضمان اختيار أفضل عرض.',
        'آلية التنفيذ عبر أوامر جزئية: بعد إبرام الصفقة الإطار، يقوم صاحب المشروع بإصدار أوامر بالشراء كلما دعت الحاجة، دون الحاجة إلى إعادة طرح المنافسة في كل مرة. يجب أن تحدد هذه الأوامر الكميات المطلوبة وآجال التسليم، مع الالتزام بالأسعار والشروط المحددة في الصفقة الإطار الأصلية.',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي الأساليب الرئيسية التي تعتمدها الإدارة لإبرام صفقاتها العمومية؟', a: 'وفقاً للمادة 19 من المرسوم رقم 2.22.431 المتعلق بالصفقات العمومية، فإن الأساليب الرئيسية لإبرام الصفقات هي: 1. طلب العروض: وهو القاعدة العامة، ويكون إما مفتوحاً أو محدوداً. 2. المسابقة: وتتعلق أساساً بالمشاريع ذات الطابع الفني أو الجمالي، كالمجال المعماري والتعمير. 3. الصفقة التفاوضية: وهي إجراء استثنائي يتم اللجوء إليه في حالات محددة حصراً في القانون، كحالة الاستعجال القصوى أو لأسباب تقنية.' },
    { q: 'ما الفرق الجوهري بين طلب العروض المفتوح وطلب العروض المحدود؟', a: 'الفرق الأساسي يكمن في طبيعة المتنافسين المدعوين للمشاركة. - طلب العروض المفتوح: كما هو معرف في المادة 37 من مرسوم الصفقات العمومية، هو الإجراء الذي يُمكِّن كل مترشح مؤهل من تقديم عرضه. إنه يجسد مبدأ حرية الوصول إلى الطلبيات العمومية. - طلب العروض المحدود: حسب المادة 38 من نفس المرسوم، هو الإجراء الذي لا يُسمح فيه بتقديم العروض إلا للمترشحين الذين قرر صاحب المشروع استشارتهم مسبقاً، وذلك بعد إجراء انتقاء أولي. يتم اللجوء إليه عندما تكون الأعمال موضوع الصفقة تتطلب خبرات خاصة.' },
    { q: 'هل يمكن للإدارة إبرام صفقة بشكل مباشر مع مقاول أو مورد دون اللجوء إلى المنافسة؟', a: 'نعم، يمكن ذلك استثناءً عبر آلية "الصفقة التفاوضية". المادة 103 من مرسوم الصفقات العمومية تحدد الحالات التي يجوز فيها اللجوء إلى هذا الأسلوب، ومنها: - الأعمال التي لا يمكن تنفيذها إلا من طرف فاعل اقتصادي وحيد (احتكار). - حالة الاستعجال القصوى الناتجة عن ظروف غير متوقعة لا تسمح بالتقيد بآجال طلب العروض. - عندما لا يتم تقديم أي عرض أو يتم تقديم عروض غير مقبولة بعد إجراء طلب عروض. - الصفقات التي تعلن الإدارة أنها سرية أو يتطلب تنفيذها تدابير أمنية خاصة.' },
    { q: 'بصفتي صاحب مقاولة صغيرة جداً أو متوسطة، هل هناك إجراءات خاصة تشجع مشاركتي في الصفقات العمومية؟', a: 'نعم، أولى المشرع المغربي أهمية خاصة للمقاولات الصغيرة والمتوسطة. تنص المادة 155 من مرسوم الصفقات العمومية على تخصيص نسبة من المبلغ المتوقع للصفقات التي يبرمها صاحب المشروع خلال السنة المالية لفائدة المقاول الذاتي والمقاولة الصغيرة والمتوسطة والتعاونية واتحاد التعاونيات. كما يمكن أن تستفيد هذه الفئات من أفضلية في تقييم عروضها المالية، مما يعزز قدرتها التنافسية.' },
    { q: 'تم إقصاء عرضي في إحدى الصفقات. ما هي سبل الطعن المتاحة لي قانونياً؟', a: 'يضمن القانون للمتنافسين الذين تم إقصاؤهم الحق في الطعن. وفقاً للمادة 169 من مرسوم الصفقات العمومية، يمكنك سلوك المسارين التاليين: 1. الشكاية الإدارية: يمكنك تقديم شكاية إلى صاحب المشروع (الإدارة المعنية) الذي يبت فيها خلال خمسة أيام. إذا لم تقتنع بالجواب، يمكنك رفع الشكاية إلى "لجنة الصفقات" وهي هيئة استشارية لدى الأمانة العامة للحكومة. 2. الطعن القضائي: بغض النظر عن الشكاية الإدارية، يحق لك دائماً اللجوء إلى القضاء الإداري (المحكمة الإدارية) للطعن في قرار الإقصاء، والمطالبة بإلغائه أو طلب التعويض عن الضرر إذا ثبت وجود تعسف أو خرق للقانون من طرف الإدارة.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'أوامر الخدمة وسير التنفيذ',
      content: 'تمثل أوامر الخدمة الأداة الإدارية الأساسية التي يستخدمها صاحب المشروع لتوجيه ومراقبة تنفيذ الصفقة. طبقا للمادة 95 من المرسوم رقم 2.22.431، فإن هذه الأوامر ملزمة لصاحب الصفقة، وتحدد بشكل دقيق بداية الأشغال، أو توقفها، أو استئنافها، وأي تغييرات تطرأ على حجم أو طبيعة الخدمات.',
      bullets: [
        'يتم تبليغ أمر الخدمة الأول، الذي يحدد تاريخ بدء التنفيذ، إلى صاحب الصفقة عبر بوابة الصفقات العمومية أو بأي وسيلة أخرى تضمن إثبات التوصل. ويعتبر هذا التاريخ هو نقطة الانطلاق الرسمية لاحتساب آجال التنفيذ التعاقدية.',
        'في حالة عدم تبليغ أمر الخدمة ببدء التنفيذ خلال الأجل المحدد في دفتر الشروط الخاصة، يحق لصاحب الصفقة إعذار صاحب المشروع، وإذا لم يتم التبليغ خلال ثلاثين (30) يوما من تاريخ الإعذار، يمكنه طلب فسخ الصفقة مع حقه في التعويض.',
        'يمكن لصاحب المشروع إصدار أوامر بإيقاف الأشغال لأسباب تتعلق بالمصلحة العامة أو لظروف قاهرة. يترتب على هذا الإيقاف تمديد أجل الصفقة لمدة مساوية لمدة التوقف، شريطة ألا يكون التوقف ناتجا عن خطأ من صاحب الصفقة.',
        'إذا تضمن أمر الخدمة تعليمات يرى صاحب الصفقة أنها تخالف بنود الصفقة أو النصوص التنظيمية الجاري بها العمل، يتوجب عليه تقديم تحفظاته كتابيا ومعللة إلى صاحب المشروع في أجل أقصاه خمسة عشر (15) يوما من تاريخ التبليغ، وإلا اعتبر موافقا عليها.',
        'تُحرر أوامر الخدمة التي لها تأثير مالي، كتلك المتعلقة بتغيير حجم الأشغال أو طبيعتها، في نظيرين أصليين ويتم توقيعها من الطرفين، حيث يحتفظ كل طرف بنسخة، وذلك لضمان الشفافية وتجنب النزاعات المحتملة عند التسوية المالية النهائية.',
      ],
    },
    {
      h2: 'غرامات التأخير ومراجعة الأثمان',
      content: 'يُعد احترام الآجال التعاقدية عنصرا جوهريا في تنفيذ الصفقات العمومية، ويترتب على كل تأخير تطبيق غرامات مالية. وبالمقابل، يضمن نظام مراجعة الأثمان حماية التوازن المالي للعقد من تقلبات الظروف الاقتصادية، وذلك وفقا لمقتضيات المواد 98 و99 من مرسوم الصفقات العمومية.',
      bullets: [
        'تُطبق غرامات التأخير تلقائيا بمجرد معاينة التأخير في إنجاز الخدمات مقارنة بالآجال التعاقدية. يتم احتسابها بتطبيق صيغة محددة في دفتر الشروط الخاصة، على ألا يتجاوز مبلغها الإجمالي عشرة في المائة (10%) من المبلغ الأصلي للصفقة، مع إمكانية رفعه إلى عشرين في المائة (20%) في حالات استثنائية مبررة.',
        'يمكن إعفاء صاحب الصفقة من غرامات التأخير إذا أثبت أن التأخير ناتج عن حالة قوة قاهرة أو بسبب يعزى مباشرة إلى صاحب المشروع (كتأخر تبليغ أمر خدمة أو تقديم بيانات ضرورية). ويجب على صاحب الصفقة تقديم طلب معلل وموثق في هذا الشأن خلال أجل محدد بعد وقوع الحدث المسبب للتأخير.',
        'تعتبر مراجعة الأثمان إلزامية في الصفقات التي تتجاوز مدة تنفيذها ستة (6) أشهر. تتم المراجعة بتطبيق صيغة حسابية منصوص عليها في دفتر الشروط الخاصة، تعتمد على مؤشرات اقتصادية رسمية تعكس تطور تكاليف المواد واليد العاملة.',
        'إذا كانت الصفقة ذات ثمن نهائي وغير قابل للمراجعة، فإن هذا الشرط يجب أن يكون منصوصا عليه صراحة في وثائق الصفقة. في هذه الحالة، يتحمل صاحب الصفقة مخاطر التقلبات الاقتصادية، ولا يحق له المطالبة بأي تعويض عن ارتفاع الأسعار.',
        'يتم تصفية المبالغ الناتجة عن مراجعة الأثمان بشكل دوري مع الدفعات على الحساب، ويمكن أن تكون هذه التصفية مؤقتة. لا تتم التسوية النهائية لمراجعة الأثمان إلا بعد توفر جميع المؤشرات النهائية اللازمة للحساب.',
        'في حالة التأخير في التنفيذ، لا يستفيد صاحب الصفقة من مراجعة الأثمان خلال فترة التأخير إلا إذا كانت المؤشرات الاقتصادية في غير صالحه. أما إذا كانت في صالحه، فتطبق المؤشرات السارية في آخر يوم من الأجل التعاقدي.',
      ],
    },
    {
      h2: 'الاستلام (المؤقت والنهائي) والمقاولة من الباطن',
      content: 'يمثل الاستلام الإجراء الذي يقر بموجبه صاحب المشروع بأن الخدمات المنجزة مطابقة للمواصفات التعاقدية، ويمر عبر مرحلتين أساسيتين: الاستلام المؤقت ثم النهائي. كما ينظم القانون بدقة شروط اللجوء إلى المقاولة من الباطن (المناولة) لضمان جودة التنفيذ وحماية حقوق جميع الأطراف.',
      bullets: [
        'يتم الاستلام المؤقت، المنصوص عليه في المادة 102 من المرسوم، بعد انتهاء الأشغال بناء على طلب من صاحب الصفقة. تقوم لجنة مختصة بمعاينة الأشغال وتحرير محضر إما بالقبول دون تحفظ، أو بالقبول مع تحفظات يجب على المقاول رفعها، أو بالرفض مع تحديد الأسباب.',
        'يُعتبر تاريخ محضر الاستلام المؤقت هو نقطة انطلاق فترة الضمان، التي تمتد عادة لسنة واحدة. خلال هذه الفترة، يظل صاحب الصفقة مسؤولا عن أي عيوب أو نواقص تظهر في الأشغال، ويلتزم بإصلاحها على نفقته.',
        'يجرى الاستلام النهائي عند انقضاء فترة الضمان، طبقا للمادة 104 من المرسوم. تتحقق اللجنة من أن صاحب الصفقة قد أوفى بجميع التزاماته، بما في ذلك رفع التحفظات المسجلة عند الاستلام المؤقت. يترتب على محضر الاستلام النهائي الإبراء النهائي لصاحب الصفقة وتحرير الضمانة النهائية.',
        'لا يمكن لصاحب الصفقة اللجوء إلى المقاولة من الباطن (المناولة) إلا بعد الحصول على ترخيص كتابي مسبق من صاحب المشروع، وفقا للمادة 158. ويجب أن يقدم صاحب الصفقة ملفا كاملا عن المقاول من الباطن المقترح لإثبات أهليته وقدراته.',
        'يبقى صاحب الصفقة مسؤولا مسؤولية كاملة وتضامنية تجاه صاحب المشروع عن جميع الخدمات المنجزة، بما في ذلك تلك التي تم إسنادها إلى مقاول من الباطن. لا تنشأ أي علاقة تعاقدية مباشرة بين صاحب المشروع والمقاول من الباطن.',
        'لحماية المقاولين من الباطن، يمكن لصاحب المشروع، بموجب المادة 159، أن يوافق على آلية الدفع المباشر. بموجب هذه الآلية، يقوم صاحب المشروع بدفع مستحقات المقاول من الباطن مباشرة بعد موافقة صاحب الصفقة الرئيسي، مما يضمن له الحصول على مستحقاته في الوقت المناسب.',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي العواقب القانونية المترتبة عن تأخر المقاول في إنجاز الأشغال أو تسليم التوريدات موضوع الصفقة العمومية؟', a: 'في حالة تأخر المقاول عن الالتزام بالآجال التعاقدية، يتم تطبيق غرامات تأخير (pénalités de retard). ووفقاً للمادة 60 من المرسوم رقم 2-12-349 المتعلق بالصفقات العمومية، تُحتسب هذه الغرامات عن كل يوم تأخير. يتم تحديد نسبتها في دفتر الشروط الخاصة (CPS)، ولا يمكن أن يتجاوز مجموعها 10% من مبلغ الصفقة الأصلي. إذا بلغ التأخير حداً معيناً أو تجاوزت الغرامات السقف المذكور، يمكن لصاحب المشروع (الإدارة) فسخ الصفقة من جانب واحد على نفقة ومسؤولية المقاول.' },
    { q: 'ما هي الآجال المحددة لأداء مستحقات المقاول، وماذا يحدث إذا تأخرت الإدارة في صرفها؟', a: 'يجب على صاحب المشروع (الإدارة) الأمر بأداء المبالغ المستحقة للمقاول داخل أجل أقصاه تسعون (90) يوماً، ابتداءً من تاريخ استلام كشوف الحسابات أو الفواتير. حسب المادة 92 من مرسوم الصفقات العمومية، إذا تجاوزت الإدارة هذا الأجل، يحق للمقاول الحصول على فوائد تأخيرية (intérêts moratoires) تُحتسب على المبالغ غير المؤداة، وذلك دون الحاجة إلى تقديم طلب مسبق. يتم تحديد سعر هذه الفوائد بقرار لوزير الاقتصاد والمالية.' },
    { q: 'هل يحق للإدارة (صاحب المشروع) إدخال تغييرات على حجم أو طبيعة الخدمات المتعاقد عليها أثناء تنفيذ الصفقة؟', a: 'نعم، يمكن لصاحب المشروع إدخال تغييرات على الصفقة أثناء تنفيذها، ولكن ضمن حدود وشروط صارمة. تتم هذه التغييرات عبر إبرام "ملحق" (avenant) للصفقة الأصلية. وفقاً للمادة 55 من مرسوم الصفقات العمومية، لا يجب أن يتجاوز المبلغ الإجمالي للتغييرات نسبة 10% من المبلغ الأصلي للصفقة. كما لا يجوز أن تغير هذه التعديلات موضوع الصفقة أو طبيعتها بشكل جوهري. وفي حالة رفض المقاول للتغييرات المقترحة، يمكن اللجوء إلى إجراءات الفسخ.' },
    { q: 'ما هي أنواع الضمانات المالية المطلوبة في الصفقات العمومية، ومتى يتم استرجاعها؟', a: 'يُلزم المقاول بتقديم ضمانتين أساسيتين: 1.  الضمان النهائي (Cautionnement définitif): تحدد قيمته في 3% من المبلغ الأصلي للصفقة، ويهدف إلى ضمان حسن تنفيذ جميع التزامات المقاول. يتم استرجاع هذا الضمان بعد التسلم النهائي (réception définitive) للأشغال أو الخدمات، وذلك وفقاً للمادة 16 من مرسوم الصفقات العمومية. 2.  الاقتطاع الضامن (Retenue de garantie): يتم اقتطاع نسبة 7% من كل دفعة (أو كشف حساب) يتم صرفها للمقاول. يهدف هذا الاقتطاع إلى تغطية العيوب التي قد تظهر خلال فترة الضمان. يتم استرجاع هذا المبلغ بعد انقضاء أجل الضمان والتسلم النهائي. يمكن للمقاول استبدال هذا الاقتطاع بضمانة بنكية (caution personnelle et solidaire) بنفس القيمة، وذلك حسب المادة 59 من نفس المرسوم.' },
    { q: 'في حالة نشوب خلاف بين المقاول والإدارة حول تنفيذ الصفقة، ما هي مسطرة حل النزاع؟', a: 'يجب أولاً محاولة حل النزاع بطريقة حبية بين الطرفين. إذا فشلت التسوية الودية، يتم اللجوء إلى القضاء. وفقاً للمادة 158 من مرسوم الصفقات العمومية، تختص المحاكم الإدارية بالنظر في النزاعات المتعلقة بإبرام وتنفيذ الصفقات العمومية. يجب على الطرف الذي يرغب في رفع دعوى قضائية أن يقدم أولاً مذكرة تفصيلية بمطالبه إلى الطرف الآخر. وفي حالة عدم التوصل إلى حل خلال شهرين، يمكنه رفع القضية أمام المحكمة الإدارية المختصة.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الرقابة القبلية على إبرام الصفقات العمومية',
      content: 'تهدف آليات الرقابة القبلية إلى ضمان مشروعية وشفافية مساطر إبرام الصفقات العمومية قبل دخولها حيز التنفيذ والمصادقة عليها. وتتوزع هذه الرقابة بين أجهزة داخلية تابعة لصاحب المشروع وأجهزة خارجية متخصصة كاللجان الوزارية والخزينة العامة للمملكة.',
      bullets: [
        'لجنة فتح الأظرفة: تتولى هذه اللجنة، المشكلة بموجب المادة 39 من المرسوم رقم 2-12-349 المتعلق بالصفقات العمومية، التحقق من أهلية المتنافسين وفحص مطابقة ملفاتهم الإدارية والتقنية والمالية لمقتضيات دفتر الشروط الخاصة. وتقوم بإقصاء أي متنافس لا يستوفي الشروط المطلوبة، وتُحرر محضراً مفصلاً بأعمالها.',
        'لجنة تقييم العروض: بعد فتح الأظرفة، تقوم لجنة التقييم (التي يمكن أن تكون هي نفسها لجنة الفتح) بدراسة العروض التقنية والمالية للمتنافسين المقبولين، وترتيبهم استناداً إلى معايير الاختيار المحددة في نظام الاستشارة، واقتراح المتنافس الذي قدم العرض الأفضل على صاحب المشروع.',
        'لجنة الصفقات: بالنسبة للصفقات التي تفوق مبالغها حدوداً معينة (مثلاً 20 مليون درهم للأشغال)، تُعرض وجوباً على "لجنة الصفقات" المختصة قبل المصادقة عليها. وتقدم هذه اللجنة، المنظمة بموجب المادة 157 من مرسوم الصفقات العمومية، رأياً استشارياً حول تقرير إنجاز المسطرة، ويمكنها طلب أي توضيح أو وثيقة إضافية قبل إبداء رأيها.',
        'تأشيرة مراقبي الالتزام بالنفقات: تخضع صفقات الدولة التي يتجاوز مبلغها التقديري خمسة ملايين درهم (5.000.000 درهم) لتأشيرة مراقبي الالتزام بالنفقات التابعين للخزينة العامة للمملكة. وتهدف هذه التأشيرة، المنصوص عليها في المادة 154 من المرسوم رقم 2-12-349، إلى التحقق من توفر الاعتمادات المالية ومشروعية النفقة المقترحة قبل أي التزام مالي للدولة.',
        'مصادقة السلطة المختصة: بعد استيفاء جميع مراحل الرقابة القبلية والحصول على الآراء والتأشيرات اللازمة، تتخذ السلطة المختصة (الآمر بالصرف) قرار المصادقة على الصفقة، وهو الإجراء الذي يمنحها طابعها التنفيذي ويسمح بتبليغها لصاحب الصفقة لبدء التنفيذ.',
      ],
    },
    {
      h2: 'الرقابة البعدية للمجلس الأعلى للحسابات والمجالس الجهوية للحسابات',
      content: 'بعد إبرام الصفقات ودخولها طور التنفيذ، تتولى المحاكم المالية، وعلى رأسها المجلس الأعلى للحسابات، ممارسة رقابة بعدية شاملة. تهدف هذه الرقابة إلى التحقق من سلامة تدبير الأموال العمومية المرصودة للصفقات وتقييم أدائها من حيث الفعالية والنجاعة والاقتصاد.',
      bullets: [
        'تدقيق تسيير الصفقات: بموجب القانون رقم 62.99 المتعلق بمدونة المحاكم المالية، يقوم قضاة المجلس بفحص كيفية تنفيذ الصفقات العمومية. ويشمل التدقيق تقييم مدى احترام القواعد المسطرية، وتحقيق أهداف النجاعة والفعالية والاقتصاد في استعمال الموارد العمومية.',
        'القضاء في الحسابات: يمارس المجلس اختصاصاً قضائياً في فحص حسابات المحاسبين العموميين الذين يؤدون نفقات الصفقات. وفي حالة اكتشاف عجز أو نفقة غير مبررة، يمكن للمجلس أن يُلزم المحاسب المعني بالمسؤولية الشخصية والمالية وإرجاع المبالغ المصروفة بغير حق.',
        'التأديب المتعلق بالميزانية والشؤون المالية: يمكن للمجلس الأعلى للحسابات، في إطار هذه المسطرة، متابعة الآمرين بالصرف وكل مسؤول ثبتت مسؤوليته عن ارتكاب مخالفات مالية أثناء تنفيذ الصفقات. وتشمل هذه المخالفات، حسب المادة 54 من القانون 62.99، مخالفة قواعد الالتزام بالنفقات أو إعطاء امتياز غير مبرر للغير، وقد تصل العقوبات إلى غرامات مالية مهمة.',
        'الإحالة على القضاء الجنائي: إذا كشفت تحريات المجلس عن أفعال قد تكتسي طابعاً جنائياً (مثل الرشوة، أو اختلاس الأموال العمومية، أو الغدر)، فإن الوكيل العام للملك لدى المجلس الأعلى للحسابات ملزم بإحالة الملف على النيابة العامة المختصة لدى المحاكم العادية لاتخاذ الإجراءات الزجرية اللازمة.',
        'نشر التقارير الرقابية: يعتمد المجلس الأعلى للحسابات مبدأ الشفافية عبر نشر تقريره السنوي وتقاريره الموضوعاتية التي تتضمن خلاصات وملاحظات وتوصيات حول تدبير الصفقات العمومية، مما يساهم في تعزيز الحكامة الجيدة والمساءلة العمومية.',
      ],
    },
    {
      h2: 'مسالك الطعن والنزاعات القضائية والإدارية',
      content: 'يضمن القانون المغربي للمتنافسين الذين يعتبرون أنفسهم متضررين من إجراءات إبرام صفقة عمومية، مجموعة من مسالك الطعن الإدارية والقضائية للدفاع عن حقوقهم. تتدرج هذه المساطر من الشكاية الإدارية البسيطة إلى التقاضي أمام المحاكم الإدارية.',
      bullets: [
        'الشكاية الإدارية لدى صاحب المشروع: كإجراء أولي، يمكن لكل متنافس تم إقصاؤه أن يتقدم بشكاية كتابية إلى صاحب المشروع. يجب إيداع هذه الشكاية، وفقاً للمادة 169 من المرسوم رقم 2-12-349، داخل أجل خمسة (5) أيام عمل من تاريخ تبليغه بقرار الإقصاء، وعلى صاحب المشروع الرد عليها في أجل أقصاه خمسة (5) أيام عمل.',
        'الطعن أمام لجنة الصفقات: في حالة عدم رد صاحب المشروع أو إذا كان الرد غير مقنع، يمكن للمتنافس رفع شكايته إلى الوزير المعني الذي يعرضها على "لجنة الصفقات". تقوم اللجنة، بموجب المادة 170 من مرسوم الصفقات، بدراسة الشكاية وتقديم اقتراح للوزير في أجل لا يتعدى خمسة عشر (15) يوماً. ويجب على الوزير البت في الشكاية وإخبار المشتكي بقراره قبل تاريخ فتح الأظرفة المالية.',
        'دعوى الإلغاء لتجاوز السلطة: يعتبر الطعن بالإلغاء أمام المحكمة الإدارية المسطرة القضائية الرئيسية للطعن في قرار إسناد الصفقة أو أي قرار إداري آخر مرتبط بالمسطرة. وتهدف هذه الدعوى، المنظمة بموجب القانون رقم 41.90 المحدث للمحاكم الإدارية، إلى إلغاء القرار المشوب بعيب في المشروعية (مخالفة القانون، عيب الشكل، الانحراف في استعمال السلطة).',
        'الطعن الاستعجالي لوقف التنفيذ: يمكن للمتنافس، في حالة الاستعجال القصوى ولتفادي ضرر يصعب تداركه، أن يلجأ إلى قاضي المستعجلات الإداري لطلب وقف تنفيذ قرار إسناد الصفقة أو أي إجراء آخر. ويتطلب هذا الطعن إثبات جدية الأسباب التي يستند إليها الطعن في الموضوع (référé précontractuel).',
        'دعوى القضاء الشامل للتعويض: بالإضافة إلى طلب الإلغاء، يمكن للمتنافس المقصى بصفة غير قانونية أن يرفع دعوى القضاء الشامل للمطالبة بالتعويض عن الأضرار التي لحقت به. يمكن أن يشمل التعويض المصاريف التي تكبدها للمشاركة في المنافسة، أو التعويض عن "تفويت فرصة" الفوز بالصفقة، والذي تقدر المحكمة مبلغه بناءً على ظروف كل قضية.',
      ],
    },
  ],
  faq_ar: [
    { q: 'بصفتي متنافسا، ما هي الإجراءات التي يمكنني اتخاذها إذا لاحظت خرقا لقواعد المنافسة أو عيبا في مسطرة إبرام الصفقة قبل توقيع العقد؟', a: 'يمكن لكل متنافس يعتبر نفسه متضررا من خرق لقواعد المنافسة أو عيب في المسطرة أن يتقدم بشكاية لدى صاحب المشروع. وفي حالة عدم رضاه عن الرد، أو في غياب الرد، يمكنه رفع طعن أمام اللجنة الوطنية للطلبيات العمومية. يجب تقديم الشكاية قبل تاريخ فتح الأظرفة إذا كانت تتعلق بوثائق الاستشارة، أو في أجل خمسة (5) أيام من تاريخ تبليغ قرار الإقصاء. هذه المسطرة منظمة بموجب المادة 158 من المرسوم رقم 2.22.431 المتعلق بالصفقات العمومية.' },
    { q: 'فازت شركتي بصفقة عمومية، لكن نشأ نزاع مع الإدارة بخصوص تنفيذ الأشغال أو أداء المستحقات. ما هي المسطرة المتبعة لحل هذا النزاع؟', a: 'المسطرة الأولى لحل النزاعات التنفيذية هي التسوية الحبية (règlement amiable) المنصوص عليها في دفاتر الشروط الإدارية العامة (CCAG). في حالة فشل هذه التسوية، يتم اللجوء إلى القضاء الإداري. يجب رفع دعوى أمام المحكمة الإدارية المختصة ترابيا، والتي تبت في النزاع بناءً على بنود العقد وقواعد القانون الإداري. هذا الاختصاص القضائي مؤسس بموجب القانون رقم 41.90 المحدث للمحاكم الإدارية.' },
    { q: 'تم إقصائي من المنافسة على صفقة عمومية. هل يمكنني الطعن قضائيا في قرار إسناد الصفقة لمتنافس آخر، وما هو الأساس القانوني لذلك؟', a: 'نعم، يمكن للمتنافس الذي تم إقصاؤه أن يطعن في مقرر إسناد الصفقة عن طريق رفع دعوى الإلغاء بسبب الشطط في استعمال السلطة أمام المحكمة الإدارية المختصة. يجب رفع هذه الدعوى داخل أجل ستين (60) يوما من تاريخ تبليغ المقرر المطعون فيه أو نشره. على المدعي أن يثبت أن قرار الإدارة مشوب بأحد العيوب التي تجعله غير مشروع، كخرق القانون أو عيب في الشكل أو الانحراف في السلطة. يستند هذا الطعن إلى المادة 20 من القانون رقم 41.90 المحدث للمحاكم الإدارية.' },
    { q: 'بصفتي متنافسا تم إقصاؤه، كيف يمكنني الاطلاع على تقرير تقييم العروض لفهم أسباب الإقصاء؟', a: 'يكرس مرسوم الصفقات العمومية مبدأ الشفافية. بعد الإعلان عن النتائج، يحق لكل متنافس تم إقصاؤه أن يطلب كتابيا من صاحب المشروع موافاته بأسباب إقصائه، وكذا بخصائص وميزات العرض الذي تم قبوله. صاحب المشروع ملزم بالرد على هذا الطلب في أجل محدد. هذا الحق معزز أيضا بمقتضيات القانون رقم 31.13 المتعلق بالحق في الحصول على المعلومات. تنص المادة 156 من المرسوم رقم 2.22.431 على هذه الإمكانية بشكل صريح.' },
    { q: 'ما هو دور اللجنة الوطنية للطلبيات العمومية، ومتى يمكن اللجوء إليها؟', a: 'اللجنة الوطنية للطلبيات العمومية هي هيئة إدارية مستقلة مكلفة بالنظر في الطعون المقدمة من طرف المتنافسين الذين يعتبرون أنفسهم متضررين من خرق مساطر إبرام الصفقات العمومية. يمكن اللجوء إليها قبل توقيع العقد. تقوم اللجنة بدراسة الطعن ويمكنها إصدار توصيات لصاحب المشروع، قد تصل إلى إلغاء المسطرة. صلاحياتها وإجراءات عملها محددة في المواد من 157 إلى 160 من المرسوم رقم 2.22.431 المتعلق بالصفقات العمومية.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الالتزامات الجوهرية لمسؤول المعالجة بموجب القانون 09-08',
      content: 'يفرض القانون رقم 09-08، الصادر بتنفيذه الظهير الشريف رقم 1.09.15 بتاريخ 18 فبراير 2009، مجموعة من الالتزامات الدقيقة على كل شخص ذاتي أو اعتباري يقوم بتحديد غايات ووسائل معالجة البيانات الشخصية، والذي يُصطلح عليه بـ "مسؤول المعالجة". تهدف هذه الالتزامات إلى ضمان مشروعية المعالجة وحماية حقوق الأفراد.',
      bullets: [
        'الحصول على الموافقة الصريحة: كقاعدة عامة، لا يجوز معالجة أي بيانات شخصية دون الحصول على الموافقة "الصريحة، الواضحة والمسبقة" للشخص المعني، كما تنص على ذلك المادة 4 من القانون. يجب أن تكون هذه الموافقة قابلة للإثبات، ويحق للشخص سحبها في أي وقت.',
        'التصريح المسبق أو طلب الإذن من اللجنة الوطنية (CNDP): قبل البدء في أي عملية معالجة، يجب على مسؤول المعالجة إيداع تصريح لدى اللجنة الوطنية لمراقبة حماية المعطيات ذات الطابع الشخصي. وفي حالات محددة، كمعالجة البيانات الحساسة (الأصل العرقي، الآراء السياسية، المعتقدات الدينية...) أو نقل البيانات إلى الخارج، يتوجب الحصول على إذن مسبق من اللجنة طبقا للمواد 12 و 43 من القانون.',
        'احترام مبدأ الغائية والتناسبية: يجب جمع البيانات لأغراض "محددة، ومعلنة، ومشروعة"، ولا يجوز معالجتها لاحقاً بطريقة تتعارض مع هذه الأغراض. كما يجب أن تكون البيانات "ملائمة، ومناسبة، وغير مفرطة" مقارنة بالغايات التي جُمعت من أجلها، وذلك تطبيقا لمقتضيات المادة 5.',
        'الالتزام بأمن وسرية البيانات: يلزم القانون مسؤول المعالجة باتخاذ كافة "الاحتياطات اللازمة" للحفاظ على أمن البيانات وحمايتها من التلف، أو التغيير، أو الوصول غير المصرح به، خاصة عند نقلها عبر الشبكات. هذا الالتزام بالأمن منصوص عليه في المادة 23.',
        'تحديد مدة الاحتفاظ بالبيانات: لا يجوز الاحتفاظ بالبيانات الشخصية في شكل يسمح بالتعرف على أصحابها لمدة أطول من اللازم لتحقيق الغايات التي جمعت من أجلها. عند انتهاء هذه المدة، يجب حذف البيانات أو إخفاء هويتها (Anonymisation).',
        'إعلام الشخص المعني: يجب على مسؤول المعالجة، عند جمع البيانات مباشرة من الشخص المعني، أن يزوده بمجموعة من المعلومات الإلزامية المنصوص عليها في المادة 5، وتشمل هوية مسؤول المعالجة، غايات المعالجة، والمرسل إليهم المحتملين للبيانات.',
      ],
    },
    {
      h2: 'حقوق الأشخاص الذاتيين على بياناتهم الشخصية',
      content: 'يمنح القانون 09-08 للأشخاص الذاتيين (الأفراد) مجموعة من الحقوق الأساسية التي تمكنهم من ممارسة رقابة فعلية على بياناتهم الشخصية التي تتم معالجتها من قبل الغير. هذه الحقوق قابلة للتنفيذ مباشرة لدى مسؤول المعالجة، وفي حالة عدم الاستجابة، يمكن اللجوء إلى اللجنة الوطنية CNDP.',
      bullets: [
        'حق الولوج (Droit d\'accès): لكل شخص الحق في أن يطلب من مسؤول المعالجة تأكيد ما إذا كانت بياناته الشخصية تعالج أم لا، والحصول على نسخة واضحة من هذه البيانات، بالإضافة إلى معلومات حول مصدرها وغايات المعالجة. يتم ممارسة هذا الحق عبر طلب كتابي، ويجب على المسؤول الرد في أجل معقول، كما هو مفصل في المادة 7.',
        'حق التصحيح (Droit de rectification): إذا كانت البيانات المعالجة غير صحيحة، أو غير كاملة، أو منقوصة، أو متجاوزة، يحق للشخص المعني أن يطلب من مسؤول المعالجة تصحيحها، أو تتميمها، أو تحيينها، أو إغلاقها، أو حذفها. هذا الحق، المنصوص عليه في المادة 8، يضمن دقة وموثوقية المعلومات.',
        'حق التعرض (Droit d\'opposition): يخول القانون للشخص المعني، لأسباب "مشروعة وخاصة بوضعيته"، الحق في التعرض على معالجة بياناته. يصبح هذا الحق مطلقاً وغير مشروط عندما تتم المعالجة لأغراض الاستقراء التجاري (التسويق المباشر)، حيث يمكن ممارسته دون أي تبرير، وذلك وفقا للمادة 9.',
        'الحق في عدم الخضوع لقرار فردي آلي: تنص المادة 10 على أنه لا يمكن اتخاذ أي قرار ينتج آثارا قانونية تجاه شخص ما بناءً على معالجة آلية للبيانات فقط تهدف إلى تقييم بعض جوانب شخصيته (مثل أدائه المهني، أو وضعه المالي). يحق للشخص في هذه الحالة المطالبة بتدخل بشري في عملية اتخاذ القرار.',
        'حق تقديم شكاية إلى اللجنة الوطنية (CNDP): في حالة انتهاك أحد حقوقه أو عدم استجابة مسؤول المعالجة لطلبه في الآجال القانونية، يحق للشخص المعني تقديم شكاية مباشرة إلى اللجنة الوطنية CNDP، التي تملك صلاحية التحقيق وإصدار الأوامر اللازمة لضمان احترام القانون.',
        'الحق في الحصول على تعويض: في حالة وقوع ضرر مادي أو معنوي ناتج عن معالجة غير مشروعة للبيانات الشخصية، يحق للشخص المتضرر اللجوء إلى القضاء للمطالبة بالتعويض عن الضرر الذي لحقه، وذلك طبقا للقواعد العامة للمسؤولية المدنية المنصوص عليها في قانون الالتزامات والعقود.',
      ],
    },
    {
      h2: 'آليات الامتثال والرقابة: من نقل البيانات إلى مسؤول حماية البيانات (DPO)',
      content: 'لا يقتصر القانون 09-08 على تحديد المبادئ والحقوق، بل يضع إطاراً إجرائياً ومؤسساتياً لضمان الامتثال الفعلي. يشمل هذا الإطار قواعد صارمة لنقل البيانات خارج المغرب، ودور اللجنة الوطنية كجهاز رقابي، بالإضافة إلى تشجيع تعيين مسؤول لحماية البيانات داخل المؤسسات.',
      bullets: [
        'ضوابط نقل البيانات نحو الخارج: تمنع المادة 43 من القانون نقل البيانات الشخصية إلى دولة أجنبية ما لم تكن هذه الدولة توفر مستوى "كافياً" من الحماية. تحدد اللجنة الوطنية قائمة الدول التي تستوفي هذا الشرط. في غياب ذلك، يتطلب النقل إذناً خاصاً من اللجنة، يمكن منحه استناداً إلى ضمانات كافية مثل "البنود التعاقدية النموذجية" (Clauses Contractuelles Types) التي تقرها اللجنة.',
        'دور اللجنة الوطنية (CNDP) في الرقابة والعقوبات: بصفتها الهيئة الرقابية، تتمتع اللجنة الوطنية بصلاحيات واسعة تشمل تلقي التصاريح، وإجراء التحقيقات والافتحاصات لدى مسؤولي المعالجة، وتلقي الشكايات. وفي حالة ثبوت المخالفة، يمكن للجنة أن تصدر إنذارات، أو أوامر بتصحيح الوضع، أو حتى إحالة الملف على النيابة العامة التي يمكنها تحريك المتابعة الجنائية.',
        'نظام العقوبات الزجرية والمالية: يحدد الباب الثامن من القانون (المواد 51 إلى 66) ترسانة من العقوبات لردع المخالفين. تتراوح هذه العقوبات بين غرامات مالية من 10.000 إلى 300.000 درهم، وعقوبات حبسية يمكن أن تصل إلى سنة حبساً نافذاً في حالات خطيرة مثل معالجة البيانات دون موافقة لغايات تمس بالنظام العام أو الآداب.',
        'تعيين مسؤول حماية البيانات (DPO): على الرغم من أن القانون 09-08 لا ينص صراحة على إلزامية تعيين "مسؤول حماية البيانات" (Délégué à la Protection des Données - DPO) على النحو المعروف في أنظمة أخرى، إلا أن اللجنة الوطنية تشجع بقوة على تعيينه كإجراء من إجراءات الحكامة الجيدة. وقد أصبح تعيينه إلزامياً في قطاعات معينة بموجب مداولات اللجنة، مثل المداولة رقم 446-AU-2013 الخاصة بالقطاع البنكي. يتولى هذا المسؤول مهمة ضمان الامتثال الداخلي ويكون نقطة الاتصال مع اللجنة.',
        'سجل المعالجات: يجب على كل مسؤول معالجة أن يمسك سجلاً داخلياً لأنشطة المعالجة التي يقوم بها. هذا السجل، الذي توصي به اللجنة الوطنية، يجب أن يتضمن تفاصيل حول كل عملية معالجة (الغايات، فئات البيانات، المستلمون، مدة الحفظ، التدابير الأمنية)، وهو أداة أساسية لإثبات الامتثال في حالة إجراء تفتيش من قبل اللجنة.',
      ],
    },
  ],
  faq_ar: [
    { q: 'بصفتي مواطنا، ما هي حقوقي الأساسية فيما يتعلق ببياناتي الشخصية التي تجمعها الشركات أو الإدارات؟', a: 'يضمن لك القانون رقم 09-08 المتعلق بحماية الأشخاص الذاتيين تجاه معالجة المعطيات ذات الطابع الشخصي حقوقا أساسية. أهمها: الحق في الإعلام (المادة 5)، أي يجب إخبارك بسبب جمع بياناتك وهوية المسؤول عن المعالجة. ولك أيضا حق الولوج (المادة 7) لبياناتك للتأكد من صحتها، وحق التصحيح (المادة 8) لتعديل أي معلومة خاطئة أو غير مكتملة، بالإضافة إلى حق التعرض (المادة 9) لأسباب مشروعة على معالجة بياناتك.' },
    { q: 'أنا صاحب مقاولة صغيرة وأجمع بيانات زبائني (الاسم، الهاتف، البريد الإلكتروني). ما هي التزاماتي القانونية الرئيسية؟', a: 'بصفتك مسؤولاً عن المعالجة، تقع على عاتقك عدة التزامات بموجب القانون 09-08. أولاً، يجب الحصول على الموافقة الصريحة للشخص المعني قبل جمع بياناته (المادة 4). ثانياً، يجب أن يتم جمع البيانات لغايات محددة ومشروعة (مبدأ الغائية). ثالثاً، وهو الأهم، يجب عليك إيداع تصريح مسبق أو طلب ترخيص لدى اللجنة الوطنية لمراقبة حماية المعطيات ذات الطابع الشخصي (CNDP) قبل البدء في أي معالجة لهذه البيانات.' },
    { q: 'هل يجوز نقل بيانات شخصية لعملاء مغاربة إلى خوادم معلوماتية (serveurs) موجودة خارج المغرب؟', a: 'نعم، لكن بشروط صارمة. حسب المادتين 43 و 44 من القانون 09-08، لا يمكن نقل المعطيات ذات الطابع الشخصي إلى دولة أجنبية إلا إذا كانت هذه الدولة تضمن مستوى حماية كافٍ للحياة الخاصة والحريات والحقوق الأساسية للأفراد. تحدد اللجنة الوطنية (CNDP) لائحة هذه الدول. في حالة عدم توفر هذا المستوى من الحماية، يتطلب النقل الحصول على ترخيص استثنائي من اللجنة بعد تقديم ضمانات كافية.' },
    { q: 'هل يحق للمشغل (صاحب العمل) مراقبة البريد الإلكتروني المهني لموظفيه؟', a: 'مراقبة البريد الإلكتروني المهني ممكنة ولكنها مقيدة جداً. يجب أن تكون المراقبة مبررة بضرورة حماية أمن الشبكة المعلوماتية للمقاولة أو ضمان استخدامها لأغراض مهنية فقط. لا يمكن أن تكون المراقبة عامة ومستمرة، بل يجب أن تكون متناسبة مع الهدف المنشود. والأهم من ذلك، يجب إعلام الموظفين مسبقاً وبشكل واضح بوجود نظام المراقبة وبشروطه، وذلك تطبيقا لمبدأ الشفافية الذي ينص عليه القانون 09-08.' },
    { q: 'ماذا أفعل إذا اكتشفت أن إحدى الشركات تستخدم بياناتي الشخصية دون موافقتي أو لغرض مختلف عن الذي صرحت به؟', a: 'الخطوة الأولى هي الاتصال بالمسؤول عن المعالجة في الشركة المعنية لممارسة حقك في التعرض أو التصحيح. إذا لم تتلق رداً مرضياً أو لم يتم الاستجابة لطلبك، يمكنك تقديم شكاية رسمية إلى اللجنة الوطنية لمراقبة حماية المعطيات ذات الطابع الشخصي (CNDP). هذه اللجنة هي الهيئة المكلفة بالتحقيق في مثل هذه الخروقات واتخاذ الإجراءات اللازمة، والتي قد تصل إلى فرض عقوبات مالية أو إحالة الملف على القضاء.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الالتزامات الإعلامية المسبقة للمورد الإلكتروني',
      content: 'قبل إبرام أي عقد للبيع عن بعد، يفرض القانون رقم 31-08 القاضي بتحديد تدابير لحماية المستهلك على المورد الإلكتروني مجموعة من الالتزامات الإعلامية الدقيقة والشفافة. الهدف هو تمكين المستهلك من اتخاذ قرار مستنير بناءً على معطيات كاملة وواضحة.',
      bullets: [
        'تحديد هوية المورد: يجب أن يعرض الموقع الإلكتروني بشكل واضح ومقروء الاسم الكامل للمورد أو تسميته التجارية، وعنوان مقره الاجتماعي، ورقم هاتفه، وبريده الإلكتروني، بالإضافة إلى رقم تقييده في السجل التجاري ورقم التعريف الضريبي.',
        'وصف المنتج أو الخدمة: تقديم وصف تفصيلي للمميزات الأساسية للمنتج أو الخدمة المعروضة للبيع، بما في ذلك مكوناته وخصائصه التقنية وطريقة استخدامه، وذلك وفقاً للمادة 29 من القانون 31-08.',
        'بيان السعر والضرائب: يجب الإشارة بوضوح إلى السعر الإجمالي للمنتج بالدرهم المغربي، شاملاً لجميع الرسوم والضرائب، وعلى رأسها الضريبة على القيمة المضافة (TVA). كما يجب تفصيل تكاليف التسليم وأي مصاريف إضافية محتملة.',
        'شروط البيع والتسليم: توضيح وسائل الأداء المقبولة، وآجال التسليم، والمناطق الجغرافية التي يغطيها. يجب أن تكون الشروط العامة للبيع متاحة للاطلاع عليها وحفظها من طرف المستهلك قبل تأكيد الطلب.',
        'حق التراجع والضمان: الإخبار الصريح بوجود حق التراجع القانوني ومدته (7 أيام كاملة) وكيفية ممارسته، أو الإشارة إلى عدم وجوده في الحالات الاستثنائية التي نصت عليها المادة 38 من القانون 31-08. كذلك، يجب بيان شروط الضمان القانوني والضمان التجاري إن وجد.',
        'المعالجة الإلكترونية للمعطيات الشخصية: يجب إعلام المستهلك بأن معطياته الشخصية ستخضع للمعالجة، وذلك طبقاً لمقتضيات القانون رقم 09-08 المتعلق بحماية الأشخاص الذاتيين تجاه معالجة المعطيات ذات الطابع الشخصي، مع الإشارة إلى حقوقه في الولوج والتصحيح والتعرض.',
      ],
    },
    {
      h2: 'إبرام العقد الإلكتروني وشروطه القانونية',
      content: 'يُعطي القانون رقم 53-05 المتعلق بالتبادل الإلكتروني للمعطيات القانونية للعقد المبرم بطريقة إلكترونية نفس القوة الثبوتية التي للعقد المحرر على الورق. ولكي يكون العقد صحيحاً، يجب احترام مسطرة محددة تضمن سلامة رضا الطرفين.',
      bullets: [
        'قاعدة "النقرة المزدوجة": تنص المادة 31 من القانون 31-08 على وجوب تمكين المستهلك من مراجعة تفاصيل طلبه وسعره الإجمالي قبل تأكيده النهائي. يجب أن يمر مسار الطلب بمرحلتين: (1) عرض ملخص الطلب للتحقق والتصحيح، و(2) التأكيد النهائي للطلب الذي يُعتبر قبولاً للعرض.',
        'الإشعار بالتوصل: بمجرد تأكيد الطلب، يلتزم المورد، وفقاً للمادة 4-65 من قانون الالتزامات والعقود (المعدل بموجب القانون 53-05)، بأن يوجه للمستهلك دون تأخير وبطريقة إلكترونية إشعاراً بالتوصل يتضمن ملخصاً للطلب المؤكد.',
        'حجية الوثيقة الإلكترونية: تعتبر الوثيقة المحررة على دعامة إلكترونية والموقعة توقيعاً إلكترونياً مؤمَّناً، وثيقة أصلية لها نفس قوة الإثبات التي للكتابة على الورق. هذا المبدأ، المنصوص عليه في القانون 53-05، هو أساس المعاملات التجارية الرقمية.',
        'حفظ العقد: يلتزم المورد بحفظ وأرشفة العقد الإلكتروني المبرم مع المستهلك في سجلات إلكترونية موثوقة تضمن سلامته وتتيح للمستهلك الاطلاع عليه عند الطلب، خاصة بالنسبة للمعاملات التي تتجاوز قيمتها حداً معيناً.',
        'التوقيع الإلكتروني المؤمن: لكي يتمتع التوقيع الإلكتروني بنفس حجية التوقيع الخطي، يجب أن يكون "مؤمَّناً" وفق الشروط المحددة في المرسوم رقم 2.08.518، أي أن يكون منشأ بواسطة آلية معتمدة ومصادق عليه من طرف مقدم خدمات مصادقة إلكترونية معتمد من السلطة الوطنية (المديرية العامة لأمن نظم المعلومات).',
      ],
    },
    {
      h2: 'التزامات ما بعد البيع: التسليم وحق التراجع',
      content: 'بعد إتمام عملية البيع، تظل على عاتق المورد الإلكتروني التزامات جوهرية تتعلق بتنفيذ العقد، أهمها احترام أجل التسليم وضمان حق المستهلك في التراجع عن الشراء وفقاً لمقتضيات قانون حماية المستهلك.',
      bullets: [
        'أجل التسليم: يجب على المورد تسليم المنتج أو تنفيذ الخدمة في الأجل المحدد في العقد. وفي حالة عدم تحديد أجل، فإن الأجل الأقصى للتسليم هو ثلاثون (30) يوماً ابتداءً من تاريخ تأكيد الطلب من طرف المستهلك، وذلك بموجب المادة 34 من القانون 31-08.',
        'آثار التأخر في التسليم: إذا تجاوز المورد أجل التسليم بثلاثين يوماً، أو الأجل المتفق عليه، يحق للمستهلك إلغاء الطلب. وفي هذه الحالة، يجب على المورد أن يرد للمستهلك المبلغ المدفوع كاملاً في أجل أقصاه سبعة (7) أيام من تاريخ ممارسة هذا الحق.',
        'حق التراجع (مهلة التفكير): يتمتع المستهلك بأجل سبعة (7) أيام كاملة لممارسة حقه في التراجع، دون الحاجة إلى تعليل قراره ودون أداء أي غرامات. يبدأ هذا الأجل من تاريخ تسلم المنتج بالنسبة للسلع، أو من تاريخ إبرام العقد بالنسبة للخدمات (المادة 36 من القانون 31-08).',
        'استثناءات حق التراجع: لا يمكن ممارسة حق التراجع في حالات محددة نصت عليها المادة 38، منها: السلع المصنعة حسب مواصفات المستهلك، والسلع التي قد تتلف بسرعة، والتسجيلات الصوتية أو المرئية أو البرامج المعلوماتية التي تم نزع أغلفتها، والصحف والمجلات.',
        'إرجاع المبلغ المدفوع: عند ممارسة حق التراجع، يلتزم المورد بأن يرجع للمستهلك المبلغ المدفوع كاملاً وفوراً، وعلى أبعد تقدير خلال الخمسة عشر (15) يوماً الموالية للتاريخ الذي مورس فيه الحق المذكور. أي تأخير في الإرجاع يعرض المورد لغرامات وفوائد قانونية (المادة 37 من القانون 31-08).',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي الخطوات القانونية الأولى لإنشاء موقع للتجارة الإلكترونية بالمغرب؟', a: 'لبدء نشاط تجاري إلكتروني بشكل قانوني في المغرب، يجب أولاً اختيار شكل قانوني للمقاولة (مثل مقاول ذاتي، شركة ذات مسؤولية محدودة، إلخ). بعد ذلك، يتوجب التسجيل في السجل التجاري لدى المحكمة التجارية المختصة والحصول على مُعرّف ضريبي. لا يوجد ترخيص خاص بالتجارة الإلكترونية، بل تطبق القواعد العامة المنصوص عليها في مدونة التجارة والقوانين الضريبية الجاري بها العمل.' },
    { q: 'ما هي البيانات الإلزامية التي يجب أن يتضمنها موقعي للبيع عن بعد؟', a: 'وفقاً للمادة 29 من القانون رقم 31.08 القاضي بتحديد تدابير لحماية المستهلك، يجب أن يعرض الموقع بشكل واضح ومفهوم المعلومات التالية: هوية المورد (الاسم، العنوان، البريد الإلكتروني، رقم الهاتف، رقم السجل التجاري)، الخصائص الأساسية للمنتج أو الخدمة، السعر بالدرهم شاملًا لجميع الرسوم، تكاليف التسليم، طرق الدفع والتسليم، وجود الحق في التراجع ومدته، ومدة صلاحية العرض.' },
    { q: 'هل يحق للمستهلك إرجاع منتج اشتراه عبر الإنترنت؟ وما هي الشروط؟', a: 'نعم، يمنح القانون 31.08 المستهلك "الحق في التراجع". يمكن للمستهلك ممارسة هذا الحق خلال أجل 7 أيام كاملة من تاريخ تسلم المنتج، دون الحاجة إلى تبرير قراره أو دفع غرامات، باستثناء تكاليف الإرجاع. إذا لم يقم المورد بتوفير المعلومات المطلوبة قانونًا، يتم تمديد هذا الأجل إلى 30 يومًا. تجدر الإشارة إلى أن هذا الحق لا يسري على بعض المنتجات كالمواد سريعة التلف أو المنتجات المصنعة حسب مواصفات المستهلك (المادتان 36 و 37 من القانون 31.08).' },
    { q: 'أقوم بجمع بيانات شخصية لزبائني (الاسم، العنوان...). ما هي التزاماتي بموجب قانون حماية المعطيات الشخصية؟', a: 'بصفتك مسؤولاً عن معالجة المعطيات الشخصية، فإنك تخضع لمقتضيات القانون رقم 09.08 المتعلق بحماية الأشخاص الذاتيين تجاه معالجة المعطيات ذات الطابع الشخصي. يجب عليك التصريح المسبق لدى اللجنة الوطنية لمراقبة حماية المعطيات ذات الطابع الشخصي (CNDP) قبل البدء في جمع البيانات. كما يتوجب عليك إعلام الزبائن بالغرض من جمع بياناتهم وحقوقهم في الولوج والتصحيح والتعرض، بالإضافة إلى ضمان أمن وسرية هذه البيانات.' },
    { q: 'هل الفواتير الإلكترونية معترف بها قانونياً في المغرب؟', a: 'نعم، الفاتورة الإلكترونية لها نفس القوة الثبوتية التي للفاتورة الورقية. ينص القانون رقم 53.05 المتعلق بالتبادل الإلكتروني للمعطيات القانونية على أن الوثيقة المحررة على دعامة إلكترونية تتمتع بنفس قوة الإثبات التي تتمتع بها الوثيقة المحررة على الورق، شريطة أن يكون بالإمكان التعرف على هوية الشخص الذي أصدرها وأن تكون معدة ومحفوظة وفق شروط تضمن تماميتها. لذلك، تعتبر الفاتورة الإلكترونية صالحة قانونياً شريطة استخدام وسائل تضمن سلامة محتواها وهوية مصدرها، كالتوقيع الإلكتروني المؤمن.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'تكوين ملف طلب رخصة البناء: الوثائق الإلزامية',
      content: 'يتطلب الحصول على رخصة البناء إيداع ملف متكامل لدى الشباك الوحيد للجماعة المعنية. يجب أن يُعد هذا الملف بدقة فائقة من طرف مهندس معماري معتمد، وذلك طبقا لمقتضيات المرسوم رقم 2-18-577 المتعلق بالموافقة على ضابط البناء العام الذي يحدد الوثائق المكونة لملفات طلبات الرخص.',
      bullets: [
        'الوثائق الإدارية والقانونية: يجب أن يتضمن الملف طلباً يحمل توقيع صاحب الشأن أو وكيله، وشهادة ملكية العقار أو وثيقة تثبت الحق في إقامة البناء عليه (عقد كراء، وعد بالبيع...). بالنسبة للشخص المعنوي، يجب الإدلاء بالملف القانوني للشركة (النظام الأساسي، محضر آخر جمع عام، السجل التجاري نموذج 7) ونسخة من بطاقة التعريف الوطنية للممثل القانوني.',
        'التصاميم المعمارية: مجموعة كاملة من التصاميم المعدة والموقعة من طرف مهندس معماري مسجل بهيئة المهندسين المعماريين. تشمل هذه التصاميم تصميم الموقع (plan de situation) داخل وثيقة التعمير، التصميم الكتلي (plan de masse)، وتصاميم جميع المستويات والواجهات والمقاطع (plans des niveaux, façades, coupes) بمقياس لا يقل عن 1/100، مع تحديد جميع الأبعاد والمساحات.',
        'الدراسات التقنية المتخصصة: حسب طبيعة وأهمية المشروع، يجب إرفاق دراسات تقنية موقعة من طرف مكاتب دراسات معتمدة. تشمل هذه الدراسات بشكل أساسي دراسة الهياكل والخرسانة المسلحة (étude de structure et béton armé)، وفي الحالات التي يفرضها القانون (كالمناطق الزلزالية أو المباني المرتفعة)، يجب تقديم دراسة مقاومة الزلازل.',
        'وثائق إضافية خاصة: بالنسبة للمشاريع الصناعية أو السياحية أو التجارية الكبرى، تُطلب وثائق إضافية كدراسة التأثير على البيئة المصادق عليها طبقا للقانون رقم 12-03، وموافقة المصالح المختصة (كوزارة السياحة أو الصناعة) ورأي الوقاية المدنية بخصوص معايير السلامة من الحرائق.',
        'النسخ المطلوبة والجانب الرقمي: يجب إيداع الملف في عدد من النسخ الورقية يحدده الشباك الوحيد (عادة ما بين 5 و 10 نسخ)، بالإضافة إلى نسخة رقمية على قرص مدمج (CD-ROM) أو عبر المنصة الرقمية المخصصة "Rokhas.ma" في الجماعات التي اعتمدتها، وذلك لتسهيل التبادل بين مختلف المتدخلين.',
      ],
    },
    {
      h2: 'مسطرة دراسة الطلب والآجال القانونية الملزمة',
      content: 'تخضع مسطرة دراسة طلبات رخص البناء لتنظيم دقيق يهدف إلى تبسيط الإجراءات وتحديد آجال ملزمة للإدارة. تتم دراسة الملفات داخل لجنة موحدة على مستوى الشباك الوحيد للجماعة، وذلك في إطار مقتضيات القانون رقم 12-90 المتعلق بالتعمير والمراسيم التطبيقية له.',
      bullets: [
        'إيداع الملف بالشباك الوحيد: يتم إيداع الملف كاملاً لدى الشباك الوحيد بالجماعة الترابية المختصة، والذي يسلم لصاحب الطلب وصلاً بالإيداع مؤرخاً ومختوماً. يعتبر هذا التاريخ هو نقطة انطلاق حساب الآجال القانونية للرد على الطلب.',
        'لجنة الدراسة الموحدة: يُعرض الملف على "لجنة الدراسة" التي يترأسها رئيس المجلس الجماعي أو من ينوب عنه، وتضم ممثلين عن العمالة أو الإقليم، الوكالة الحضرية، والوقاية المدنية، بالإضافة إلى ممثلي المصالح المكلفة بالشبكات (الماء، الكهرباء، الاتصالات) عند الاقتضاء. تجتمع هذه اللجنة لدراسة مدى مطابقة المشروع للقوانين ووثائق التعمير الجاري بها العمل.',
        'آجال البت في الطلب: حدد المرسوم رقم 2-18-475 آجالاً قصوى للبت في الطلبات من طرف اللجنة. بالنسبة للمشاريع الصغرى (بناء فردي، فيلا...)، يجب أن تصدر اللجنة رأيها في أجل أقصاه 15 يوم عمل. أما بالنسبة للمشاريع الكبرى (مجموعات سكنية، عمارات، تجهيزات...)، فإن الأجل الأقصى هو 30 يوم عمل.',
        'قرار رئيس المجلس الجماعي: بناءً على الرأي الموافق (avis favorable) للجنة، يقوم رئيس المجلس الجماعي بتسليم رخصة البناء في أجل يومي (2) عمل. في حالة وجود ملاحظات أو طلب تعديلات (avis défavorable)، يتم إشعار صاحب الطلب بها كتابةً وبشكل معلل لإجراء التصويبات اللازمة.',
        'مبدأ الرخصة الضمنية: في حالة سكوت الإدارة وعدم ردها داخل الآجال القانونية المذكورة، يمكن لصاحب الطلب، بعد انقضاء شهرين من تاريخ إيداع الملف، أن يعتبر طلبه مقبولاً ضمنياً. لتفعيل ذلك، يجب عليه إشعار رئيس المجلس الجماعي والوالي أو العامل عبر رسالة مضمونة مع إشعار بالتوصل، مع نسخة للمهندس المعماري، ليتمكن من مباشرة الأشغال.',
      ],
    },
    {
      h2: 'الالتزامات بعد الحصول على الرخصة وشهادة المطابقة',
      content: 'لا ينتهي المسار القانوني بالحصول على رخصة البناء، بل يترتب عليها مجموعة من الالتزامات أثناء وبعد إنجاز الأشغال، وصولاً إلى الحصول على الوثيقة النهائية التي تسمح باستغلال البناية بشكل قانوني، وهي رخصة السكن أو شهادة المطابقة.',
      bullets: [
        'إشهار الرخصة وفتح الورش: قبل بدء أي عمل، يجب على صاحب المشروع تعليق لوحة واضحة في مدخل الورش تتضمن معلومات الرخصة (الرقم، التاريخ، طبيعة المشروع، اسم المهندس المعماري والمقاول). كما يجب عليه التصريح بتاريخ انطلاق الأشغال وتاريخ انتهائها لدى الجماعة.',
        'احترام التصاميم المرخصة: يُعتبر أي تغيير في التصاميم التي تمت المصادقة عليها مخالفة للقانون تستوجب عقوبات. في حالة ضرورة إدخال تعديلات جوهرية، يجب تقديم طلب "رخصة تعديلية" (permis modificatif) واتباع نفس مسطرة الطلب الأصلي قبل تنفيذ التعديل.',
        'التتبع الإلزامي من طرف المهندس المعماري: يفرض القانون رقم 016-89 المتعلق بمزاولة مهنة الهندسة المعمارية على المهندس المعماري تتبع أشغال الورش الذي أشرف على تصميمه. ويقوم بتحرير محاضر زيارات الورش التي توثق مدى مطابقة الأشغال المنجزة للتصاميم المرخصة ولقواعد فن البناء.',
        'طلب رخصة السكن أو شهادة المطابقة: بعد انتهاء الأشغال كلياً، يقدم صاحب المشروع طلباً للحصول على "رخصة السكن" (permis d\'habiter) للمباني السكنية، أو "شهادة المطابقة" (certificat de conformité) للمباني ذات الاستعمال الآخر (تجاري، صناعي، مكتبي...). يُرفق الطلب بتصريح انتهاء الأشغال موقع من طرف المهندس المعماري.',
        'لجنة المعاينة والتسليم النهائي: تقوم لجنة تقنية، تضم نفس أعضاء لجنة دراسة الملفات، بزيارة ميدانية للبناية للتحقق من مطابقتها للتصاميم المرخصة ولضوابط التعمير. بناءً على تقريرها الإيجابي، يسلم رئيس المجلس الجماعي رخصة السكن أو شهادة المطابقة، وهي الوثيقة التي تسمح قانونياً بإشغال المبنى وربطه بالشبكات النهائية (الماء، الكهرباء).',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي رخصة البناء، ومتى يكون الحصول عليها إلزامياً؟', a: 'رخصة البناء هي وثيقة إدارية يمنحها رئيس مجلس الجماعة، تسمح بالقيام بأعمال بناء جديدة أو تعديل بناء قائم. تهدف إلى ضمان احترام القوانين والأنظمة المتعلقة بالتعمير وضوابط البناء والسلامة العامة. يعتبر الحصول عليها إلزامياً قبل الشروع في أي عملية بناء، أو توسعة، أو تعلية، أو إدخال تغييرات على الواجهات الخارجية، أو أي تعديلات هيكلية جوهرية على المباني القائمة، وذلك طبقاً لمقتضيات المادة 40 من القانون رقم 90-12 المتعلق بالتعمير.' },
    { q: 'ما هي الإجراءات والعقوبات المترتبة على البناء دون الحصول على رخصة؟', a: 'يُعتبر البناء بدون رخصة مخالفة خطيرة يعاقب عليها القانون. يقوم المراقبون المخولون قانوناً بتحرير محضر مخالفة، ويصدر الوالي أو العامل أمراً فورياً بإيقاف الأشغال. وفي حالة عدم الامتثال، يمكن للسلطة المحلية اللجوء إلى الهدم التلقائي على نفقة المخالف. بالإضافة إلى ذلك، يتعرض المخالف لعقوبات زجرية تتراوح بين غرامات مالية كبيرة وعقوبات حبسية، وذلك وفقاً لمقتضيات القانون رقم 12-66 المتعلق بمراقبة وزجر المخالفات في مجال التعمير والبناء، خاصة المواد من 64 إلى 71 منه.' },
    { q: 'ما هي المسطرة المتبعة للحصول على رخصة البناء ومن هي الجهة المختصة بمنحها؟', a: 'يتم إيداع ملف طلب رخصة البناء لدى "الشباك الوحيد" بالجماعة الترابية المعنية. تتم دراسة الملف من طرف لجنة متخصصة تضم ممثلين عن الجماعة، الوكالة الحضرية، الوقاية المدنية، ومصالح أخرى حسب طبيعة المشروع. تتولى هذه اللجنة دراسة مدى تطابق المشروع مع وثائق التعمير والقوانين الجاري بها العمل. الجهة المختصة قانوناً بمنح الرخصة هي رئيس مجلس الجماعة، الذي يتخذ قراره بناءً على الرأي الملزم للوكالة الحضرية. تنظم هذه المسطرة مقتضيات القانون رقم 90-12 المتعلق بالتعمير والمرسوم رقم 2.18.577 بالمصادقة على ضابط البناء العام.' },
    { q: 'ما هي مدة صلاحية رخصة البناء وهل يمكن تمديدها؟', a: 'تكون رخصة البناء صالحة لمدة ثلاث (3) سنوات ابتداءً من تاريخ تسليمها. إذا لم يتم الشروع في الأشغال خلال هذه المدة، أو إذا توقفت الأشغال لمدة تزيد عن سنة، تصبح الرخصة لاغية. يمكن لصاحب الشأن طلب تمديد صلاحية الرخصة مرة واحدة ولمدة سنة إضافية، شريطة أن يقدم طلبه قبل شهرين على الأقل من تاريخ انتهاء صلاحيتها، وأن يثبت أن التأخير لا يعزى إليه. تستند هذه المقتضيات إلى المادة 35 من المرسوم رقم 2.18.577 بالمصادقة على ضابط البناء العام المحدد لشكل وشروط تسليم الرخص.' },
    { q: 'ما هي الوثائق الأساسية التي يتكون منها ملف طلب رخصة البناء؟', a: 'يتكون ملف طلب رخصة البناء، على سبيل المثال لا الحصر، من الوثائق التالية: - طلب يحمل توقيع صاحب الشأن أو من يمثله. - شهادة ملكية العقار أو أي وثيقة قانونية تثبت الحق في إقامة البناء. - التصاميم المعمارية (تصميم الموقع، تصميم الكتلة، التصاميم بمختلف المستويات والواجهات والمقاطع) موقعة من طرف مهندس معماري مسجل في هيئة المهندسين المعماريين. - تصميم طبوغرافي للأرض في حال تطلب الأمر ذلك. - دراسات تقنية (مثل دراسة الخرسانة المسلحة) يعدها مهندسون متخصصون. - عقد مع المهندس المعماري. تحدد لائحة الوثائق بشكل دقيق بموجب المادة 19 من المرسوم رقم 2.18.577 بالمصادقة على ضابط البناء العام.' },
  ],
  ...
  sections_ar: [
    {
      h2: 'الإطار القانوني وأنواع المخالفات التعميرية',
      content: 'يُشكل القانون رقم 12.90 المتعلق بالتعمير، كما تم تعديله وتتميمه بالقانون رقم 66.12 المتعلق بمراقبة وزجر المخالفات في مجال التعمير والبناء، الركيزة الأساسية لتنظيم قطاع البناء بالمغرب. تحدد هذه القوانين بدقة الأفعال التي تعتبر مخالفات وتستوجب العقاب، بهدف ضمان احترام وثائق التعمير وسلامة المباني.',
      bullets: [
        'البناء بدون رخصة مسبقة: يعتبر تشييد أي بناية دون الحصول على رخصة البناء الصادرة عن رئيس المجلس الجماعي من أخطر المخالفات. تستثنى من ذلك فقط الأبنية المحددة حصراً بموجب المادة 43 من القانون 12.90.',
        'عدم مطابقة الأشغال للرخصة المسلمة: كل بناء يتجاوز ما هو مرخص به في التصاميم المصادق عليها (TDP - Titre de propriété) من حيث عدد الطوابق، أو المساحة المبنية، أو العلو، أو المظهر الخارجي، يُعد مخالفة صريحة للمادة 40 من القانون 12.90.',
        'استعمال مواد بناء ممنوعة أو غير مطابقة للمواصفات: يُلزم القانون باستخدام مواد تضمن متانة البناء وسلامته. إن استخدام مواد محظورة أو لا تحترم المعايير التقنية المعمول بها يعرض المخالف للمساءلة القانونية.',
        'تغيير الغرض المخصص للبناء: يُعتبر تحويل بناية مخصصة للسكن إلى محل تجاري أو ورشة حرفية، أو العكس، دون الحصول على رخصة تعديلية، مخالفة تستوجب تدخلاً زجرياً وفقاً لمقتضيات القانون.',
        'عدم الحصول على رخصة السكن أو شهادة المطابقة: بعد انتهاء الأشغال، يُعد شغل البناية أو استعمالها دون الحصول على رخصة السكن (للمباني السكنية) أو شهادة المطابقة (للمباني الأخرى)، كما تنص على ذلك المادة 55 من القانون 12.90، مخالفة قائمة بذاتها تمنع من إبرام عقود الماء والكهرباء بشكل نهائي.',
      ],
    },
    {
      h2: 'مسطرة المراقبة والزجر الإداري والقضائي',
      content: 'وضع المشرع مسطرة دقيقة ومتدرجة لمراقبة وزجر المخالفات، تتدخل فيها السلطات الإدارية المحلية والقضاء. تهدف هذه المسطرة إلى وقف المخالفة في مهدها ومنع تفاقمها، مع ضمان حق الدفاع للمخالف.',
      bullets: [
        'معاينة المخالفة وتحرير المحضر: يقوم ضباط الشرطة القضائية أو مراقبو التعمير المؤهلون قانوناً بمعاينة المخالفة وتحرير محضر رسمي بشأنها. يتم توجيه هذا المحضر فوراً إلى وكيل الملك، ورئيس المجلس الجماعي، والعامل أو الوالي حسب الحالة، وذلك طبقاً للمادة 66 من القانون 66.12.',
        'الأمر الفوري بإيقاف الأشغال: بمجرد معاينة المخالفة، يقوم المراقب بإصدار أمر فوري للمخالف بوقف الأشغال. في حالة عدم الامتثال، يمكن للسلطة الإدارية المحلية اتخاذ الإجراءات اللازمة لفرض وقف الأشغال، بما في ذلك وضع الأختام على الورش.',
        'صلاحيات العامل في هدم البناء المخالف: منح القانون رقم 66.12 للعامل (أو من يفوضه) صلاحية إصدار أمر بهدم الأبنية التي لا تزال في طور البناء والتي تشكل مخالفة. يجب تنفيذ هذا الأمر الإداري خلال أجل محدد، وفي حالة امتناع المخالف، تقوم السلطة بالهدم على نفقته.',
        'المتابعة القضائية والعقوبات: يحال محضر المخالفة على وكيل الملك لدى المحكمة الابتدائية المختصة. تتراوح العقوبات، حسب خطورة المخالفة، بين غرامات مالية من 10.000 إلى 100.000 درهم (المادة 71 من القانون 12.90)، وقد تصل إلى عقوبات حبسية في حالات العود أو المخالفات الجسيمة.',
        'هدم البناء بحكم قضائي: في حال صدور حكم قضائي نهائي بالإدانة، يمكن للمحكمة أن تأمر بهدم البناء المخالف وإعادة الحالة إلى ما كانت عليه على نفقة المخالف. إذا لم يقم المحكوم عليه بالهدم طواعية، تتولى الإدارة تنفيذ الحكم جبراً على نفقته.',
      ],
    },
    {
      h2: 'إمكانيات التسوية والحصول على المطابقة',
      content: 'رغم الصرامة في الزجر، أقر المشرع المغربي آليات استثنائية لتسوية وضعية بعض البنايات غير القانونية، شريطة استيفائها لمجموعة من الشروط التقنية والقانونية. تهدف هذه الإجراءات إلى إدماج هذه البنايات في النسيج العمراني المنظم مع تحقيق مداخيل للجماعات الترابية.',
      bullets: [
        'شروط قبول طلب التسوية: لا يمكن تسوية وضعية بناية إلا إذا كانت منجزة قبل تاريخ معين يحدده النص التنظيمي (المرسوم رقم 2.18.475)، وألا تكون مقامة على ملك من أملاك الدولة أو الجماعات، وألا تشكل خطراً على السلامة العامة، وأن تحترم الضوابط الأساسية للتعمير.',
        'مسطرة إيداع ودراسة الملف: يقدم المعني بالأمر ملفاً تقنياً كاملاً (يعده مهندس معماري) لدى الجماعة الترابية المختصة. تتم دراسة الملف من طرف لجنة إقليمية خاصة تضم ممثلين عن العمالة والجماعة والوكالة الحضرية والوقاية المدنية.',
        'قرار اللجنة ومنح رخصة التسوية: بعد دراسة الملف والقيام بزيارة ميدانية، تصدر اللجنة قرارها إما بقبول الطلب، أو رفضه مع تعليل الأسباب، أو قبوله بشروط (إنجاز أشغال تكميلية). في حالة القبول، يتم منح "رخصة التسوية" بعد أداء غرامة تحدد قيمتها بناءً على طبيعة ومساحة المخالفة.',
        'أهمية الحصول على شهادة المطابقة النهائية: بعد إتمام البناء بشكل قانوني أو بعد الحصول على رخصة التسوية، يبقى من الضروري التقدم بطلب للحصول على رخصة السكن أو شهادة المطابقة. هذه الوثيقة هي الإثبات النهائي بأن البناية مطابقة للقوانين والأنظمة، وهي ضرورية لإبرام عقود التزويد بالخدمات الأساسية (ماء، كهرباء) ولإتمام أي معاملة عقارية مستقبلية (بيع، رهن).',
      ],
    },
  ],
  faq_ar: [
    { q: 'ما هي أبرز المخالفات في مجال التعمير والبناء التي يعاقب عليها القانون المغربي؟', a: 'تتعدد المخالفات التعميرية، لكن أبرزها وأكثرها شيوعاً تشمل: - البناء أو إقامة منشآت دون الحصول على رخصة بناء مسبقة. - عدم مطابقة الأشغال المنجزة للتصاميم المرخصة أو لمقتضيات وثائق التعمير (كتجاوز العلو المسموح به أو عدم احترام المساحات الخضراء). - استعمال المبنى في غرض غير الذي خصص له بموجب الرخصة (مثلاً، تحويل شقة سكنية إلى محل تجاري دون ترخيص). - إحداث تجزئة عقارية أو مجموعة سكنية دون إذن مسبق. هذه المخالفات منصوص عليها بشكل أساسي في القانون رقم 90-12 المتعلق بالتعمير والقانون رقم 90-25 المتعلق بالتجزئات العقارية، كما تم تعديلهما وتتميمهما بموجب القانون رقم 12-66 المتعلق بمراقبة وزجر المخالفات في مجال التعمير والبناء.' },
    { q: 'من هي الجهات المخولة قانوناً بمعاينة المخالفات التعميرية وتحرير محاضر بشأنها؟', a: 'خول القانون رقم 12-66 مهمة معاينة المخالفات التعميرية وتحرير المحاضر لعدة جهات، وهي: 1.  ضباط الشرطة القضائية. 2.  المراقبون في مجال التعمير والبناء، التابعون للوالي أو العامل أو الإدارة، والذين يؤدون اليمين القانونية أمام المحكمة المختصة. 3.  كل خبير أو موظف تكلفه الإدارة بهذه المهمة، محلف ومكلف بصفة قانونية. يقوم هؤلاء المراقبون بزيارة الأوراش ومعاينة الأشغال الجارية، وفي حال اكتشاف مخالفة، يحررون محضراً يوجه إلى السلطات المختصة (العامل أو الوالي) ووكيل الملك لدى المحكمة الابتدائية لاتخاذ الإجراءات اللازمة.' },
    { q: 'ما هي الإجراءات الفورية التي يتم اتخاذها عند ضبط مخالفة تعميرية؟', a: 'بمجرد معاينة المخالفة من طرف المراقب المختص، يتم اتخاذ إجراءات إدارية فورية لوقف التمادي في المخالفة. أهم هذه الإجراءات هو إصدار أمر فوري بوقف الأشغال. يقوم المراقب بتوجيه هذا الأمر مباشرة إلى المخالف. وفي حال عدم الامتثال، يمكن للسلطة الإدارية المحلية (الباشا أو القائد) اتخاذ التدابير اللازمة لفرض وقف الأشغال، بما في ذلك وضع الأختام على الورش أو حجز المعدات والأدوات، وذلك استناداً إلى مقتضيات المادة 65 من القانون رقم 12-66.' },
    { q: 'ما هي العقوبات الجنائية المترتبة عن ارتكاب مخالفة تعميرية؟', a: 'إلى جانب الإجراءات الإدارية كالهدم، نص القانون رقم 12-66 على عقوبات جنائية صارمة. فمثلاً، يعاقب على جريمة البناء بدون رخصة بغرامة مالية تتراوح بين 10.000 و 100.000 درهم. وفي حال عدم مطابقة البناء للتصاميم المرخصة، تتراوح الغرامة بين 5.000 و 50.000 درهم.  بالإضافة إلى الغرامات، يمكن للمحكمة أن تأمر بهدم البناء المخالف على نفقة المخالف. وفي حالة العود (ارتكاب نفس المخالفة خلال سنة)، تضاعف العقوبات المالية ويمكن الحكم بعقوبات حبسية. هذه العقوبات منصوص عليها في الباب الرابع من القانون رقم 12-66 (المواد من 70 إلى 80).' },
    { q: 'هل يمكن تسوية وضعية بناية تم تشييدها بشكل مخالف للقانون؟ وما هي الشروط؟', a: 'كانت تسوية وضعية البنايات غير القانونية ممكنة بشكل استثنائي ومؤقت بموجب المادة 7 من القانون رقم 12-66، والتي فتحت الباب لإيداع ملفات التسوية داخل أجل محدد انتهى قانونياً. كانت هذه التسوية تخضع لشروط صارمة، منها: - أن تكون البناية منجزة قبل تاريخ معين. - ألا تكون مقامة على ملك من أملاك الدولة أو الجماعات الترابية. - أن تحترم متطلبات السلامة والمتانة (عبر خبرة تقنية). - ألا تؤثر بشكل كبير على وثائق التعمير السارية. حالياً، وبعد انقضاء الأجل القانوني، لم يعد إجراء التسوية متاحاً كقاعدة عامة. أي تسوية مستقبلية تتطلب صدور نص قانوني جديد أو دوريات وزارية استثنائية تنظم العملية وشروطها، وهو أمر غير مضمون.' },
  ],
  ...
  // ─── Réforme marchés publics — décret 2-22-431 ───────────────────────────
  {
    ...
    h1:               'Réforme des marchés publics au Maroc : projet de décret n° 2-26-435 modifiant le décret n° 2-22-431',
    h1_ar:            'إصلاح الصفقات العمومية في المغرب: قراءة في مشروع المرسوم رقم 2.26.435 المعدل للمرسوم رقم 2.22.431',
    badge:            'Projet de texte réglementaire — non encore en vigueur',
    badge_ar:         'مشروع نص تنظيمي غير ساري المفعول بعد',
    stats: [
      { value: '800 000 DH TTC', label: 'Seuil proposé pour les bons de commande', badge: 'Proposé' },
      { value: '1 500 000 DH HT', label: 'Seuil proposé pour l\'AO ouvert simplifié', badge: 'Proposé' },
      { value: '15 %', label: 'Taux proposé pour les offres excessives et anormalement basses', badge: 'Proposé' },
      { value: '5 jours', label: 'Délai de publicité proposé pour les bons de commande', badge: 'Proposé' },
      { value: '2 %', label: 'Garantie de bonne exécution proposée (bons de commande)', badge: 'Proposé' },
    ],
    stats_ar: [
      { value: '800.000 درهم TTC', label: 'العتبة المقترحة لسندات الطلب', badge: 'مقترح' },
      { value: '1.500.000 درهم HT', label: 'العتبة المقترحة لطلب العروض المفتوح المبسط', badge: 'مقترح' },
      { value: '15%', label: 'النسبة المقترحة للعروض المفرطة والمنخفضة بكيفية غير عادية', badge: 'مقترح' },
      { value: '5 أيام', label: 'مدة الإشهار المقترحة لسندات الطلب', badge: 'مقترح' },
      { value: '2%', label: 'ضمان حسن التنفيذ المحتمل لسندات الطلب', badge: 'مقترح' },
    ],
    intro:            'Le décret n° 2-22-431 du 15 chaabane 1444 (8 mars 2023) constitue le texte réglementaire de référence régissant les marchés publics de l\'État, des collectivités territoriales et des établissements publics. Un projet de décret n° 2-26-435 visant à le modifier et le compléter a été préparé par le Ministère de l\'Économie et des Finances. Ce projet, soumis à l\'avis de la Commission nationale des marchés publics, répond aux difficultés pratiques exprimées par les maîtres d\'ouvrage et les opérateurs économiques au cours des premières années d\'application. Vingt-neuf articles sont concernés par les modifications proposées.',
    intro_ar:         'يُشكّل المرسوم رقم 2.22.431 الصادر في 15 شعبان 1444 (8 مارس 2023) النص التنظيمي المرجعي لإبرام صفقات الدولة والجماعات الترابية والمؤسسات العمومية والأشخاص الاعتبارية الأخرى الخاضعة للقانون العام، وهو النص التنظيمي الجاري به العمل في مجال الصفقات العمومية. وقد أعدّت وزارة الاقتصاد والمالية مشروع مرسوم رقم 2.26.435 يرمي إلى تغييره وتتميمه، معالجةً الإشكاليات العملية التي عبّر عنها أصحاب المشاريع والمتعاملون الاقتصاديون خلال السنوات الأولى للتطبيق. ويطال هذا المشروع تسعاً وعشرين مادة.',
    disclaimer:       'Avertissement — Ce guide est fondé sur un projet de texte réglementaire (décret n° 2-26-435) non encore publié au Bulletin officiel. Les dispositions présentées constituent des modifications proposées et ne sont pas encore applicables. En cas de divergence avec le texte définitif, seule la version publiée officiellement fait foi.',
    disclaimer_ar:    'تنبيه: تستند هذه الصفحة إلى مشروع مرسوم رقم 2.26.435 لم يُنشر بعد في الجريدة الرسمية. ولا تصبح أي من الأحكام المعروضة قابلة للتطبيق إلا بعد اعتماد النص النهائي ونشره في الجريدة الرسمية. وفي حالة وجود أي تعارض، فالعبرة بالنص الرسمي المنشور.',
    methodology_note:    'Note méthodologique : cette page est fondée sur une lecture comparative entre le décret n° 2-22-431 et le projet de décret n° 2-26-435. Elle ne se substitue pas aux textes officiels publiés au Bulletin officiel.',
    methodology_note_ar: 'ملاحظة منهجية: اعتمدت هذه الصفحة على قراءة مقارنة بين المرسوم رقم 2.22.431 ومشروع المرسوم رقم 2.26.435، مع التركيز على التعديلات ذات الأثر العملي. ولا تُغني هذه القراءة عن الرجوع إلى النصوص الرسمية المنشورة في الجريدة الرسمية.',
    ...
    sections_ar: [
      {
        ...
        content: [
          'يُشكّل المرسوم رقم 2.22.431 الصادر في 15 شعبان 1444 (8 مارس 2023) النص التنظيمي المرجعي لإبرام صفقات الدولة والجماعات الترابية والمؤسسات العمومية والأشخاص الاعتبارية الأخرى الخاضعة للقانون العام، وهو النص التنظيمي الجاري به العمل في مجال الصفقات العمومية. ويأتي مشروع المرسوم رقم 2.26.435 للتغيير والتتميم، استجابةً للإشكاليات العملية التي عبّر عنها أصحاب المشاريع والمتعاملون الاقتصاديون خلال السنوات الأولى من تطبيق المرسوم.',
          'أُعدّ المشروع من طرف وزارة الاقتصاد والمالية، وعُرض على اللجنة الوطنية للطلبيات العمومية، ويطال تسعاً وعشرين مادة من مرسوم 2023.',
        ],
        bullets: [
          'الاستجابة لتطلعات أصحاب المشاريع والمتعاملون الاقتصاديون المُعبَّر عنها خلال السنوات الأولى من تطبيق المرسوم',
          ...
          'تعزيز الولوج الترابي للمقاولات إلى الطلبيات العمومية، خاصة عند تساوي العروض وفق الشروط التي يحددها المشروع',
          'إدماج البعد الاجتماعي في تقييم بعض العروض، خاصة في صفقات الحراسة والنظافة وصيانة المساحات الخضراء، بما يحد من كسر الأسعار على حساب كلفة اليد العاملة',
      ...
      },
      {
        ...
        content: [
          'الأرقام التالية واردة في صيغة المشروع المتاحة، وقد تتغير عند اعتماد النص النهائي.',
        ...
        bullets: [
          'سندات الطلب (م. 91) — قبل المشروع : 500.000 درهم مع احتساب جميع الرسوم ← يقترح المشروع : 800.000 درهم مع احتساب جميع الرسوم — توسيع نطاق اللجوء إلى سندات الطلب',
          'طلب العروض المفتوح المبسط (م. 19) — قبل المشروع : 1.000.000 درهم خارج الرسوم ← يقترح المشروع : 1.500.000 درهم خارج الرسوم — تمكين عدد أكبر من الصفقات من الاستفادة من المسطرة المبسطة',
          'العرض المفرط (م. 44 و144) — قبل المشروع : أكثر من 20 % ← يقترح المشروع : أكثر من 15 % حسب المواد المعنية',
          'العرض المنخفض بكيفية غير عادية (م. 44 و144) — يقترح المشروع ملاءمة هذه العتبات حول نسبة 15% حسب المواد المعنية',
          'مدة إشهار سندات الطلب (م. 91) — قبل المشروع : 48 ساعة ← يقترح المشروع : 5 أيام على الأقل — تقوية الشفافية وتكافؤ الفرص',
          'جائزة الحوار التنافسي والعرض التلقائي (م. 12 و13) — قبل المشروع : غير محددة ← يقترح المشروع : 0,5 % من العرض المالي المقبول، بسقف 200.000 درهم',
          'ضمان حسن التنفيذ لسندات الطلب (م. 91) — قبل المشروع : غير مقرر ← يقترح المشروع : 2 % من مبلغ تقدير الأعمال، بين 1.000 و5.000 درهم',
          'مدة سريان العروض (م. 143) — يقترح المشروع تأطير التمديد في 30 يوماً على الأكثر، بسقف إجمالي 90 يوماً — حماية المتنافسين من تأخيرات المصادقة',
        ],
      },
      {
        icon: '📦',
        h2: 'سندات الطلب : العتبة السنوية ترتفع إلى 800.000 درهم مع احتساب جميع الرسوم (م. 91)',
        content: [
          'يرمي المشروع إلى رفع العتبة السنوية للأشغال المُنجزة بواسطة سندات الطلب من 500.000 درهم مع احتساب جميع الرسوم إلى 800.000 درهم مع احتساب جميع الرسوم، بالنسبة لكل آمر بالصرف أو آمر بالصرف مساعد أو شخص مؤهل، حسب الصيغة المعتمدة في النص، وذلك في إطار سنة مالية واحدة.',
          ...
          'ماذا يعني ذلك عملياً؟ إذا تم اعتماد هذا التعديل، فإن رفع العتبة إلى 800.000 درهم مع احتساب جميع الرسوم سيوسع مجال اللجوء إلى سندات الطلب، لكنه يربط هذه الإمكانية بضمانات إضافية، من بينها إشهار الإعلان لمدة لا تقل عن خمسة أيام، وإمكانية المطالبة بضمان حسن التنفيذ بنسبة 2%.',
        ],
        bullets: [
          'العتبة السنوية المقترحة : 800.000 درهم مع احتساب جميع الرسوم لكل آمر بالصرف أو آمر بالصرف مساعد أو شخص مؤهل (م. 91)',
      ...
      },
      {
        ...
        content: [
          'تعريفات أساسية — العرض المفرط: هو العرض الذي يتجاوز العتبة المحددة مقارنة بتقدير كلفة الأعمال أو الثمن المرجعي، حسب الحالات المنصوص عليها. العرض المنخفض بكيفية غير عادية: هو العرض الذي يقل بكيفية غير عادية عن التقدير، مما قد يثير شبهة عدم القدرة على التنفيذ. العرض الأكثر أفضلية: هو العرض المعتمد وفق معايير التقييم المحددة في النص، ولا يعني دائماً العرض الأقل ثمناً في جميع الحالات. الثمن المرجعي: آلية مقارنة تُستعمل لتقييم العروض المالية وفق الشروط المحددة في المرسوم.',
          'ملاحظة جوهرية — يُبقي المشروع على معيار الثمن المرجعي كمعيار عام لإسناد الصفقات بالنسبة لصفقات الأشغال والتوريدات والخدمات غير المتعلقة بالدراسات (م. 43). لا ينبغي فهم المشروع على أنه يتخلى كلياً عن منطق العرض المالي — فحسب نوع الصفقة، يظل تقييم العرض المالي مرتبطاً بالثمن المرجعي أو بالمعايير المحددة في النص.',
          'استثناء اجتماعي مهم — بالنسبة لصفقات حراسة المباني الإدارية وتنظيفها وصيانة المساحات الخضراء، يتجه المشروع إلى حماية كلفة اليد العاملة من خلال ترجيح العرض الذي يقترح نسبة الزيادة الأعلى، وفق الشروط المحددة في المشروع. ويستهدف هذا الاستثناء الحدّ من ظاهرة كسر الأسعار على حساب الالتزامات الاجتماعية للمقاولات.',
          'عند التساوي في العروض الأكثر أفضلية، يُرجّح المشروع المتنافسَ الذي يزاول نشاطه في مكان تنفيذ الأعمال. ولا تُعد الأفضلية الترابية، حسب الصيغة المعروضة في المشروع، قاعدة إقصاء أو امتيازاً مطلقاً، بل آلية ترجيح عند تساوي العروض الأكثر أفضلية (م. 43).',
        ],
        bullets: [
          'المعيار العام : تقييم العرض المالي بالنسبة للثمن المرجعي أو المعايير المحددة في النص (حسب نوع الصفقة)',
          'استثناء صفقات الحراسة والنظافة والمساحات الخضراء : نسبة الزيادة الأعلى هي المعيار (حماية كلفة اليد العاملة)',
          'يقترح المشروع تخفيض عتبة العرض المفرط من أكثر من 20% إلى أكثر من 15%، حسب المواد المعنية (م. 44 و144)',
          'العرض المنخفض بكيفية غير عادية : يقترح المشروع ملاءمة العتبات حول 15% حسب المواد المعنية (م. 44 و144)',
          'الأفضلية الترابية عند التساوي : الجماعة → الإقليم أو العمالة → الجهة → القرعة (م. 43)',
          'تُقيَّم العروض على أساس المبلغ خارج الرسوم من قِبَل صاحب المشروع (م. 44)',
        ],
      },
      {
        icon: '🏢',
        h2: 'البعد الاجتماعي والصفقات المخصصة للمقاولات الصغرى والمتوسطة (م. 6 و147 و148)',
        content: [
          'المادة 6 — إعداد تقدير كلفة الأعمال : بالنسبة لصفقات حراسة المباني الإدارية وتنظيفها وصيانة المساحات الخضراء، يتعين على صاحب المشروع، عند إعداد تقدير كلفة الأعمال، أن يأخذ بعين الاعتبار الحد الأدنى القانوني للأجور والمساهمات الاجتماعية الإلزامية. ويُضمَّن تقدير كلفة الأعمال في وثيقة مكتوبة تُبرز المبلغ خارج الرسوم ونسبة الضريبة على القيمة المضافة ومبلغها والمبلغ مع احتساب جميع الرسوم. والغرض من هذا التوجه هو الحد من العروض التي تبدو منخفضة مالياً لكنها لا تغطي فعلياً الكلفة القانونية للعمل.',
          'المادة 147 — الأفضلية الوطنية : تُطبق زيادة بنسبة 15% على مبلغ العرض المالي المقدم من طرف المتنافس غير المؤسس بالمغرب لأغراض المقارنة مع عروض المتنافسين الوطنيين. ينبغي توضيح أن هذه الزيادة تُستعمل لأغراض مقارنة العروض، ولا تعني بالضرورة رفع الثمن الذي ستُؤدى به الصفقة.',
          'المادة 148 — الصفقات المخصصة : يحثّ المشروع على اللجوء إلى الصفقات المخصصة لفائدة فئات متعددة من المتعاملين الاقتصاديين. ويرمي هذا التوجه إلى توسيع قاعدة الولوج إلى الطلبيات العمومية، لكنه مرتبط بالشروط والكيفيات التي قد تُحدد بقرار للوزير المكلف بالمالية.',
          'من هي الفئات المستفيدة من الصفقات المخصصة؟',
        ],
        bullets: [
          'المقاولات الصغيرة جداً والمقاولات الصغرى والمتوسطة',
          ...
          'زيادة 15% تُطبَّق على عروض المتنافسين غير المؤسَّسين بالمغرب لأغراض المقارنة فقط، ولا تعني بالضرورة رفع الثمن النهائي (م. 147)',
      ...
      },
      {
        ...
        content: [
          'يُدخل المشروع جملةً من التبسيطات لفائدة المتعاملون الاقتصاديون وأصحاب المشاريع، في سياق التحول الرقمي التدريجي لمنظومة الطلبيات العمومية المغربية.',
          'إثبات القدرات والمؤهلات (م. 28) : في إطار الصفقات المبرمة بواسطة طلب العروض المفتوح المبسط، يمكن للمتنافس الإدلاء بالشهادة المسلمة في إطار نظام التأهيل والتصنيف أو الاعتماد، عوضاً عن بعض الوثائق المطلوبة في الملف الإداري أو التقني.',
          'تمديد صلاحية العروض (م. 143) : يقترح المشروع تأطير تمديد صلاحية العروض، بحيث لا يتجاوز التمديد 30 يوماً في كل مرة، مع سقف إجمالي لا يتجاوز 90 يوماً، حسب الصيغة المعروضة في المشروع.',
          'الإشراف المنتدب على المشروع (م. 154) : متى كان الوزير المعني قد وقّع مسبقاً على اتفاقية الإشراف المنتدب، يُعفى صاحب المشروع المنتدب من التأشيرة أو الإذن المطلوبَين عادةً لإبرام الصفقات المندرجة ضمن تلك الاتفاقية.',
        ],
        bullets: [
          'شهادة التأهيل أو التصنيف أو الاعتماد تحلّ محل بعض وثائق الملف التقني في إطار طلب العروض المفتوح المبسط (م. 28)',
          'فتح الأظرفة وتقييم العروض إلكترونياً مُؤطَّران بالنصوص التطبيقية (م. 136)',
          'يقترح المشروع تأطير تمديد صلاحية العروض بـ30 يوماً كحد أقصى لكل تمديد، و90 يوماً كسقف إجمالي (م. 143)',
          'الإشراف المنتدب على المشروع : إعفاء من التأشيرة إذا سبق للوزير المعني التوقيع على الاتفاقية (م. 154)',
          'إعادة تنظيم تشكيلة لجنة طلب العروض بحسب طبيعة الجهة صاحبة المشروع — الدولة، المؤسسات العمومية، هيئات القانون العام الأخرى (م. 38)',
        ],
      },
      {
        icon: '🔄',
        h2: 'ما الذي سيتغير عملياً إذا اعتمد المشروع؟',
        content: [
          'إذا اعتُمد النص النهائي ونُشر في الجريدة الرسمية، يُتوقع أن تشمل أبرز التغييرات ما يلي:',
        ],
        bullets: [
          'توسيع مجال سندات الطلب برفع العتبة إلى 800.000 درهم مع احتساب جميع الرسوم',
          'توسيع استعمال طلب العروض المفتوح المبسط إلى 1.500.000 درهم خارج الرسوم',
          'تشديد مراقبة العروض المفرطة والمنخفضة بكيفية غير عادية عند 15%',
          'إدماج أقوى للبعد الاجتماعي في بعض الصفقات',
          'تقوية الولوج الترابي والوطني لبعض المتنافسين',
          'دعم المقاولات الصغيرة والمتوسطة والتعاونيات والمقاولين الذاتيين',
          'تبسيط بعض الوثائق والمساطر الإدارية',
        ],
      },
      {
        icon: '👥',
        h2: 'لمن تهم هذه التعديلات؟',
        content: [
          'يمسّ مشروع المرسوم رقم 2.26.435 طيفاً واسعاً من أطراف منظومة الطلبيات العمومية:',
        ],
        bullets: [
          'أصحاب المشاريع (الدولة والجماعات الترابية والمؤسسات العمومية)',
          'الآمرون بالصرف والآمرون بالصرف المساعدون',
          'المتعاملون الاقتصاديون المشاركون في الصفقات العمومية',
          'المقاولات الصغيرة جداً والصغرى والمتوسطة',
          'التعاونيات والمقاولون الذاتيون',
          'مكاتب الدراسات والمهندسون المعماريون',
          'الباحثون والطلبة في القانون العام والمالية العامة',
        ],
      },
      {
        icon: '🔍',
        h2: 'نقاط يجب مراقبتها عند صدور النص النهائي',
        content: [
          'في انتظار النص الرسمي، يُنصح بمتابعة النقاط التالية عند نشر المرسوم في الجريدة الرسمية:',
        ],
        bullets: [
          'هل سيتم الاحتفاظ بعتبة 800.000 درهم مع احتساب جميع الرسوم لسندات الطلب؟',
          'هل ستبقى نسبة 15% للعروض المفرطة والمنخفضة بكيفية غير عادية كما هي؟',
          'ما هي القرارات التطبيقية التي ستصدر عن الوزير المكلف بالمالية؟',
          'هل ستُحدد كيفيات الصفقات المخصصة للمقاولات الصغيرة والمتوسطة والتعاونيات والمقاولين الذاتيين؟',
          'هل ستصدر نماذج أو دلائل تطبيقية من الخزينة العامة أو وزارة الاقتصاد والمالية؟',
          'هل ستُحدد كيفيات تطبيق الصفقات المخصصة للمقاولات المبتكرة؟',
        ],
      },
    ],
...
export function getRelatedGuides(intent, max = 4) {
  ...
  faq_ar: [
    { q: 'ما هو المستجد الرئيسي الذي جاء به مشروع المرسوم فيما يخص تشجيع المنتوج والمقاولة الوطنية؟', a: 'يكرس مشروع المرسوم رقم 2.26.435 مبدأ "الأفضلية الوطنية" بشكل صريح وفعال. بموجب هذا المبدأ، سيتم تفضيل عروض المقاولات الوطنية في صفقات الأشغال والتوريدات، وذلك من خلال تطبيق زيادة بنسبة 15% على المبالغ المالية لعروض المقاولات الأجنبية عند مقارنتها بعروض المقاولات الوطنية. كما يهدف المشروع إلى تشجيع المنتوج المحلي "صنع في المغرب" عبر اشتراطات محددة في دفاتر الشروط الخاصة. يأتي هذا الإجراء تماشياً مع أهداف ميثاق الاستثمار الجديد والنموذج التنموي، لتحويل الصفقات العمومية إلى رافعة للاقتصاد الوطني.' },
    { q: 'بصفتي صاحب مقاولة صغرى، كيف يدعم مشروع المرسوم الجديد مشاركة المقاولات الصغيرة جدا والصغرى والمتوسطة في الصفقات العمومية؟', a: 'أولى مشروع المرسوم أهمية قصوى لهذه الفئة من المقاولات. أبرز إجراء هو رفع الحصة المخصصة لها من المبلغ الإجمالي السنوي للصفقات العمومية لكل إدارة من 20% إلى 30%. كما يمنح المشروع لصاحب المشروع (الإدارة العمومية) إمكانية تخصيص صفقات بأكملها أو حصص ضمن صفقة معينة لفائدة المقاول الذاتي والمقاولات الصغيرة جدا والصغرى والمتوسطة والتعاونيات واتحاد التعاونيات. يهدف هذا الإجراء، المنصوص عليه في التعديلات المقترحة على المرسوم رقم 2.22.431، إلى دمقرطة الولوج للطلبية العمومية وتعزيز النسيج المقاولاتي المحلي.' },
    { q: 'هل هناك تبسيط للمساطر الإدارية، خاصة فيما يتعلق بتقديم العروض إلكترونيا؟', a: 'نعم، يعتبر تعميم الرقمنة وإزالة الطابع المادي (la dématérialisation) أحد الركائز الأساسية لمشروع المرسوم. يسعى المشروع إلى جعل بوابة الصفقات العمومية (www.marchespublics.gov.ma) المنصة الوحيدة لجميع مراحل الصفقة، بدءًا من الإعلان وتقديم العروض، مرورًا بفتح الأظرفة وتقييم العروض، وصولًا إلى التبليغ بالنتائج. هذا التوجه سيؤدي إلى تبسيط كبير للمساطر، وتقليص الآجال، وخفض التكاليف على المتنافسين، بالإضافة إلى تعزيز الشفافية وإمكانية تتبع جميع الإجراءات بشكل دقيق ومؤرشف.' },
    { q: 'ما هي الآليات الجديدة التي يقترحها مشروع المرسوم لتعزيز الشفافية والحكامة في تدبير الصفقات العمومية؟', a: 'يعزز مشروع المرسوم الشفافية عبر عدة آليات. أولاً، من خلال إلزامية النشر الإلكتروني لجميع الوثائق والقرارات المتعلقة بالصفقة على بوابة الصفقات العمومية، بما في ذلك محاضر فتح الأظرفة وتقارير إنجاز الصفقات. ثانيًا، يقترح المشروع تدقيق قواعد تعارض المصالح لأعضاء لجان طلبات العروض. ثالثًا، يهدف إلى توحيد وتوضيح طرق تقييم العروض لتجنب التأويلات والقرارات التقديرية غير المبررة. هذه الإجراءات تندرج في إطار السعي نحو حكامة جيدة وتخليق الحياة العامة، تماشياً مع المبادئ الدستورية وتوصيات الهيئات الوطنية المختصة.' },
    { q: 'ما هو الهدف العام من هذا الإصلاح؟ ولماذا يتم تعديل مرسوم لم يمر على تطبيقه سوى فترة قصيرة؟', a: 'الهدف العام من مشروع المرسوم رقم 2.26.435 هو تحويل منظومة الصفقات العمومية من أداة لتدبير النفقات العمومية إلى رافعة استراتيجية لتحقيق أهداف التنمية الاقتصادية والاجتماعية للمملكة. يأتي هذا التعديل السريع للمرسوم رقم 2.22.431 استجابة للتوجيهات الملكية السامية وللتطورات الاقتصادية المتسارعة، وخصوصاً لتنزيل مقتضيات ميثاق الاستثمار الجديد الذي يضع الاستثمار المنتج في صلب الأولويات. يسعى الإصلاح إلى جعل الطلبية العمومية، التي تمثل نسبة هامة من الناتج الداخلي الخام، محركًا للاستثمار الوطني، وداعمًا للمقاولة المغربية والمنتوج المحلي، ومكرسًا للسيادة الاقتصادية.' },
  ],
